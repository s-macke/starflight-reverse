...
const unsigned short int cc_UNK_0xe67c = 0x004b; // UNK_0xe67c
const unsigned short int cc_UNK_0xe680 = 0x0000; // UNK_0xe680
const unsigned short int cc_UNK_0xe684 = 0x0016; // UNK_0xe684
const unsigned short int cc_UNK_0xe688 = 0x0190; // UNK_0xe688
...
void UNK_0xe9e9() // UNK_0xe9e9
{
  ...
  _1_dot_5_ex__2(); // 1.5!_2
  Push(pp_UNK_0xe9e5); // UNK_0xe9e5 size: 0
  _099(); // 099
  Push(0); // 0
...
void DMSG() // DMSG
{
  Push(pp_UNK_0xefda); // UNK_0xefda size: 0
  _099(); // 099
  Push(pp_XABS); // XABS size: 2
  Push(Read16(Pop())); // @
  Push(pp_YABS); // YABS size: 2
...
{
  Push(pp_UNK_0xf0d6); // UNK_0xf0d6 size: 0
  Push(Read16(Pop())); // @
  Push(0x0096);
  _gt_(); // >
  Push(pp_UNK_0xf0de); // UNK_0xf0de size: 0
  Push(Read16(Pop())); // @
  Push(cc__8); // 8
  _slash_(); // /
  Push(cc__8); // 8
  Push(Pop() * Pop()); // *
  Push(pp_UNK_0xf0e2); // UNK_0xf0e2 size: 0
  Push(Read16(Pop())); // @
  Push(cc__8); // 8
  _slash_(); // /
  Push(cc__8); // 8
  ...
  Push(Pop() & Pop()); // AND
  if (Pop() == 0) return;
  Push(pp_UNK_0xf0da); // UNK_0xf0da size: 0
  Push(Read16(Pop())); // @
  if (Pop() == 0) goto label1;
  CTINIT(); // CTINIT
...
{
  Push(pp_UNK_0xf290); // UNK_0xf290 size: 0
  _099(); // 099
  Push2Words("*ASSIGN");
  _gt_C_plus_S(); // >C+S
...
{
  Push(pp_UNK_0xf430); // UNK_0xf430 size: 0
  _099(); // 099
  UNK_0xf401(); // UNK_0xf401
  Push(0x65f2); // IFIELD(UNK_0xf42b)
  Push(Read8(Pop())&0xFF); // C@
  Push(pp_UNK_0xf434); // UNK_0xf434 size: 0
  _ex__2(); // !_2
  IOPEN(); // IOPEN
  Push(0xf413);
  Push(0xf464);
