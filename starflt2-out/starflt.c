...
// 0x7394: call   1649
  ...
  Push(b); // I
  Push(Read16(Pop())&0xFF); //  C@
  Push(!((Read16(Pop())&0xFF)==Read16(pp_FILE_n_)?1:0)); //  C@ FILE# @ = NOT
  if (Pop() != 0)
  {
    _gt_0FONT_1(); // >0FONT_1
    PRINT("AFIELD err", 10); // (.")
...
void UNK_0x9049() // UNK_0x9049
{
  ...
  {
    Push(i); // I
    Push(Read16(Pop() + pp_CMAP)&0xFF); //  CMAP + C@
    I_gt_C(); // I>C
    Push(i); // I
    Push(Pop() + pp_CMAP); //  CMAP +
    C_ex__2(); // C!_2
    i++;
  } while(i<imax); // (LOOP)
...
void UNK_0x9895() // UNK_0x9895
{
  ...
  {
    Push(i); // I
    Push(Pop() + Read16(pp_UNK_0x5c90)); //  UNK_0x5c90 @ +
...
// 0xaccc: call   1649
  ...
  do // (DO)
  {
    ...
    if (Pop() != 0)
    {
      ...
      {
        Push(i); // I
        Push(((Pop() - Read16(cc_UNK_0xab77) >> 1) >> 1) * 2 + Read16(cc_UNK_0xab77)); //  UNK_0xab77 - 2/ 2/ 2* UNK_0xab77 +
        Push(Read16(regsp)); // DUP
        Push(Read16(Pop())); //  @
        Push(i); // I
        Push(Read16(Pop())); //  @
