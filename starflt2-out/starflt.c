...
const unsigned short int pp__n_STORM = 0x5c80; // #STORM size: 14
// {0x00, 0x00, 0x29, 0x1d, 0x4a, 0x00, 0x29, 0x1d, 0x00, 0x00, 0x29, 0x1d, 0x4b, 0x00}
...
{
  OVER(); // OVER
  Push(Read16(pp_UNK_0x55ff)); // UNK_0x55ff @
  Push((Pop()==Pop())?1:0); // =
  OVER(); // OVER
  Push(Read16(pp_UNK_0x5603)); // UNK_0x5603 @
  Push((Pop()==Pop())?1:0); // =
  Push(Pop() & Pop()); // AND
  if (Pop() == 0) Push(1); else Push(0); // NOT
}
...
{
  Push(0x65e1+INST_dash_PR.offset); // IFIELD
  _1_dot_5_ex__2(); // 1.5!_2
}
...
{
  Push(0x65e1+INST_dash_CL.offset); // IFIELD
  C_ex__2(); // C!_2
}
...
{
  Push(0x65e1+INST_dash_SP.offset); // IFIELD
  C_ex__2(); // C!_2
}
...
void OPEN_dash_OV() // OPEN-OV
{
  ...
  Push(Pop()<<4); // 16*
  Push(-Pop()); // NEGATE
  Push(Read16(cc_UNK_0x5102)); // UNK_0x5102
  Push(Pop() + Pop()); // +
  Push(Read16(regsp)); // DUP
  UNK_0x82d3(); // UNK_0x82d3
  Push(Read16(regsp)); // DUP
...
void TILEFIL() // TILEFIL
{
  ...
  a = Pop(); // >R
  UNK_0x86fa(); // UNK_0x86fa
  Push(Read16(pp_TILE_dash_PT)); // TILE-PT @
  Push(Read8(Pop())&0xFF); // C@
  StoreCOLOR(); // !COLOR
  b = Pop(); // >R
  OVER(); // OVER
...
void UNK_0x9895() // UNK_0x9895
{
  ...
  {
    Push(i); // I
    Push(Read16(pp_UNK_0x5c90)); // UNK_0x5c90 @
    Push(Pop() + Pop()); // +
...
void _plus_ICON_2() // +ICON_2
{
  Push(Read16(pp_IGLOBAL)); // IGLOBAL @
  Push(Read16(regsp)); // DUP
  Push(Read16(cc_UNK_0x5286)); // UNK_0x5286
  Push((Pop()==Pop())?1:0); // =
  if (Pop() != 0)
  {
    UNRAVEL(); // UNRAVEL
...
{
  CDEPTH(); // CDEPTH
  Push(Read16(pp_UNK_0x5e52)); // UNK_0x5e52 @
  _dash_(); // -
}
...
void DOTASKS() // DOTASKS
{
  ...
  do
  {
    ...
    D_gt_(); // D>
    Push(Read16(pp_FORCEPT)); // FORCEPT @
    Push(Pop() | Pop()); // OR
    if (Pop() != 0)
    {
      PARALLE(); // PARALLE
