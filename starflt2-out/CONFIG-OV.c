...
{
  Push(pp_UNK_0xe7ba); // UNK_0xe7ba size: 0
  Push(Read16(Pop())); // @
...
void UNK_0xeb87() // UNK_0xeb87
{
  ...
  Push(Pop() + Pop()); // +
  POS_dot_(); // POS.
  Push(pp_UNK_0xea76); // UNK_0xea76 size: 0
  Push(i); // I
  Push(Pop()*2); // 2*
  Push(Pop() + Pop()); // +
  Push(Read16(Pop())); // @
...
void UNK_0xeca2() // UNK_0xeca2
{
  ...
  DMAX(); // DMAX
  _2DUP(); // 2DUP
  Push(pp_UNK_0xec9c); // UNK_0xec9c size: 0
  D_ex_(); // D!
  Push(cc__6); // 6
  D_dot_R(); // D.R
  return;
...
void UNK_0xf173() // UNK_0xf173
{
  ...
  Push(pp_OCRS); // OCRS size: 2
  _099(); // 099
  Push(pp_UNK_0xe903); // UNK_0xe903 size: 0
  BLD_dash_CRS(); // BLD-CRS
  Push(0); // 0
  Push(pp_UNK_0xf16f); // UNK_0xf16f size: 0
  Push(Read16(Pop())); // @
  if (Pop() == 0) goto label1;
...
void _ro_U_dash_CONFIG_rc_() // (U-CONFIG)
{
  ...
  MODULE(); // MODULE
  UNK_0xeb07(); // UNK_0xeb07
  Push(pp_UNK_0xe8ec); // UNK_0xe8ec size: 0
  BLD_dash_CRS(); // BLD-CRS
  _gt_DISPLA(); // >DISPLA
