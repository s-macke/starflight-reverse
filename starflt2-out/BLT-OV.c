...
{
  Push(pp_UNK_0xf068); // UNK_0xf068 size: 0
  Push(0x000f);
  Push(cc_BL); // BL
  FILL_2(); // FILL_2
  Push(pp_UNK_0xf068); // UNK_0xf068 size: 0
...
void UNK_0xf111() // UNK_0xf111
{
  _ask_VGA(); // ?VGA
  if (Pop() == 0) goto label1;
  Push(pp_UNK_0xeff6); // UNK_0xeff6 size: 0
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  BMPAL(); // BMPAL
  C_ex__2(); // C!_2
...
void UNK_0xf12b() // UNK_0xf12b
{
  _ask_VGA(); // ?VGA
  if (Pop() == 0) goto label1;
  Push(pp_UNK_0xf006); // UNK_0xf006 size: 0
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  BMPAL(); // BMPAL
  C_ex__2(); // C!_2
...
void UNK_0xf179() // UNK_0xf179
{
  ...
  Push(pp_UNK_0xf01b); // UNK_0xf01b size: 0
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  ICLOSE(); // ICLOSE
}
