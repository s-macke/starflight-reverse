...
{
  Push(0xf068); // pointer to UNK_0xf068
  Push(0x000f);
  Push(cc_BL); // BL
  FILL_2(); // FILL_2
  Push(0xf068); // pointer to UNK_0xf068
...
void UNK_0xf111() // UNK_0xf111
{
  _ask_VGA(); // ?VGA
  if (Pop() == 0) goto label1;
  Push(0xeff6); // pointer to UNK_0xeff6
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  BMPAL(); // BMPAL
  C_ex__2(); // C!_2
...
void UNK_0xf12b() // UNK_0xf12b
{
  _ask_VGA(); // ?VGA
  if (Pop() == 0) goto label1;
  Push(0xf006); // pointer to UNK_0xf006
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  BMPAL(); // BMPAL
  C_ex__2(); // C!_2
...
void UNK_0xf179() // UNK_0xf179
{
  ...
  Push(0xf01b); // pointer to UNK_0xf01b
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  ICLOSE(); // ICLOSE
}
