...
void UNK_0xe59f() // UNK_0xe59f
{
  ...
  SetColor("BLUE");
  _ex_COLOR(); // !COLOR
  Push(pp_UNK_0xe57b); // UNK_0xe57b size: 0
...
void UNK_0xe764() // UNK_0xe764
{
  ...
  Push(pp_UNK_0xe73e); // UNK_0xe73e size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__2(); // !_2
  BLT(); // BLT
}
...
{
  UNK_0xe74e(); // UNK_0xe74e
  Push(pp_UNK_0xe742); // UNK_0xe742 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__2(); // !_2
  BLT(); // BLT
}
...
void UNK_0xe7de() // UNK_0xe7de
{
  ...
  if (Pop() == 0) return;
  UNK_0xe74e(); // UNK_0xe74e
  Push(pp_UNK_0xe746); // UNK_0xe746 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__2(); // !_2
  Push(0); // 0
...
void UNK_0xe804() // UNK_0xe804
{
  ...
  if (Pop() == 0) return;
  UNK_0xe74e(); // UNK_0xe74e
  Push(pp_UNK_0xe74a); // UNK_0xe74a size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__2(); // !_2
  Push(0); // 0
...
void UNK_0xe922() // UNK_0xe922
{
  _ex_COLOR(); // !COLOR
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xe910); // UNK_0xe910 size: 0
  _ex__2(); // !_2
  Push(0x004c);
  Push(Pop() + Pop()); // +
  Push(pp_YBLT); // YBLT size: 2
  _ex__2(); // !_2
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xe914); // UNK_0xe914 size: 0
  _ex__2(); // !_2
  Push(Pop()+1); // 1+
  Push(pp_XBLT); // XBLT size: 2
  _ex__2(); // !_2
  ...
  Push(pp_WBLT); // WBLT size: 2
  _ex__2(); // !_2
  Push(pp_UNK_0xe918); // UNK_0xe918 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__2(); // !_2
  BLT(); // BLT
}
...
void UNK_0xec0b() // UNK_0xec0b
{
  ...
  Push(cc__3); // 3
  Push(Pop() * Pop()); // *
  Push(pp_UNK_0xec00); // UNK_0xec00 size: 0
  Push(Pop() + Pop()); // +
  Push(0); // 0
  Push(cc__3); // 3
  RRND(); // RRND
...
void UNK_0xefb2() // UNK_0xefb2
{
  ...
  R_gt_(); // R>
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xecc7); // UNK_0xecc7 size: 0
  Push(cc__4); // 4
  Push(Pop() + Pop()); // +
  C_ex__2(); // C!_2
  Push(pp_UNK_0xecce); // UNK_0xecce size: 0
  Push(cc__4); // 4
  Push(Pop() + Pop()); // +
  C_ex__2(); // C!_2
  UNK_0xe8c0(); // UNK_0xe8c0
...
{
  Push(pp__i_DO_dash_CLOUD); // 'DO-CLOUD size: 84
  Push(Read16(Pop())); // @
  MODULE(); // MODULE
}
