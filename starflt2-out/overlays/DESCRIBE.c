...
// ================================================
IFieldType UNK_0xe64a = {0x2b, 0x0b, 0x03};
...
// ================================================
LoadDataType UNK_0xe663 = {0x15, 0x00, 0x10, 0x32, 0x6ad1};

// ================================================
// 0xe669: WORD 'UNK_0xe66b' codep=0x7394 parp=0xe66b
// ================================================
LoadDataType UNK_0xe66b = {0x15, 0x13, 0x01, 0x32, 0x6ad1};
...
// ================================================
LoadDataType UNK_0xe6ab = {0x1a, 0x00, 0x10, 0x17, 0x6ba9};

// ================================================
// 0xe6b1: WORD 'UNK_0xe6b3' codep=0x7420 parp=0xe6b3
// ================================================
IFieldType UNK_0xe6b3 = {0x10, 0x0b, 0x0f};
...
// ================================================
LoadDataType UNK_0xe6c5 = {0x44, 0x17, 0x03, 0x22, 0x6f07};

// ================================================
// 0xe6cb: WORD 'UNK_0xe6cd' codep=0x7394 parp=0xe6cd
// ================================================
LoadDataType UNK_0xe6cd = {0x44, 0x1f, 0x01, 0x22, 0x6f07};
