...
//        .APHRASE  codep:0x224c parp:0xeaa0 size:0x0042 C-string:'DrawAPHRASE'
...
// ================================================
// 0xe604: WORD 'UNK_0xe606' codep=0x224c parp=0xe606 params=4 returns=2
// ================================================
...
// 0xe64d: db 0x20 0x74 0x3d 0x1c 0x01 0x20 0x74 0x3d 0x1d 0x01 0x20 0x74 0x3d 0x1a 0x01 0x20 0x74 0x3d 0x1b 0x01 ' t=   t=   t=   t=  '
...
// 0xe671: db 0x94 0x73 0x15 0x1d 0x01 0x32 0xd1 0x6a 0x94 0x73 0x15 0x1f 0x01 0x32 0xd1 0x6a 0x94 0x73 0x15 0x20 0x01 0x32 0xd1 0x6a 0x94 0x73 0x15 0x21 0x01 0x32 0xd1 0x6a 0x94 0x73 0x15 0x22 0x01 0x32 0xd1 0x6a 0x94 0x73 0x15 0x23 0x01 0x32 0xd1 0x6a 0x94 0x73 0x18 0x00 0x03 0x00 0x00 0x00 ' s   2 j s   2 j s   2 j s ! 2 j s " 2 j s # 2 j s      '
...
// 0xe6b6: db 0x20 0x74 0x10 0x20 0x02 0x94 0x73 0x44 0x00 0x14 0x22 0x07 0x6f ' t    sD  " o'
...
// 0xe6d3: db 0x20 0x74 0x44 0x17 0x01 0x4c 0x22 0x5d 0x17 0x1c 0x00 0xf2 0x0e 0x43 0x73 0x5d 0x17 0x18 0x00 0x5d 0x17 0x2e 0x00 0x25 0xab 0xe6 0x06 0x90 0x16 ' tD  L"]     Cs]   ] . %     '
...
// ================================================
// 0xe8f3: WORD 'UNK_0xe8f5' codep=0x224c parp=0xe8f5 params=4 returns=0
// ================================================
...
// ================================================
// 0xe954: WORD 'UNK_0xe956' codep=0x224c parp=0xe956 params=12 returns=3
// ================================================
...
// ================================================
// 0xe970: WORD 'UNK_0xe972' codep=0x224c parp=0xe972 params=5 returns=2
// ================================================
...
// ================================================
// 0xe98b: WORD 'UNK_0xe98d' codep=0x224c parp=0xe98d params=5 returns=2
// ================================================
...
// ================================================
// 0xe9a8: WORD 'UNK_0xe9aa' codep=0x224c parp=0xe9aa params=5 returns=0
// ================================================
...
// ================================================
// 0xe9b8: WORD 'UNK_0xe9ba' codep=0x224c parp=0xe9ba params=4 returns=3
// ================================================
...
void UNK_0xe9ba() // UNK_0xe9ba
{
  CJ(); // CJ
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xe6b3.offset); // IFIELD
  COUNT(); // COUNT
...
// ================================================
// 0xeb4f: WORD 'UNK_0xeb51' codep=0x224c parp=0xeb51 params=4 returns=0
// ================================================
...
// ================================================
// 0xeb65: WORD 'UNK_0xeb67' codep=0x224c parp=0xeb67 params=5 returns=0
// ================================================
...
void UNK_0xeb67() // UNK_0xeb67
{
  ...
  _1_dot_5_at_(); // 1.5@
  Push(0x65e1+UNK_0xe64a.offset); // IFIELD
  _1_dot_5_ex__2(); // 1.5!_2
  goto label1;
...
// ================================================
// 0xebf0: WORD 'UNK_0xebf2' codep=0x224c parp=0xebf2 params=2 returns=0
// ================================================
...
// ================================================
// 0xec61: WORD 'UNK_0xec63' codep=0x224c parp=0xec63 params=6 returns=1
// ================================================
...
// ================================================
// 0xec75: WORD 'UNK_0xec77' codep=0x224c parp=0xec77 params=6 returns=1
// ================================================
...
// ================================================
// 0xecbb: WORD 'UNK_0xecbd' codep=0x224c parp=0xecbd params=0 returns=5
// ================================================
...
// ================================================
// 0xed0d: WORD 'UNK_0xed0f' codep=0x224c parp=0xed0f params=2 returns=0
// ================================================
...
// ================================================
// 0xeda5: WORD 'UNK_0xeda7' codep=0x224c parp=0xeda7 params=2 returns=1
// ================================================
...
// ================================================
// 0xf2a4: WORD 'UNK_0xf2a6' codep=0x224c parp=0xf2a6 params=5 returns=0
// ================================================
