...
{
  Push(Read16(pp_UNK_0xed46)); // UNK_0xed46 @
  Push(Pop() + Pop()); // +
}
...
void UNK_0xee6d() // UNK_0xee6d
{
  ...
  Push(3);
  Push(Pop() * Pop()); // *
  Push(0x65e1+UNK_0xedc1.offset); // IFIELD
  Push(Pop() + Pop()); // +
  Get_gt_C_plus_S(); // @>C+S
  Push(0x65e1+UNK_0xedbc.offset); // IFIELD
  _do__dot_(); // $.
  CDROP(); // CDROP
  ICLOSE(); // ICLOSE
}
...
void UNK_0xeebb() // UNK_0xeebb
{
  ...
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xedc6.offset); // IFIELD
  _do__dot_(); // $.
  ICLOSE(); // ICLOSE
}
...
void UNK_0xf314() // UNK_0xf314
{
  ...
  _gt_C_plus_S(); // >C+S
  Push(0x0096);
  Push(0x65e1+UNK_0xedcb.offset); // IFIELD
  _plus__ex__2(); // +!_2
  ICLOSE(); // ICLOSE
  Push2Words("*STARSH");
  _gt_C_plus_S(); // >C+S
...
void UNK_0xf3d4() // UNK_0xf3d4
{
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xedd0.offset); // IFIELD
