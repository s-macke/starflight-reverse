...
//      UNK_0xf069  codep:0x1d29 parp:0xf069 size:0x0124 C-string:'UNK_0xf069'
...
//      UNK_0xf1c5  codep:0x1d29 parp:0xf1c5 size:0x006c C-string:'UNK_0xf1c5'
...
// ================================================
// 0xebcc: WORD 'UNK_0xebce' codep=0x7394 parp=0xebce orphan
// ================================================
...
// ================================================
// 0xebdc: WORD 'UNK_0xebde' codep=0x7394 parp=0xebde orphan
// ================================================
...
// ================================================
// 0xebec: WORD 'UNK_0xebee' codep=0x7394 parp=0xebee orphan
// ================================================
...
// ================================================
// 0xec14: WORD 'UNK_0xec16' codep=0x7394 parp=0xec16 orphan
// ================================================
...
// ================================================
// 0xec5c: WORD 'UNK_0xec5e' codep=0x224c parp=0xec5e orphan
// ================================================
...
// ================================================
// 0xed3e: WORD 'UNK_0xed40' codep=0x7394 parp=0xed40 orphan
// ================================================
...
// ================================================
// 0xf067: WORD 'UNK_0xf069' codep=0x1d29 parp=0xf069 orphan
// ================================================
...
// ================================================
// 0xf18d: WORD 'UNK_0xf18f' codep=0x224c parp=0xf18f params=3 returns=0
// ================================================
...
// ================================================
// 0xf1a1: WORD 'UNK_0xf1a3' codep=0x224c parp=0xf1a3 params=3 returns=0
// ================================================
...
// ================================================
// 0xf1b5: WORD 'UNK_0xf1b7' codep=0x224c parp=0xf1b7 orphan params=0 returns=1
// ================================================
...
// ================================================
// 0xf1c3: WORD 'UNK_0xf1c5' codep=0x1d29 parp=0xf1c5 orphan
// ================================================
// 0xf1c5: db 0x00 0x0a 0x0b 0x0d 0x29 0x1d 0x00 0x0a 0x0f 0x15 0x4c 0x22 0xb5 0xf1 0xfa 0x15 0x42 0x00 0x19 0xa9 0xae 0x0b 0x7f 0x0e 0x41 0x0e 0xc3 0xf1 0x72 0x0f 0x92 0x0c 0xf2 0x0e 0xc9 0xf1 0x72 0x0f 0x92 0x0c 0xc4 0x4b 0x5d 0x17 0x0a 0x00 0xb5 0x75 0x9b 0x53 0x07 0x40 0xfa 0x15 0x04 0x00 0xf2 0x0e 0xc4 0x0f 0x58 0x10 0x5d 0x17 0xf8 0x7f 0xad 0x11 0xcc 0xa9 0x16 0x6d 0x20 0x0f 0x22 0x75 0xcc 0xed 0x0a 0x6d 0x41 0xf1 0x90 0x16 0x4c 0x22 0x07 0x76 0x07 0x13 0xfa 0x15 0x0e 0x00 0x7a 0x7a 0x07 0x13 0xfa 0x15 0x04 0x00 0xc9 0x7a 0x1e 0x7f 0x90 0x16 '    )     L"    B      A   r       r    K]    u S @        X ]       m  "u   mA   L" v      zz       z   '

// ================================================
// 0xf231: WORD 'UNK_0xf233' codep=0x224c parp=0xf233 params=5 returns=0
// ================================================
...
// ================================================
// 0xf24d: WORD 'UNK_0xf24f' codep=0x224c parp=0xf24f params=9 returns=0
// ================================================
...
// ================================================
// 0xf2d5: WORD 'UNK_0xf2d7' codep=0x224c parp=0xf2d7 orphan params=0 returns=0
// ================================================
...
// ================================================
// 0xf3d8: WORD 'UNK_0xf3da' codep=0x224c parp=0xf3da orphan params=3 returns=0
// ================================================
