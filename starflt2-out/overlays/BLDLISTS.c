...
//      UNK_0xebc6  codep:0x7394 parp:0xebc6 size:0x0006 C-string:'UNK_0xebc6'
//      UNK_0xebce  codep:0x7394 parp:0xebce size:0x0006 C-string:'UNK_0xebce'
//      UNK_0xebd6  codep:0x7394 parp:0xebd6 size:0x0006 C-string:'UNK_0xebd6'
//      UNK_0xebde  codep:0x7394 parp:0xebde size:0x0006 C-string:'UNK_0xebde'
//      UNK_0xebe6  codep:0x7394 parp:0xebe6 size:0x0006 C-string:'UNK_0xebe6'
//      UNK_0xebee  codep:0x7394 parp:0xebee size:0x0006 C-string:'UNK_0xebee'
...
//      UNK_0xec16  codep:0x7394 parp:0xec16 size:0x0006 C-string:'UNK_0xec16'
...
//      UNK_0xec56  codep:0x7394 parp:0xec56 size:0x0006 C-string:'UNK_0xec56'
//      UNK_0xec5e  codep:0x224c parp:0xec5e size:0x000c C-string:'UNK_0xec5e'
...
//      UNK_0xed38  codep:0x7394 parp:0xed38 size:0x0006 C-string:'UNK_0xed38'
//      UNK_0xed40  codep:0x7394 parp:0xed40 size:0x0006 C-string:'UNK_0xed40'
...
//      UNK_0xf039  codep:0x224c parp:0xf039 size:0x002e C-string:'UNK_0xf039'
//      UNK_0xf069  codep:0x1d29 parp:0xf069 size:0x0004 C-string:'UNK_0xf069'
//      UNK_0xf06f  codep:0x1d29 parp:0xf06f size:0x0004 C-string:'UNK_0xf06f'
//      UNK_0xf075  codep:0x224c parp:0xf075 size:0x003c C-string:'UNK_0xf075'
//      UNK_0xf0b3  codep:0x224c parp:0xf0b3 size:0x0008 C-string:'UNK_0xf0b3'
//      UNK_0xf0bd  codep:0x224c parp:0xf0bd size:0x0024 C-string:'UNK_0xf0bd'
//      UNK_0xf0e3  codep:0x224c parp:0xf0e3 size:0x001a C-string:'UNK_0xf0e3'
//      UNK_0xf0ff  codep:0x224c parp:0xf0ff size:0x000e C-string:'UNK_0xf0ff'
//      UNK_0xf10f  codep:0x224c parp:0xf10f size:0x0018 C-string:'UNK_0xf10f'
//      UNK_0xf129  codep:0x224c parp:0xf129 size:0x0018 C-string:'UNK_0xf129'
//      UNK_0xf143  codep:0x224c parp:0xf143 size:0x001e C-string:'UNK_0xf143'
//      UNK_0xf163  codep:0x224c parp:0xf163 size:0x0012 C-string:'UNK_0xf163'
//      UNK_0xf177  codep:0x224c parp:0xf177 size:0x0016 C-string:'UNK_0xf177'
//      UNK_0xf18f  codep:0x224c parp:0xf18f size:0x0012 C-string:'UNK_0xf18f'
//      UNK_0xf1a3  codep:0x224c parp:0xf1a3 size:0x0012 C-string:'UNK_0xf1a3'
//      UNK_0xf1b7  codep:0x224c parp:0xf1b7 size:0x000c C-string:'UNK_0xf1b7'
//      UNK_0xf1c5  codep:0x1d29 parp:0xf1c5 size:0x0004 C-string:'UNK_0xf1c5'
//      UNK_0xf1cb  codep:0x1d29 parp:0xf1cb size:0x0004 C-string:'UNK_0xf1cb'
//      UNK_0xf1d1  codep:0x224c parp:0xf1d1 size:0x0048 C-string:'UNK_0xf1d1'
...
//      UNK_0xf2bb  codep:0x224c parp:0xf2bb size:0x001a C-string:'UNK_0xf2bb'
//      UNK_0xf2d7  codep:0x224c parp:0xf2d7 size:0x0034 C-string:'UNK_0xf2d7'
...
//      UNK_0xf3da  codep:0x224c parp:0xf3da size:0x000c C-string:'UNK_0xf3da'
...
const unsigned short int pp_UNK_0xf069 = 0xf069; // UNK_0xf069 size: 4
// {0x00, 0x32, 0x46, 0x5a}

const unsigned short int pp_UNK_0xf06f = 0xf06f; // UNK_0xf06f size: 4
// {0x00, 0x6f, 0x83, 0x97}

const unsigned short int pp_UNK_0xf1c5 = 0xf1c5; // UNK_0xf1c5 size: 4
// {0x00, 0x0a, 0x0b, 0x0d}

const unsigned short int pp_UNK_0xf1cb = 0xf1cb; // UNK_0xf1cb size: 4
// {0x00, 0x0a, 0x0f, 0x15}
...
// ================================================
// 0xebcc: WORD 'UNK_0xebce' codep=0x7394 parp=0xebce
// ================================================
// orphan
LoadDataType UNK_0xebce = {TRADERSIDX, 0x15, 0x01, 0x32, 0x6ad1};
...
// ================================================
// 0xebdc: WORD 'UNK_0xebde' codep=0x7394 parp=0xebde
// ================================================
// orphan
LoadDataType UNK_0xebde = {TRADERSIDX, 0x1a, 0x03, 0x32, 0x6ad1};
...
// ================================================
// 0xebec: WORD 'UNK_0xebee' codep=0x7394 parp=0xebee
// ================================================
// orphan
LoadDataType UNK_0xebee = {TRADERSIDX, 0x1e, 0x01, 0x32, 0x6ad1};
...
// ================================================
// 0xec14: WORD 'UNK_0xec16' codep=0x7394 parp=0xec16
// ================================================
// orphan
LoadDataType UNK_0xec16 = {TRADERSIDX, 0x25, 0x02, 0x32, 0x6ad1};
...
// ================================================
// 0xec5c: WORD 'UNK_0xec5e' codep=0x224c parp=0xec5e
// ================================================
// orphan

void UNK_0xec5e() // UNK_0xec5e
{
  Push(0xebbe); // probable 'UNK_0xebbe'
  IFLD_at_(); // IFLD@
  Push(Pop()==4?1:0); //  4 =
}
...
// ================================================
// 0xec6a: WORD 'UNK_0xec6c' codep=0x224c parp=0xec6c params=0 returns=2
// ================================================
...
// ================================================
// 0xec78: WORD 'UNK_0xec7a' codep=0x224c parp=0xec7a params=0 returns=0
// ================================================
...
// ================================================
// 0xec80: WORD 'UNK_0xec82' codep=0x224c parp=0xec82 params=1 returns=1
// ================================================
...
// ================================================
// 0xed3e: WORD 'UNK_0xed40' codep=0x7394 parp=0xed40
// ================================================
LoadDataType UNK_0xed40 = {ARTIFACTIDX, 0x1e, 0x01, 0x20, 0x6bcd};
...
// ================================================
// 0xed6e: WORD 'UNK_0xed70' codep=0x224c parp=0xed70 params=2 returns=2
// ================================================
...
// ================================================
// 0xede2: WORD 'UNK_0xede4' codep=0x224c parp=0xede4 params=2 returns=2
// ================================================
...
// ================================================
// 0xee2f: WORD 'UNK_0xee31' codep=0x224c parp=0xee31 params=1 returns=0
// ================================================
...
// ================================================
// 0xee3d: WORD 'UNK_0xee3f' codep=0x224c parp=0xee3f params=0 returns=1
// ================================================
...
// ================================================
// 0xee4f: WORD 'UNK_0xee51' codep=0x224c parp=0xee51 params=0 returns=1
// ================================================
...
void UNK_0xee57() // UNK_0xee57
{
  ...
  Push(Read16(Pop())&0xFF); //  C@
  ICLOSE(); // ICLOSE
  Push(Read16(Pop() + pp_UNK_0xee23)&0xFF); //  UNK_0xee23 + C@
}
...
void UNK_0xee69() // UNK_0xee69
{
  ...
  Push(Read16(Pop())&0xFF); //  C@
  ICLOSE(); // ICLOSE
  Push(Read16(Pop() + pp_UNK_0xee1c)&0xFF); //  UNK_0xee1c + C@
}
...
// ================================================
// 0xee87: WORD 'UNK_0xee89' codep=0x224c parp=0xee89 params=0 returns=0
// ================================================
...
// ================================================
// 0xeebf: WORD 'UNK_0xeec1' codep=0x224c parp=0xeec1 params=1 returns=0
// ================================================
...
// ================================================
// 0xeef1: WORD 'UNK_0xeef3' codep=0x224c parp=0xeef3 params=0 returns=0
// ================================================
...
void UNK_0xef03() // UNK_0xef03
{
  ...
  UNK_0xec7a(); // UNK_0xec7a
  LoadData(UNK_0xebc6); // from 'TRADERS'
  Push(Read16((Read16(Pop())&0xFF) + pp_UNK_0xee2a)&0xFF); //  C@ UNK_0xee2a + C@
  ICLOSE(); // ICLOSE
  Push(0x0018);
  Push(1);
...
// ================================================
// 0xef4d: WORD 'UNK_0xef4f' codep=0x224c parp=0xef4f params=1 returns=0
// ================================================
...
// ================================================
// 0xef79: WORD 'UNK_0xef7b' codep=0x224c parp=0xef7b params=1 returns=0
// ================================================
...
void UNK_0xefad() // UNK_0xefad
{
  ...
  UNK_0xec7a(); // UNK_0xec7a
  LoadData(UNK_0xebc6); // from 'TRADERS'
  Push((Read16((Read16(Pop())&0xFF) + pp_UNK_0xee2a)&0xFF) >> 1); //  C@ UNK_0xee2a + C@ 2/
  Push(0x0017);
  Push(6);
  _eq_SPECIE(); // =SPECIE
  if (Pop() != 0)
...
// ================================================
// 0xf067: WORD 'UNK_0xf069' codep=0x1d29 parp=0xf069
// ================================================
// 0xf069: db 0x00 0x32 0x46 0x5a ' 2FZ'

// ================================================
// 0xf06d: WORD 'UNK_0xf06f' codep=0x1d29 parp=0xf06f
// ================================================
// 0xf06f: db 0x00 0x6f 0x83 0x97 ' o  '

// ================================================
// 0xf073: WORD 'UNK_0xf075' codep=0x224c parp=0xf075
// ================================================
// orphan

void UNK_0xf075() // UNK_0xf075
{
  GetINST_dash_S(); // @INST-S
  UNK_0xee51(); // UNK_0xee51
  Push(Pop() + Pop()); // +
  ...
  UNK_0xec7a(); // UNK_0xec7a
  Push(0xebce); // probable 'UNK_0xebce'
  IFLD_at_(); // IFLD@
  ICLOSE(); // ICLOSE
  Push(Read16(regsp)); // DUP
  Push(Read16(Pop() + pp_UNK_0xf069)&0xFF); //  UNK_0xf069 + C@
  SWAP(); // SWAP
  Push(Read16(Pop() + pp_UNK_0xf06f)&0xFF); //  UNK_0xf06f + C@
  RRND(); // RRND
  Push(0x0064);
  _star__slash_(); // */
  ABS(); // ABS
...
// ================================================
// 0xf0b1: WORD 'UNK_0xf0b3' codep=0x224c parp=0xf0b3 params=0 returns=1
// ================================================
...
// ================================================
// 0xf0e1: WORD 'UNK_0xf0e3' codep=0x224c parp=0xf0e3 params=0 returns=1
// ================================================

void UNK_0xf0e3() // UNK_0xf0e3
{
  GetINST_dash_C(); // @INST-C
  Push(Pop()==Read16(cc_UNK_0xeb8e)?1:0); //  UNK_0xeb8e =
  if (Pop() != 0)
  {
    LoadData(UNK_0xed40); // from 'ARTIFACT'
...
// ================================================
// 0xf10d: WORD 'UNK_0xf10f' codep=0x224c parp=0xf10f
// ================================================

void UNK_0xf10f() // UNK_0xf10f
{
...
// ================================================
// 0xf127: WORD 'UNK_0xf129' codep=0x224c parp=0xf129
// ================================================

void UNK_0xf129() // UNK_0xf129
{
  UNK_0xf0ff(); // UNK_0xf0ff
  Push(0x0078);
  Push(0x00c9);
...
void UNK_0xf163() // UNK_0xf163
{
  ...
  if (Pop() != 0)
  {
    UNK_0xf10f(); // UNK_0xf10f
    return;
  }
  UNK_0xf075(); // UNK_0xf075
  UNK_0xf0bd(); // UNK_0xf0bd
}


// ================================================
// 0xf175: WORD 'UNK_0xf177' codep=0x224c parp=0xf177 params=0 returns=0
// ================================================
...
void UNK_0xf18f() // UNK_0xf18f
{
  ...
  _gt_C_plus_S(); // >C+S
  IOPEN(); // IOPEN
  Push(0xf163); // probable 'UNK_0xf163'
  ALL(); // ALL
  ICLOSE(); // ICLOSE
  ICLOSE(); // ICLOSE
}
...
void UNK_0xf1a3() // UNK_0xf1a3
{
  ...
  _gt_C_plus_S(); // >C+S
  IOPEN(); // IOPEN
  Push(0xf177); // probable 'UNK_0xf177'
  ALL(); // ALL
  ICLOSE(); // ICLOSE
  ICLOSE(); // ICLOSE
}
...
// ================================================
// 0xf1b5: WORD 'UNK_0xf1b7' codep=0x224c parp=0xf1b7 params=0 returns=1
// ================================================
...
// ================================================
// 0xf1c3: WORD 'UNK_0xf1c5' codep=0x1d29 parp=0xf1c5
// ================================================
// 0xf1c5: db 0x00 0x0a 0x0b 0x0d '    '

// ================================================
// 0xf1c9: WORD 'UNK_0xf1cb' codep=0x1d29 parp=0xf1cb
// ================================================
...
void UNK_0xf1d1() // UNK_0xf1d1
{
  ...
  OVER(); // OVER
  Push(Read16(regsp)); // DUP
  Push(Read16(Pop() + pp_UNK_0xf1c5)&0xFF); //  UNK_0xf1c5 + C@
  SWAP(); // SWAP
  Push(Read16(Pop() + pp_UNK_0xf1cb)&0xFF); //  UNK_0xf1cb + C@
  RRND(); // RRND
  Push(0x000a);
  CI_i_(); // CI'
  Push2Words("*2BUY");
...
// ================================================
// 0xf219: WORD 'UNK_0xf21b' codep=0x224c parp=0xf21b params=0 returns=0
// ================================================
...
void UNK_0xf233() // UNK_0xf233
{
  _gt_C_plus_S(); // >C+S
  IOPEN(); // IOPEN
  Push(0xf21b); // probable 'UNK_0xf21b'
  ALL(); // ALL
  IsNULL(); // ?NULL
  Push(!Pop()); //  NOT
  if (Pop() != 0)
...
void UNK_0xf25f() // UNK_0xf25f
{
  ...
  _gt_C_plus_S(); // >C+S
  IOPEN(); // IOPEN
  Push(0xf1d1); // probable 'UNK_0xf1d1'
  ALL(); // ALL
  Push(2);
  _star_CLOSE(); // *CLOSE
  Push2Words("*2BUY");
...
// ================================================
// 0xf2b9: WORD 'UNK_0xf2bb' codep=0x224c parp=0xf2bb params=0 returns=1
// ================================================
...
// ================================================
// 0xf2d5: WORD 'UNK_0xf2d7' codep=0x224c parp=0xf2d7 params=0 returns=0
// ================================================

void UNK_0xf2d7() // UNK_0xf2d7
{
  UNK_0xf1b7(); // UNK_0xf1b7
  if (Pop() == 0) return;
  GetINST_dash_C(); // @INST-C
...
// ================================================
// 0xf30b: WORD 'UNK_0xf30d' codep=0x224c parp=0xf30d params=0 returns=2
// ================================================
...
// ================================================
// 0xf339: WORD 'UNK_0xf33b' codep=0x224c parp=0xf33b params=1 returns=1
// ================================================
...
{
  Push(Read16(Pop() + pp_UNK_0xf363)&0xFF); //  UNK_0xf363 + C@
  Push(Read16(regsp)); // DUP
  Push(Pop()==8?1:0); //  8 =
  if (Pop() == 0) return;
...
{
  IOPEN(); // IOPEN
  Push(0xf2d7); // probable 'UNK_0xf2d7'
  ALL(); // ALL
  ICLOSE(); // ICLOSE
}
...
// ================================================
// 0xf3e6: WORD 'UNK_0xf3e8' codep=0x224c parp=0xf3e8 params=0 returns=0
// ================================================
...
void UNK_0xf3e8() // UNK_0xf3e8
{
  ...
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(Read16(0x65e1+UNK_0xeb9a.offset)); // UNK_0xeb9a<IFIELD> @
  Push(Read16(0x65e1+UNK_0xeb9f.offset)); // UNK_0xeb9f<IFIELD> @
  _plus_BIT(); // +BIT
  ...
  SWAP(); // SWAP
  _dash_(); // -
  Push(0x65e1+UNK_0xeba4.offset); // UNK_0xeba4<IFIELD>
  Store_2(); // !_2
  Push(2);
  _star_CLOSE(); // *CLOSE
}
...
void UNK_0xf41e() // UNK_0xf41e
{
  ...
  if (Pop() != 0)
  {
    ...
    {
      Push(Read16(0x65e1+UNK_0xeba9.offset)&0xFF); // UNK_0xeba9<IFIELD> C@
    }
    Push(pp_EDL); // EDL
    _st__ex__gt_(); // <!>
    ICLOSE(); // ICLOSE
...
void SET_dash_CARG() // SET-CARG
{
  ...
  _gt_C_plus_S(); // >C+S
  IOPEN(); // IOPEN
  Push(0xf3da); // probable 'UNK_0xf3da'
  ALL(); // ALL
  Push(2);
  _star_CLOSE(); // *CLOSE
