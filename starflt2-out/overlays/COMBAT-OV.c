...
//      UNK_0xe21e  codep:0x1d29 parp:0xe21e size:0x0002 C-string:'UNK_0xe21e'
//      UNK_0xe222  codep:0x224c parp:0xe222 size:0x001a C-string:'UNK_0xe222'
...
const unsigned short int pp_UNK_0xe21e = 0xe21e; // UNK_0xe21e size: 2
// {0x00, 0x00}
...
// ================================================
// 0xe220: WORD 'UNK_0xe222' codep=0x224c parp=0xe222 params=0 returns=1
// ================================================
// orphan

void UNK_0xe222() // UNK_0xe222
{
  UNK_0xdd36(); // UNK_0xdd36
  Push(0x005a);
  _st_(); // <
  if (Pop() != 0)
  {
    Push(pp_UNK_0xe21e); // UNK_0xe21e
    Push(-1);
    TOGGLE(); // TOGGLE
  }
  Push(Read16(pp_UNK_0xe21e)); // UNK_0xe21e @
  _gt_FLAG(); // >FLAG
}
