...
void UNK_0xe79c() // UNK_0xe79c
{
  ...
  Push(7);
  RRND(); // RRND
  Push(0x65e1+UNK_0xe69c.offset); // IFIELD
  C_ex__2(); // C!_2
  LoadData(UNK_0xe6ae); // from 'VESSEL'
  Push(Read8(Pop())&0xFF); // C@
  Push(0x65e1+UNK_0xe6a9.offset); // IFIELD
  C_ex__2(); // C!_2
  LoadData(UNK_0xe6b6); // from 'VESSEL'
  _2_at_(); // 2@
  Push(0x65e1+UNK_0xe6be.offset); // IFIELD
  StoreD(); // D!
...
void UNK_0xee09() // UNK_0xee09
{
  ...
  if (Pop() != 0)
  {
    ...
    Push(pp__ro_ENCOUN); // (ENCOUN
    Get_gt_C_plus_S(); // @>C+S
    Push(0x65e1+UNK_0xe6f5.offset); // IFIELD
    Push(Read8(Pop())&0xFF); // C@
    ICLOSE(); // ICLOSE
...
{
  Push(0x65e1+UNK_0xe6f0.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  if (Pop() == 0) return;
  CI(); // CI
  Push(Pop() | Pop()); // OR
...
void DMSG() // DMSG
{
  ...
  do // (DO)
  {
    ...
    if (Pop() != 0)
    {
      ...
      GetIH(); // @IH
      _gt_C_plus_S(); // >C+S
      Push(0x65e1+UNK_0xefd5.offset); // IFIELD
      _2_at_(); // 2@
      Push(Pop() | Pop()); // OR
      ICLOSE(); // ICLOSE
      if (Pop() != 0)
...
void UNK_0xf08f() // UNK_0xf08f
{
  Push(Read16(pp_PAST)); // PAST @
  _gt_FLAG(); // >FLAG
  Push(0x65e1+UNK_0xe6e6.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  _gt_FLAG(); // >FLAG
  Push(Pop() & Pop()); // AND
  Push(Read16(pp_PAST)); // PAST @
  if (Pop() == 0) Push(1); else Push(0); // NOT
  Push(0x65e1+UNK_0xe6eb.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  _gt_FLAG(); // >FLAG
  Push(Pop() & Pop()); // AND
  Push(Pop() | Pop()); // OR
...
void UNK_0xf200() // UNK_0xf200
{
  ...
  if (Pop() != 0)
  {
    Push(0x65e1+UNK_0xf167.offset); // IFIELD
    _plus__dash__at_(); // +-@
    Push(0xffc1);
    Push(0x0040);
    WITHIN(); // WITHIN
    Push(0x65e1+UNK_0xf16c.offset); // IFIELD
    _plus__dash__at_(); // +-@
    Push(0xffc0);
    Push(0x0040);
    WITHIN(); // WITHIN
    ...
    Push((Pop()==Pop())?1:0); // =
    Push(Pop() | Pop()); // OR
    Push(0x65e1+UNK_0xf171.offset); // IFIELD
    Push(Read8(Pop())&0xFF); // C@
    Push(Pop() & Pop()); // AND
...
void TRAK_dash_E() // TRAK-E
{
  ...
  Push2Words("*ASSIGN");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xed2d.offset); // IFIELD
  Get_gt_C_plus_S(); // @>C+S
  Push(0x65e1+UNK_0xed28.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
...
void _plus_A_dash_VESS() // +A-VESS
{
  ...
  Push(pp__ro_ENCOUN); // (ENCOUN
  Get_gt_C_plus_S(); // @>C+S
  Push(0x65e1+UNK_0xe6c3.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(Read16(regsp)); // DUP
  Push(Pop()-2); // 2-
  SWAP(); // SWAP
  ...
  Push(1);
  MAX(); // MAX
  Push(0x65e1+UNK_0xe6dc.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(Read16(regsp)); // DUP
  Push(0x65e1+UNK_0xe6e1.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  ROT(); // ROT
  Push(0x00ff);
  _st_(); // <
...
void _gt_ORBITS() // >ORBITS
{
  ...
  Push(0x65e1+UNK_0xf42b.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
