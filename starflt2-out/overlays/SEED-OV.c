...
// ================================================
// 0xedb8: WORD 'UNK_0xedba' codep=0x224c parp=0xedba params=6 returns=0
// ================================================
...
// ================================================
// 0xedf4: WORD 'UNK_0xedf6' codep=0x224c parp=0xedf6 params=2 returns=5
// ================================================
...
// ================================================
// 0xee06: WORD 'UNK_0xee08' codep=0x224c parp=0xee08 params=2 returns=5
// ================================================
...
// ================================================
// 0xee18: WORD 'UNK_0xee1a' codep=0x224c parp=0xee1a params=2 returns=5
// ================================================
...
// ================================================
// 0xee7c: WORD 'UNK_0xee7e' codep=0x224c parp=0xee7e params=5 returns=0
// ================================================
...
// ================================================
// 0xee90: WORD 'UNK_0xee92' codep=0x224c parp=0xee92 params=6 returns=1
// ================================================
...
void UNK_0xef14() // UNK_0xef14
{
  ...
  Store_2(); // !_2
  Push(1);
  Push(0x65e1+UNK_0xecdd.offset); // IFIELD
  C_ex__2(); // C!_2
  Push(0);
  Push(0x65e1+UNK_0xecd8.offset); // IFIELD
  C_ex__2(); // C!_2
  Push(1);
  ...
  Push(0x65e1+UNK_0xecc9.offset); // IFIELD
  C_ex__2(); // C!_2
  UNK_0xef0a(); // UNK_0xef0a
  Push(0x65e1+UNK_0xecce.offset); // IFIELD
  C_ex__2(); // C!_2
}
...
// ================================================
// 0xf028: WORD 'UNK_0xf02a' codep=0x224c parp=0xf02a params=2 returns=0
// ================================================
...
// ================================================
// 0xf11e: WORD 'UNK_0xf120' codep=0x224c parp=0xf120 params=5 returns=1
// ================================================
...
// ================================================
// 0xf18e: WORD 'UNK_0xf190' codep=0x224c parp=0xf190 params=2 returns=0
// ================================================
...
// ================================================
// 0xf1a0: WORD 'UNK_0xf1a2' codep=0x224c parp=0xf1a2 params=4 returns=1
// ================================================
...
// ================================================
// 0xf1d8: WORD 'UNK_0xf1da' codep=0x224c parp=0xf1da params=3 returns=3
// ================================================
...
// ================================================
// 0xf1e6: WORD 'UNK_0xf1e8' codep=0x224c parp=0xf1e8 params=3 returns=2
// ================================================
...
// ================================================
// 0xf21a: WORD 'UNK_0xf21c' codep=0x224c parp=0xf21c params=5 returns=0
// ================================================
...
// ================================================
// 0xf2ba: WORD 'UNK_0xf2bc' codep=0x224c parp=0xf2bc params=4 returns=0
// ================================================
...
// ================================================
// 0xf2fe: WORD 'UNK_0xf300' codep=0x224c parp=0xf300 params=13 returns=0
// ================================================
...
void UNK_0xf48e() // UNK_0xf48e
{
  ...
  Push(1);
  MAX(); // MAX
  Push(0x65e1+UNK_0xec9a.offset); // IFIELD
  C_ex__2(); // C!_2
  Push(pp_THIS_dash_RE); // THIS-RE
  Get_gt_C_plus_S(); // @>C+S
  IOPEN(); // IOPEN
  ...
  Push(2);
  _star_CLOSE(); // *CLOSE
  Push(0x65e1+UNK_0xeca4.offset); // IFIELD
