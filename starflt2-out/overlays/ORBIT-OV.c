...
//      UNK_0xdc8c  codep:0x7394 parp:0xdc8c size:0x0042 C-string:'UNK_0xdc8c'
...
// 0xdc92: db 0x29 0x1d 0x8b 0xc1 0xc3 0x29 0x1d 0x8b 0xc2 0x03 0xc1 0x40 0xd1 0xf8 0x03 0xc1 0x40 0xd1 0xf8 0xc3 0x29 0x1d 0x8b 0xc2 0x03 0xc1 0x40 0xd1 0xf8 0xc3 0x29 0x1d 0x8b 0xc2 0x03 0xc1 0x40 0xd1 0xf8 0x03 0xc2 0x40 0xd1 0xf8 0xc3 0x29 0x1d 0x8b 0xc2 0xc3 0x94 0xdc 0x99 0xdc 0xa8 0xdc 0xb2 0xdc 0xc1 0xdc ')    )     @    @   )     @   )     @    @   )              '

// ================================================
// 0xdcce: WORD 'UNK_0xdcd0' codep=0x1d29 parp=0xdcd0
// ================================================
// 0xdcd0: shl    bx,1
// 0xdcd2: add    bx,DCC4
// 0xdcd6: mov    ax,[bx]
...
// ================================================
// 0xdd74: WORD 'UNK_0xdd76' codep=0x224c parp=0xdd76 params=2 returns=3
// ================================================
...
// ================================================
// 0xdd9c: WORD 'UNK_0xdd9e' codep=0x224c parp=0xdd9e params=0 returns=6
// ================================================
...
void UNK_0xdd9e() // UNK_0xdd9e
{
  ...
  do // (DO)
  {
    ...
    {
      Push(j); // I
      Push(Pop() * 0x0020 - 0x004e); //  0x0020 * 0x004e -
      Push(0);
      Push(i); // J
      Push(Pop() * 0x0020 - 0x004e); //  0x0020 * 0x004e -
      Push(i); // J
...
// ================================================
// 0xddea: WORD 'UNK_0xddec' codep=0x224c parp=0xddec params=0 returns=6
// ================================================
...
// ================================================
// 0xe6ab: WORD 'UNK_0xe6ad' codep=0x224c parp=0xe6ad params=0 returns=9
// ================================================
...
void UNK_0xe6eb() // UNK_0xe6eb
{
  ...
  do // (DO)
  {
    ...
    {
      Push(j); // I
      Push((Pop() * 8 + 1) + (Read16(pp_XVIS) - Read16(pp_XCON))); //  8 * 1+ XVIS @ XCON @ - +
      Push(i); // J
      Push((Pop() * 6 + 1) + (Read16(pp_YVIS) - Read16(pp_YCON))); //  6 * 1+ YVIS @ YCON @ - +
      OVER(); // OVER
      Push(Pop() + 8); //  8 +
      OVER(); // OVER
      Push(Pop() + 6); //  6 +
...
void UNK_0xe751() // UNK_0xe751
{
  ...
  do // (DO)
  {
    ...
    {
      Push(j); // I
      Push(Pop() + Read16(pp_X1)); //  X1 @ +
      Push(Read16(pp_Y1)); // Y1 @
      Push(i); // J
      _dash_(); // -
...
void UNK_0xe7a9() // UNK_0xe7a9
{
  ...
  do // (DO)
  {
    ...
    do // (DO)
    {
      ...
      Push(j); // I
      Push(Pop() + Pop()); // +
      Push(Pop() + pp_UNK_0xdc14); //  UNK_0xdc14 +
      C_ex__2(); // C!_2
      j++;
    } while(j<jmax); // (LOOP)
...
void UNK_0xe7e5() // UNK_0xe7e5
{
  ...
  do // (DO)
  {
    ...
    do // (DO)
    {
      ...
      L_at_(); // L@
      Push(i); // J
      Push(Pop() * 4 + pp_UNK_0xdbe8); //  4 * UNK_0xdbe8 +
      Push(j); // I
      Push(-Pop() - 1 * 2); //  1- NEGATE 2*
      Push(Pop() + Pop()); // +
      Store_2(); // !_2
      j++;
    } while(j<jmax); // (LOOP)
...
void UNK_0xe8f7() // UNK_0xe8f7
{
  ...
  {
    Push(i); // I
    Push(Pop() * 6 + pp_UNK_0xdc40); //  6 * UNK_0xdc40 +
    Push(Read16(regsp)); // DUP
    Push(Read16(Pop())); //  @
    SWAP(); // SWAP
    Push(Read16(Pop() + 4)); //  4 + @
    Push(i); // I
    Push((Pop() * 2) * 2 + pp_UNK_0xdbe8); //  2* 2* UNK_0xdbe8 +
    a = Pop(); // >R
    Push(a); // I
    Store_2(); // !_2
    Push(a); // R>
...
void UNK_0xeaa3() // UNK_0xeaa3
{
  ...
  Push(Read16(Pop())); //  @
  Push(a); // I
  Push(Pop() + (Read16(pp__n_IN) - 1) * 4); //  #IN @ 1- 4 * +
  Push(Read16(regsp)); // DUP
  Push(Read16(Pop() + 2)); //  2+ @
  SWAP(); // SWAP
  Push(Read16(Pop())); //  @
...
// ================================================
// 0xf2b3: WORD 'UNK_0xf2b5' codep=0x224c parp=0xf2b5 params=0 returns=12
// ================================================
