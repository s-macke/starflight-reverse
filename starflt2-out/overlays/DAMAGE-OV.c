...
// ================================================
// 0xe74c: WORD 'UNK_0xe74e' codep=0x224c parp=0xe74e params=3 returns=1
// ================================================
...
// 0xe7b2: db 0x14 0x22 0x14 0x00 0x20 0x74 0x14 0x11 0x01 0x20 0x74 0x14 0x12 0x01 0x20 0x74 0x14 0x13 0x01 0x20 0x74 0x14 0x14 0x01 0x20 0x74 0x14 0x15 0x01 0x20 0x74 0x14 0x16 0x01 0x20 0x74 0x14 0x17 0x01 0x20 0x74 0x14 0x18 0x01 0x20 0x74 0x14 0x19 0x01 ' "   t    t    t    t    t    t    t    t    t   '

// ================================================
// 0xe7e3: WORD 'UNK_0xe7e5' codep=0x7420 parp=0xe7e5
// ================================================
IFieldType UNK_0xe7e5 = {SHIPIDX, 0x1a, 0x01};
// 0xe7e8: db 0x20 0x74 0x14 0x1b 0x01 0x20 0x74 0x14 0x1c 0x01 0x20 0x74 0x14 0x1d 0x01 0x20 0x74 0x14 0x1e 0x01 ' t    t    t    t   '

// ================================================
// 0xe7fc: WORD 'UNK_0xe7fe' codep=0x7420 parp=0xe7fe
// ================================================
IFieldType UNK_0xe7fe = {SHIPIDX, 0x30, 0x02};
// 0xe801: db 0x20 0x74 0x14 0x45 0x04 ' t E '

// ================================================
// 0xe806: WORD 'UNK_0xe808' codep=0x7420 parp=0xe808
// ================================================
IFieldType UNK_0xe808 = {SHIPIDX, 0x32, 0x02};
// 0xe80b: db 0x20 0x74 0x14 0x49 0x01 ' t I '
...
void UNK_0xe8a4() // UNK_0xe8a4
{
  ...
  if (Pop() != 0)
  {
    ...
    OVER(); // OVER
    Draw(); // .
    Push(0x65e1+UNK_0xe7a0.offset); // IFIELD
    Is(); // ?
    Push(0x65e1+UNK_0xe79b.offset); // IFIELD
    Is(); // ?
...
// ================================================
// 0xe90e: WORD 'UNK_0xe910' codep=0x224c parp=0xe910 params=2 returns=0
// ================================================
...
void UNK_0xe910() // UNK_0xe910
{
  ...
  _plus__ex__2(); // +!_2
  Push(1);
  Push(0x65e1+UNK_0xe817.offset); // IFIELD
  Push(Read16(regsp)); // DUP
  Push(Read8(Pop())&0xFF); // C@
  ROT(); // ROT
  Push(Pop() + Pop()); // +
...
// ================================================
// 0xe92e: WORD 'UNK_0xe930' codep=0x224c parp=0xe930 params=4 returns=1
// ================================================

void UNK_0xe930() // UNK_0xe930
{
  Push(0x65e1+UNK_0xe7fe.offset); // IFIELD
  Push(Read16(Pop())); // @
  ...
  Push(Read16(Pop())); // @
  if (Pop() == 0) Push(1); else Push(0); // NOT
  Push(0x65e1+UNK_0xe7e5.offset); // IFIELD
...
// ================================================
// 0xe988: WORD 'UNK_0xe98a' codep=0x224c parp=0xe98a params=6 returns=1
// ================================================

void UNK_0xe98a() // UNK_0xe98a
{
  Push(0x65e1+UNK_0xe808.offset); // IFIELD
  Push(Read16(Pop())); // @
  UNK_0xe726(); // UNK_0xe726
...
// ================================================
// 0xea08: WORD 'REFRESH' codep=0x224c parp=0xea14 params=6 returns=0
// ================================================
// entry
...
// ================================================
// 0xea48: WORD 'UNK_0xea4a' codep=0x224c parp=0xea4a params=2 returns=0
// ================================================
...
// ================================================
// 0xead2: WORD 'UNK_0xead4' codep=0x224c parp=0xead4 params=2 returns=1
// ================================================
...
void UNK_0xead4() // UNK_0xead4
{
  ...
  Get_gt_C_plus_S(); // @>C+S
  Push(0x65e1+UNK_0xe7af.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  ICLOSE(); // ICLOSE
}
...
// ================================================
// 0xeb53: WORD 'UNK_0xeb55' codep=0x224c parp=0xeb55 params=6 returns=0
// ================================================
...
void UNK_0xeb55() // UNK_0xeb55
{
  ...
  {
    Push(0);
    Push(0x65e1+UNK_0xe81c.offset); // IFIELD
    C_ex__2(); // C!_2
  }
  ICLOSE(); // ICLOSE
}
...
// ================================================
// 0xecc6: WORD 'UNK_0xecc8' codep=0x224c parp=0xecc8 params=2 returns=0
// ================================================

void UNK_0xecc8() // UNK_0xecc8
{
  unsigned short int a;
  Push(0x65e1+UNK_0xe821.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(Read16(regsp)); // DUP
  a = Pop(); // >R
  if (Pop() == 0) Push(1); else Push(0); // 0=
...
void UNK_0xed68() // UNK_0xed68
{
  ...
  if (Pop() != 0)
  {
    ...
    do // (DO)
    {
      ...
      {
        _gt_C_plus_S(); // >C+S
        Push(0x65e1+UNK_0xe82e.offset); // IFIELD
        COUNT(); // COUNT
...
void UNK_0xedc4() // UNK_0xedc4
{
  ...
  StoreID(); // !ID
  Push(8);
  Push(0x65e1+UNK_0xe7a5.offset); // IFIELD
  C_ex__2(); // C!_2
  CTINIT(); // CTINIT
  _gt_DISPLA(); // >DISPLA
  ...
  DrawTTY(); // .TTY
  Push(0);
  Push(0x65e1+UNK_0xe796.offset); // IFIELD
  C_ex__2(); // C!_2
  ...
  Push(pp_UNK_0xedbb); // UNK_0xedbb
  Push(0x65e1+UNK_0xe7aa.offset); // IFIELD
  Push(7);
  CMOVE_2(); // CMOVE_2
...
// ================================================
// 0xef1d: WORD 'UNK_0xef1f' codep=0x224c parp=0xef1f params=5 returns=0
// ================================================
...
// ================================================
// 0xeffd: WORD 'UNK_0xefff' codep=0x224c parp=0xefff params=5 returns=0
// ================================================
...
// ================================================
// 0xf011: WORD 'UNK_0xf013' codep=0x224c parp=0xf013 params=7 returns=0
// ================================================
...
void UNK_0xf437() // UNK_0xf437
{
  ...
  if (Pop() != 0)
  {
    ...
    _gt_C_plus_S(); // >C+S
    Push(0x000a);
    Push(0x65e1+UNK_0xe812.offset); // IFIELD
    _plus__ex__2(); // +!_2
    ICLOSE(); // ICLOSE
    Push2Words("*STARSH");
    _gt_C_plus_S(); // >C+S
