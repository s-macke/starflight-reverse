...
void UNK_0xedd3() // UNK_0xedd3
{
  ...
  label2:
  Push(0x65e1+UNK_0xeba3.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(0x0018);
  _st_(); // <
  if (Pop() == 0) goto label1;
  INEXT(); // INEXT
  Push(0x65e1+UNK_0xeb9e.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  _0_gt_(); // 0>
  Push(Pop() + Pop()); // +
  goto label2;
...
void UNK_0xef80() // UNK_0xef80
{
  ...
  IsMRC(); // ?MRC
  StoreCOLOR(); // !COLOR
  Push(0x65e1+UNK_0xeb7b.offset); // IFIELD
  Push(Read16(regsp)); // DUP
  Push(Read8(Pop())&0xFF); // C@
  if (Pop() != 0)
  {
  ...
  Push(pp_XBLT); // XBLT
  Store_2(); // !_2
  Push(0x65e1+UNK_0xeb99.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(3);
  DrawR(); // .R
  Push(0x004a);
  ...
  Push(a); // I
  UNK_0xecb7(); // UNK_0xecb7
  Push(0x65e1+UNK_0xeb80.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(3);
  DrawR(); // .R
  Push(0x0077);
  ...
  Push(a); // I
  UNK_0xecb7(); // UNK_0xecb7
  Push(0x65e1+UNK_0xeb85.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(3);
  DrawR(); // .R
  Push(0x004a);
  ...
  Push(a); // I
  UNK_0xecb7(); // UNK_0xecb7
  Push(0x65e1+UNK_0xeb8a.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(3);
  DrawR(); // .R
  Push(0x008d);
  ...
  Push(a); // I
  UNK_0xecb7(); // UNK_0xecb7
  Push(0x65e1+UNK_0xeb8f.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(3);
  DrawR(); // .R
  Push(0x004a);
  ...
  Push(a); // R>
  UNK_0xecb7(); // UNK_0xecb7
  Push(0x65e1+UNK_0xeb94.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(3);
  DrawR(); // .R
  Push(0x008d);
...
void UNK_0xf1cb() // UNK_0xf1cb
{
  ...
  do // (DO)
  {
    Push(0x65e1+UNK_0xeba8.offset); // IFIELD
    Push(i); // I
    Push(3);
    Push(Pop() * Pop()); // *
    Push(Pop() + Pop()); // +
