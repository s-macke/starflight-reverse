...
void UNK_0xe89c() // UNK_0xe89c
{
  ...
  do // (DO)
  {
    ...
    if (Pop() != 0)
    {
      ...
      Push(0x65e1+UNK_0xe39c.offset); // IFIELD
  ...
  if (Pop() != 0)
  {
    ...
    do // (DO)
    {
      ...
      if (Pop() != 0)
      {
        Push(pp_PAST); // PAST
        Push(Read16(Pop())); // @
        Push(0x65e1+UNK_0xe3a1.offset); // IFIELD
        Push(Read8(Pop())&0xFF); // C@
        Push(Pop() | Pop()); // OR
      } else
      {
...
void UNK_0xe9e0() // UNK_0xe9e0
{
  ...
  Push(Read16(Pop())); // @
  WLD_gt_SCR(); // WLD>SCR
  Push(0x65e1+UNK_0xe392.offset); // IFIELD
  Push(Read16(Pop())); // @
  Push(0x65e1+UNK_0xe397.offset); // IFIELD
  Push(Read16(Pop())); // @
  WLD_gt_SCR(); // WLD>SCR
  ICLOSE(); // ICLOSE
...
void UNK_0xeeeb() // UNK_0xeeeb
{
  ...
  Push(Read16(Pop())); // @
  _gt_FLAG(); // >FLAG
  Push(0x65e1+UNK_0xe35b.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  _gt_FLAG(); // >FLAG
  Push(Pop() & Pop()); // AND
  Push(pp_PAST); // PAST
  Push(Read16(Pop())); // @
  if (Pop() == 0) Push(1); else Push(0); // NOT
  Push(0x65e1+UNK_0xe360.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  _gt_FLAG(); // >FLAG
  Push(Pop() & Pop()); // AND
  Push(Pop() | Pop()); // OR
  Push(0x65e1+UNK_0xe365.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  if (Pop() != 0)
  {
    CI(); // CI
  ...
  Push(0x65e1+UNK_0xe356.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(Pop() & Pop()); // AND
}
...
void UNK_0xf131() // UNK_0xf131
{
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xe3a6.offset); // IFIELD
  Push(Pop()+1); // 1+
  Push(Read8(Pop())&0xFF); // C@
  Push(7);
  Push(Pop() & Pop()); // AND
