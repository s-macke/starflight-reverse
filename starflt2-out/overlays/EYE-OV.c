...
// ================================================
IFieldType UNK_0xebc6 = {SHIPIDX, 0x43, 0x02};

// ================================================
// 0xebc9: WORD 'UNK_0xebcb' codep=0x7420 parp=0xebcb
// ================================================
IFieldType UNK_0xebcb = {SHIPIDX, 0x1a, 0x01};

// ================================================
// 0xebce: WORD 'UNK_0xebd0' codep=0x7420 parp=0xebd0
// ================================================
IFieldType UNK_0xebd0 = {SHIPIDX, 0x30, 0x02};

// ================================================
// 0xebd3: WORD 'UNK_0xebd5' codep=0x224c parp=0xebd5 params=1 returns=1
// ================================================
...
// ================================================
// 0xebdd: WORD 'UNK_0xebdf' codep=0x224c parp=0xebdf params=0 returns=0
// ================================================
...
// ================================================
// 0xebe5: WORD 'UNK_0xebe7' codep=0x224c parp=0xebe7 params=0 returns=1
// ================================================
...
// ================================================
// 0xec63: WORD 'UNK_0xec65' codep=0x224c parp=0xec65 params=0 returns=0
// ================================================
...
// ================================================
// 0xec97: WORD 'UNK_0xec99' codep=0x224c parp=0xec99 params=1 returns=1
// ================================================
...
// ================================================
// 0xef0b: WORD 'UNK_0xef0d' codep=0x224c parp=0xef0d params=0 returns=1
// ================================================
...
// ================================================
// 0xef13: WORD 'UNK_0xef15' codep=0x224c parp=0xef15 params=1 returns=0
// ================================================
...
// ================================================
// 0xf076: WORD 'UNK_0xf078' codep=0x224c parp=0xf078 params=0 returns=1
// ================================================
...
// ================================================
// 0xf144: WORD 'UNK_0xf146' codep=0x224c parp=0xf146 params=1 returns=0
// ================================================
...
// ================================================
// 0xf182: WORD 'UNK_0xf184' codep=0x224c parp=0xf184 params=2 returns=0
// ================================================

void UNK_0xf184() // UNK_0xf184
{
  _2DUP(); // 2DUP
  Push(Pop() - Read16(cc_UNK_0xf17c)); //  UNK_0xf17c -
  SWAP(); // SWAP
  Push(Pop() - Read16(cc_UNK_0xf180)); //  UNK_0xf180 -
  SWAP(); // SWAP
  _2SWAP(); // 2SWAP
  Push(Pop() + Read16(cc_UNK_0xf174)); //  UNK_0xf174 +
  SWAP(); // SWAP
  Push(Pop() + Read16(cc_UNK_0xf178)); //  UNK_0xf178 +
  SWAP(); // SWAP
  StoreVISWIN(); // !VISWIN
}
...
// ================================================
// 0xf263: WORD 'UNK_0xf265' codep=0x224c parp=0xf265 params=1 returns=0
// ================================================
...
// ================================================
// 0xf295: WORD 'UNK_0xf297' codep=0x224c parp=0xf297 params=0 returns=0
// ================================================
...
// ================================================
// 0xf3f7: WORD 'UNK_0xf3f9' codep=0x224c parp=0xf3f9 params=0 returns=0
// ================================================
...
// ================================================
// 0xf409: WORD 'UNK_0xf40b' codep=0x224c parp=0xf40b params=3 returns=1
// ================================================
...
// ================================================
// 0xf4a3: WORD 'UNK_0xf4a5' codep=0x224c parp=0xf4a5 params=0 returns=0
// ================================================
