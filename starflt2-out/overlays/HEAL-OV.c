...
// 0xf0f3: db 0x94 0x73 0x10 0x13 0x01 0x14 0xc8 0x6a ' s     j'
...
// ================================================
// 0xf1bb: WORD 'ROLE-C' codep=0x224c parp=0xf1c6 params=6 returns=0
// ================================================
// entry
...
void ROLE_dash_C() // ROLE-C
{
  ...
  do // (DO)
  {
    ...
    Push(Pop() + Pop()); // +
    Get_gt_C_plus_S(); // @>C+S
    Push(0x65e1+UNK_0xf0eb.offset); // IFIELD
    Push(Read8(Pop())&0xFF); // C@
    if (Pop() == 0) Push(1); else Push(0); // 0=
    if (Pop() == 0) Push(1); else Push(0); // NOT
    Push(0x65e1+UNK_0xf0f0.offset); // IFIELD
    Push(Read16(Pop())); // @
    Push(0x0010);
    Push(Pop() & Pop()); // AND
    if (Pop() == 0) Push(1); else Push(0); // NOT
...
// ================================================
// 0xf266: WORD 'UNK_0xf268' codep=0x224c parp=0xf268 params=4 returns=1
// ================================================
...
void UNK_0xf268() // UNK_0xf268
{
  ...
  Push(0x65e1+UNK_0xf0c8.offset); // IFIELD
  Get_gt_C_plus_S(); // @>C+S
  Push(0x0104);
...
{
  CTINIT(); // CTINIT
  Push(0x65e1+UNK_0xf0cd.offset); // IFIELD
  COUNT(); // COUNT
  DrawTTY(); // .TTY
  PRINT(" IS HEALED", 10); // (.")
}
...
// ================================================
// 0xf2a1: WORD 'UNK_0xf2a3' codep=0x224c parp=0xf2a3 params=10 returns=0
// ================================================
...
// ================================================
// 0xf3ea: WORD 'UNK_0xf3ec' codep=0x224c parp=0xf3ec params=2 returns=0
// ================================================
...
// ================================================
// 0xf40a: WORD 'UNK_0xf40c' codep=0x224c parp=0xf40c params=2 returns=0
// ================================================
...
void UNK_0xf429() // UNK_0xf429
{
  ...
  Push2Words("*ASSIGN");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xf0be.offset); // IFIELD
  _1_dot_5_at_(); // 1.5@
...
// ================================================
// 0xf481: WORD 'UNK_0xf483' codep=0x224c parp=0xf483 params=4 returns=1
// ================================================
...
// ================================================
// 0xf49f: WORD 'UNK_0xf4a1' codep=0x224c parp=0xf4a1 params=2 returns=0
// ================================================
...
// ================================================
// 0xf4ab: WORD 'UNK_0xf4ad' codep=0x224c parp=0xf4ad params=6 returns=0
// ================================================
...
void UNK_0xf4ad() // UNK_0xf4ad
{
  ...
  if (Pop() != 0)
  {
    ...
    CI_i_(); // CI'
    _gt_C_plus_S(); // >C+S
    Push(0x65e1+UNK_0xf0c3.offset); // IFIELD
    _1_dot_5_at_(); // 1.5@
    Push(0x65e1+UNK_0xf0be.offset); // IFIELD
    _1_dot_5_ex__2(); // 1.5!_2
    ICLOSE(); // ICLOSE
...
// ================================================
// 0xf4d1: WORD 'UNK_0xf4d3' codep=0x224c parp=0xf4d3 params=6 returns=0
// ================================================
...
// ================================================
// 0xf523: WORD 'OBITS' codep=0x224c parp=0xf52d params=12 returns=0
// ================================================
// entry
...
// ================================================
// 0xf533: WORD 'KILL' codep=0x224c parp=0xf53c params=16 returns=0
// ================================================
// entry
...
// ================================================
// 0xf548: WORD 'HEAL' codep=0x224c parp=0xf551 params=22 returns=0
// ================================================
// entry
