...
// =========== DICTIONARY ==========
// =================================
//      UNK_0xf0c6  codep:0x7420 parp:0xf0c6 size:0x0003 C-string:'UNK_0xf0c6'
...
//      UNK_0xf0ef  codep:0x7394 parp:0xf0ef size:0x0006 C-string:'UNK_0xf0ef'
//      UNK_0xf0f7  codep:0x7420 parp:0xf0f7 size:0x0003 C-string:'UNK_0xf0f7'
//      UNK_0xf0fc  codep:0x7394 parp:0xf0fc size:0x0006 C-string:'UNK_0xf0fc'
//      UNK_0xf104  codep:0x7420 parp:0xf104 size:0x0003 C-string:'UNK_0xf104'
//      UNK_0xf109  codep:0x7420 parp:0xf109 size:0x0003 C-string:'UNK_0xf109'
//      UNK_0xf10e  codep:0x7394 parp:0xf10e size:0x0006 C-string:'UNK_0xf10e'
...
//      UNK_0xf4b4  codep:0x224c parp:0xf4b4 size:0x0006 C-string:'UNK_0xf4b4'
//      UNK_0xf4bc  codep:0x224c parp:0xf4bc size:0x003e C-string:'UNK_0xf4bc'
//       ICON-PARM  codep:0x224c parp:0xf508 size:0x0010 C-string:'ICON_dash_PARM'
//      UNK_0xf51a  codep:0x224c parp:0xf51a size:0x000c C-string:'UNK_0xf51a'
...
void UNK_0xf4bc() // UNK_0xf4bc
{
  ...
  if (Pop() != 0)
  {
    Push(Read16(pp_PAST) | (Read16(0x65e1+UNK_0xf109.offset)&0xFF) & 1); // PAST @ UNK_0xf109<IFIELD> C@ 1 AND OR
    return;
  }
  GetINST_dash_C(); // @INST-C
  ...
  if (Pop() != 0)
  {
    Push(!Read16(pp_PAST) | Read16(0x65e1+UNK_0xf0c6.offset)&0xFF); // PAST @ NOT UNK_0xf0c6<IFIELD> C@ OR
    return;
  }
  Push(1);
}
...
{
  Push(0xf51a); // probable 'UNK_0xf51a'
  ALL(); // ALL
}
