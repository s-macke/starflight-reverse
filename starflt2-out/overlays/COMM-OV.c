...
extern const unsigned short int pp__ask_NID; // ?NID
...
extern const unsigned short int pp__ask_MVT; // ?MVT
...
// ================================================
IFieldType UNK_0xd8d0 = {0x19, 0x12, 0x04};
