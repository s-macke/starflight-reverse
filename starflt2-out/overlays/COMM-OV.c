...
void UNK_0xddc5() // UNK_0xddc5
{
  ...
  Push(Pop() | Pop()); // OR
  Push(Read16(cc_UNK_0xd935)); // UNK_0xd935
  Push(Read16(pp_UNK_0xd931)); // UNK_0xd931 @
  Push(2);
  Push((Pop()==Pop())?1:0); // =
  Push(Pop() & Pop()); // AND
  if (Pop() != 0)
...
{
  Push(Read16(pp_P_dash_POSTU) & Read16(pp_UNK_0xd8ef)); // P-POSTU @ UNK_0xd8ef @ AND
  if (Pop() == 0) Push(1); else Push(0); // 0=
}
