...
//      UNK_0xd889  codep:0x7420 parp:0xd889 size:0x0003 C-string:'UNK_0xd889'
//      UNK_0xd88e  codep:0x7420 parp:0xd88e size:0x0003 C-string:'UNK_0xd88e'
//      UNK_0xd893  codep:0x7420 parp:0xd893 size:0x0003 C-string:'UNK_0xd893'
...
//      UNK_0xd8a2  codep:0x7420 parp:0xd8a2 size:0x0003 C-string:'UNK_0xd8a2'
//      UNK_0xd8a7  codep:0x7420 parp:0xd8a7 size:0x0003 C-string:'UNK_0xd8a7'
...
//      UNK_0xda7d  codep:0x2214 parp:0xda7d size:0x0002 C-string:'UNK_0xda7d'
//      UNK_0xda81  codep:0x7420 parp:0xda81 size:0x0003 C-string:'UNK_0xda81'
...
// ================================================
// 0xd804: WORD 'UNK_0xd806' codep=0x224c parp=0xd806 params=0 returns=2
// ================================================
...
{
  Push((Read16(0x65e1+UNK_0xd857.offset)&0xFF) + 1); // UNK_0xd857<IFIELD> C@ 1+
  MAX(); // MAX
}
...
// ================================================
// 0xd961: WORD 'UNK_0xd963' codep=0x224c parp=0xd963 params=2 returns=0
// ================================================
...
void A_gt_ORIGINATO() // A>ORIGINATO
{
  ...
  Store_2(); // !_2
  Push(Read16(pp_UNK_0xd8ff)); // UNK_0xd8ff @
...
// ================================================
// 0xdafe: WORD 'UNK_0xdb00' codep=0x224c parp=0xdb00 params=0 returns=0
// ================================================
...
void UNK_0xdb00() // UNK_0xdb00
{
  ...
  Push(pp_UNK_0xd907); // UNK_0xd907
  Store_2(); // !_2
  Push(Read16(pp_UNK_0xd8f3)); // UNK_0xd8f3 @
  Push(pp_UNK_0xd917); // UNK_0xd917
  Store_2(); // !_2
}
...
// ================================================
// 0xdb20: WORD 'UNK_0xdb22' codep=0x224c parp=0xdb22 params=0 returns=1
// ================================================
...
void UNK_0xdb22() // UNK_0xdb22
{
  ...
  Get_gt_C_plus_S(); // @>C+S
  Push(0x65e1+UNK_0xd834.offset); // UNK_0xd834<IFIELD>
  _plus__dash__at_(); // +-@
  ICLOSE(); // ICLOSE
}
...
// ================================================
// 0xdb2e: WORD 'UNK_0xdb30' codep=0x224c parp=0xdb30 params=0 returns=1
// ================================================
...
void UNK_0xdb30() // UNK_0xdb30
{
  Push(pp_UNK_0xda4f); // UNK_0xda4f
  Get_gt_C_plus_S(); // @>C+S
  Push(0x65e1+UNK_0xd839.offset); // UNK_0xd839<IFIELD>
  _plus__dash__at_(); // +-@
  ICLOSE(); // ICLOSE
}
...
// ================================================
// 0xdb93: WORD 'UNK_0xdb95' codep=0x224c parp=0xdb95 params=0 returns=0
// ================================================
...
{
  Push(Read16(pp_UNK_0xd8dd)==0x0012?1:0); // UNK_0xd8dd @ 0x0012 =
  if (Pop() != 0)
  {
    Push(0x03e8);
  } else
...
void UNK_0xdc1d() // UNK_0xdc1d
{
  ...
  Push(Read16(regsp)); // DUP
  Push(Read16(0x65e1+UNK_0xd857.offset)&0xFF); // UNK_0xd857<IFIELD> C@
  _st_(); // <
  Push(!Pop()); //  NOT
  OVER(); // OVER
  Push(Read16(0x65e1+UNK_0xd85c.offset)&0xFF); // UNK_0xd85c<IFIELD> C@
  _st_(); // <
  Push(!Pop()); //  NOT
  Push(Pop() + Pop()); // +
  SWAP(); // SWAP
  Push(Read16(0x65e1+UNK_0xd861.offset)&0xFF); // UNK_0xd861<IFIELD> C@
  _st_(); // <
  Push(!Pop()); //  NOT
  Push(Pop() + Pop()); // +
  Push(Read16(regsp)); // DUP
  ICLOSE(); // ICLOSE
  Push(Read16(pp_UNK_0xd9fb) - Read16(pp_A_dash_STREN)); // UNK_0xd9fb @ A-STREN @ -
  _2DUP(); // 2DUP
  Push(5);
  _gt_(); // >
  SWAP(); // SWAP
...
void UNK_0xdc83() // UNK_0xdc83
{
  ...
  Push(Read16(0x65e1+UNK_0xd848.offset)&0xFF); // UNK_0xd848<IFIELD> C@
  ICLOSE(); // ICLOSE
  Push(Pop() & Pop()); // AND
  if (Pop() != 0)
  {
...
// ================================================
// 0xdd13: WORD 'UNK_0xdd15' codep=0x224c parp=0xdd15 params=0 returns=0
// ================================================

void UNK_0xdd15() // UNK_0xdd15
{
  UNK_0xd806(); // UNK_0xd806
  Push(Read16(pp_UNK_0xd90b)); // UNK_0xd90b @
  Push(0x001b);
  U_star_(); // U*
  OVER(); // OVER
  Push(Pop() * 2); //  2*
...
// ================================================
// 0xdd33: WORD 'UNK_0xdd35' codep=0x224c parp=0xdd35 params=0 returns=0
// ================================================
...
void UNK_0xdd47() // UNK_0xdd47
{
  ...
  Push(a); // R>
  BIT(); // BIT
  Push(Pop() & Read16(pp_UNK_0xda61)); //  UNK_0xda61 @ AND
  _gt_FLAG(); // >FLAG
}
...
void UNK_0xdd59() // UNK_0xdd59
{
  ...
  do
  {
    Push(Read16(0x65e1+UNK_0xd82a.offset)&0xFF); // UNK_0xd82a<IFIELD> C@
    Push(Read16(pp_UNK_0xd923)); // UNK_0xd923 @
    _st_(); // <
    Push((Read16(0x65e1+UNK_0xd825.offset)&0xFF) & (Read16(pp_UNK_0xd907)&0xFF)); // UNK_0xd825<IFIELD> C@ UNK_0xd907 C@ AND
    _0_gt_(); // 0>
    Push(Pop() & Pop()); // AND
    Push((Read16(0x65e1+UNK_0xd820.offset)&0xFF) & Read16(pp_UNK_0xd931)); // UNK_0xd820<IFIELD> C@ UNK_0xd931 @ AND
    _0_gt_(); // 0>
    Push(Pop() & Pop()); // AND
    if (Pop() != 0)
    {
...
{
  Push(Read16(pp_UNK_0xd917)); // UNK_0xd917 @
  Push(Read16(regsp)); // DUP
  Push(1);
  Push(2);
  WITHIN(); // WITHIN
...
void UNK_0xddc5() // UNK_0xddc5
{
  ...
  Push(Pop() | Pop()); // OR
  Push(Read16(cc_UNK_0xd935) & (Read16(pp_UNK_0xd931)==2?1:0)); // UNK_0xd935 UNK_0xd931 @ 2 = AND
  if (Pop() != 0)
  {
...
void UNK_0xdf4e() // UNK_0xdf4e
{
  ...
  FILL_2(); // FILL_2
  ORIGINATOR_gt_(); // ORIGINATOR>
  Push(0x65e1+UNK_0xd87a.offset); // UNK_0xd87a<IFIELD>
  Get_gt_C_plus_S(); // @>C+S
  IOPEN(); // IOPEN
  Push(0x0010);
  Push(0);
  ...
  do // (DO)
  {
    ...
    Push(pp_LSCAN); // LSCAN
    Push(pp_UNK_0xdedc + i * 7); // UNK_0xdedc I 7 * +
    OVER(); // OVER
...
{
  Push(Pop() * 7 + pp_UNK_0xdedc); //  7 * UNK_0xdedc +
  COUNT(); // COUNT
}
...
void UNK_0xdfbd() // UNK_0xdfbd
{
  ...
  C_ex__2(); // C!_2
  ORIGINATOR_gt_(); // ORIGINATOR>
  Push(Read16(0x65e1+UNK_0xd875.offset)&0xFF); // UNK_0xd875<IFIELD> C@
  a = Pop(); // >R
  ICLOSE(); // ICLOSE
  Push(Read16(regsp)); // DUP
  Push(a); // R>
...
{
  Push(!Read16(cc_UNK_0xd935)); // UNK_0xd935 NOT
  Push(Read16(pp_P_dash_POSTU)); // P-POSTU @
  Push(4);
  _st_(); // <
  Push(Pop() & Pop()); // AND
...
{
  Push(Read16(cc_UNK_0xd9f7) & Read16(cc_UNK_0xd935)); // UNK_0xd9f7 UNK_0xd935 AND
  Push(3);
  PICK(); // PICK
  Push(3);
  PICK(); // PICK
  ...
  Push(0x00fa);
  MOD(); // MOD
  Push(Read16(pp_UNK_0xda55)); // UNK_0xda55 @
  _gt_(); // >
  Push(Pop() & Pop()); // AND
}
...
// ================================================
// 0xe105: WORD 'UNK_0xe107' codep=0x224c parp=0xe107 params=0 returns=0
// ================================================

void UNK_0xe107() // UNK_0xe107
{
  UNK_0xdb1a(); // UNK_0xdb1a
  Push(0x65e1+UNK_0xd82f.offset); // UNK_0xd82f<IFIELD>
  _plus__dash__at_(); // +-@
  ICLOSE(); // ICLOSE
  Push(pp__ro_ORIGIN); // (ORIGIN
  _1_dot_5_at_(); // 1.5@
...
void UNK_0xe2e3() // UNK_0xe2e3
{
  ...
  {
    UNK_0xe1c1(); // UNK_0xe1c1
    Push(Read16(pp_UNK_0xd8f7)==9?1:0); // UNK_0xd8f7 @ 9 =
    if (Pop() != 0)
    {
      Pop(); Pop(); // 2DROP
...
{
  Push(Read16(pp_UNK_0xd8dd)==2?1:0); // UNK_0xd8dd @ 2 =
}
...
{
  Push(Read16(pp_UNK_0xd8f7)); // UNK_0xd8f7 @
  IsS(); // ?S case
}
...
void UNK_0xe47b() // UNK_0xe47b
{
  ...
  UNK_0xdb1a(); // UNK_0xdb1a
  Push((Read16(0x65e1+UNK_0xd82a.offset)&0xFF) + 1); // UNK_0xd82a<IFIELD> C@ 1+
  Push(0x65e1+UNK_0xd82a.offset); // UNK_0xd82a<IFIELD>
  C_ex__2(); // C!_2
  IOPEN(); // IOPEN
  _i_KEY(); // 'KEY
  Pop(); // DROP
...
{
  unsigned short int a;
  Push(Read16(pp_UNK_0xd8dd)); // UNK_0xd8dd @
  Push(Read16(regsp)); // DUP
  Push(Read16(Pop() + pp_UNK_0xe280)&0xFF); //  UNK_0xe280 + C@
  a = Pop(); // >R
  Push(Read16(a)); // R@
...
void UNK_0xe4c9() // UNK_0xe4c9
{
  ...
  } else
  {
    ...
    do
    {
      INEXT(); // INEXT
      GetINST_dash_S(); // @INST-S
      Push(Pop()==Read16(pp_UNK_0xd8dd)?1:0); //  UNK_0xd8dd @ =
      if (Pop() != 0)
      {
        Push(0x65e1+UNK_0xd87f.offset); // UNK_0xd87f<IFIELD>
        _1_dot_5_at_(); // 1.5@
        Push(pp_UNK_0xd8e1); // UNK_0xd8e1
        _1_dot_5_ex__2(); // 1.5!_2
        UNK_0xdb1a(); // UNK_0xdb1a
...
{
  Push(Read16(Read16(pp_UNK_0xd8dd) + pp_UNK_0xe5c1)&0xFF); // UNK_0xd8dd @ UNK_0xe5c1 + C@
}
...
{
  Push(Read16(pp_UNK_0xd91b)); // UNK_0xd91b @
  Push(Read16(regsp)); // DUP
  Push(2);
  Push(4);
  WITHIN(); // WITHIN
...
{
  Push(Read16(pp_UNK_0xd8dd)==0x000b?1:0); // UNK_0xd8dd @ 0x000b =
}
...
{
  Push(Read16(pp_UNK_0xd8dd)==0x0013?1:0); // UNK_0xd8dd @ 0x0013 =
}
...
{
  UNK_0xdb5f(); // UNK_0xdb5f
  Push(Read16(pp_UNK_0xd8fb)&0xFF); // UNK_0xd8fb C@
  _slash_(); // /
  _plus__ex_EDL(); // +!EDL
}
...
void UNK_0xe6d8() // UNK_0xe6d8
{
  A_gt_ORIGINATO(); // A>ORIGINATO
  ORIGINATOR_gt_(); // ORIGINATOR>
  Push(Read16(0x65e1+UNK_0xd843.offset)&0xFF); // UNK_0xd843<IFIELD> C@
  ICLOSE(); // ICLOSE
}
...
void UNK_0xe827() // UNK_0xe827
{
  ...
  Push(Read16(pp_UNK_0xe563)); // UNK_0xe563 @
  if (Pop() != 0)
  {
    Push(5);
    Push(0);
...
{
  Push(Read16(Read16(pp_UNK_0xd8dd) + pp__ro__ask_RACE_rc_)&0xFF); // UNK_0xd8dd @ (?RACE) + C@
}
...
{
  Push(Read16(pp_UNK_0xd903)); // UNK_0xd903 @
  Push(Read16(pp_UNK_0xd91f)); // UNK_0xd91f @
  _st_(); // <
  Push(!Pop()); //  NOT
}
...
void UNK_0xea20() // UNK_0xea20
{
  ...
  Push(Read16(0x65e1+UNK_0xd8a2.offset)); // UNK_0xd8a2<IFIELD> @
  ICLOSE(); // ICLOSE
}
...
{
  UNK_0xd7fe(); // UNK_0xd7fe
  Push(0x65e1+UNK_0xd8a2.offset); // UNK_0xd8a2<IFIELD>
  Store_2(); // !_2
  ICLOSE(); // ICLOSE
}
...
{
  Push(Read16(pp_UNK_0xda65)==1?1:0); // UNK_0xda65 @ 1 =
}
...
{
  Push(Read16(pp_UNK_0xda65)==2?1:0); // UNK_0xda65 @ 2 =
}


// ================================================
// 0xea9a: WORD 'UNK_0xea9c' codep=0x224c parp=0xea9c params=0 returns=1
// ================================================
...
// ================================================
// 0xeaa6: WORD 'UNK_0xeaa8' codep=0x224c parp=0xeaa8 params=0 returns=1
// ================================================
...
{
  Push((Read16(pp_UNK_0xd8f3)&0xFF)==0x000d?1:0); // UNK_0xd8f3 C@ 0x000d =
}
...
{
  Push((Read16(pp_P_dash_POSTU) & Read16(pp_UNK_0xd8ef))==0?1:0); // P-POSTU @ UNK_0xd8ef @ AND 0=
}
...
void UNK_0xeaf2() // UNK_0xeaf2
{
  Push(Read16(pp_UNK_0xd8fb)&0xFF); // UNK_0xd8fb C@
  _0_gt_(); // 0>
  Push(Read16(pp_UNK_0xd903)&0xFF); // UNK_0xd903 C@
  _0_gt_(); // 0>
  Push(Pop() | Pop()); // OR
  Push(Read16(pp_TERMINA)); // TERMINA @
  UNK_0xda86(); // UNK_0xda86
  Push(Pop() & Read16(pp_UNK_0xe563)); //  UNK_0xe563 @ AND
}
...
{
  Push((Read16(pp_UNK_0xd8dd)==0x000a?1:0) | Read16(pp_IsUF)); // UNK_0xd8dd @ 0x000a = ?UF @ OR
}
...
void UNK_0xeb30() // UNK_0xeb30
{
  ...
  Push(0x0064);
  RRND(); // RRND
  Push(Read16(pp_UNK_0xd8dd)==0x0016?1:0); // UNK_0xd8dd @ 0x0016 =
  if (Pop() != 0)
  {
    Push(0x0064);
  } else
  ...
  A_gt_ORIGINATO(); // A>ORIGINATO
  UNK_0xde07(); // UNK_0xde07
  Push(!(Read16(pp_UNK_0xd917)==0x000e?1:0)); // UNK_0xd917 @ 0x000e = NOT
}
...
void UNK_0xeb70() // UNK_0xeb70
{
  ...
  UNK_0xe926(); // UNK_0xe926
  Push(Pop() & Pop()); // AND
  Push(Pop() | Read16(cc_UNK_0xd9ff)); //  UNK_0xd9ff OR
}
...
void UNK_0xee2b() // UNK_0xee2b
{
  ...
  UNK_0xde07(); // UNK_0xde07
  UNK_0xe47b(); // UNK_0xe47b
  Push(!(Read16(pp_UNK_0xd8f3)==1?1:0)); // UNK_0xd8f3 @ 1 = NOT
...
void UNK_0xee8f() // UNK_0xee8f
{
  ...
  Get_gt_C_plus_S(); // @>C+S
  GetINST_dash_S(); // @INST-S
  Push((Pop()==4?1:0) & ((Read16(0x65e1+UNK_0xd843.offset)&0xFF)==0?1:0)); //  4 = UNK_0xd843<IFIELD> C@ 0= AND
  if (Pop() != 0)
  {
    Push(0x0032);
    Push(0x65e1+UNK_0xd843.offset); // UNK_0xd843<IFIELD>
    C_ex__2(); // C!_2
  }
  ICLOSE(); // ICLOSE
}
...
void UNK_0xeeb8() // UNK_0xeeb8
{
  ...
  Push(Read16(pp_UNK_0xeeb3 + Read16(pp_THIS_dash_BU))&0xFF); // UNK_0xeeb3 THIS-BU @ + C@
...
void UNK_0xf04b() // UNK_0xf04b
{
  ...
  Push(pp__ro_AORIGI); // (AORIGI
  Get_gt_C_plus_S(); // @>C+S
  Push(Read16(0x65e1+UNK_0xd852.offset)&0xFF); // UNK_0xd852<IFIELD> C@
...
void UNK_0xf065() // UNK_0xf065
{
  ...
  Push(Pop()==7?1:0); //  7 =
  ICLOSE(); // ICLOSE
  Push(Pop() & (Read16(cc_UNK_0xd92d)==0?1:0)); //  UNK_0xd92d 0= AND
  if (Pop() == 0) return;
  Push(0);
  Push(0x000a);
  RRND(); // RRND
...
{
  Push(Read16(pp_UNK_0xd8dd)==4?1:0); // UNK_0xd8dd @ 4 =
  if (Pop() == 0) return;
  Push(0);
  Push(Read16(regsp)); // DUP
  Push(pp_EDL); // EDL
  Store_2(); // !_2
  Push(0x65e1+UNK_0xd84d.offset); // UNK_0xd84d<IFIELD>
  Store_2(); // !_2
}
...
void UNK_0xf165() // UNK_0xf165
{
  ...
  if (Pop() != 0)
  {
    ...
    if (Pop() != 0)
    {
      Push(!(Read16(pp_UNK_0xda65)==2?1:0)); // UNK_0xda65 @ 2 = NOT
      if (Pop() != 0)
      {
...
void CL1() // CL1
{
  ...
  do
  {
    ...
    Push(Read16(pp_UNK_0xd8fb) | Read16(pp_UNK_0xd903)); // UNK_0xd8fb @ UNK_0xd903 @ OR
    Push(pp__ro_AORIGI); // (AORIGI
    _1_dot_5_at_(); // 1.5@
    D0_eq_(); // D0=
    UNK_0xda86(); // UNK_0xda86
...
void UNK_0xf2c6() // UNK_0xf2c6
{
  ...
  Push(pp__pe_TALK); // %TALK
  Store_2(); // !_2
  Push(Read16(0x65e1+UNK_0xd84d.offset)&0xFF); // UNK_0xd84d<IFIELD> C@
  Push(pp_EDL); // EDL
  Store_2(); // !_2
  UNK_0xea38(); // UNK_0xea38
  Push(Pop() * 5); //  5 *
...
void UNK_0xf328() // UNK_0xf328
{
  ...
  if (Pop() != 0)
  {
    Push(Read16(a + pp_UNK_0xe280)&0xFF); // I UNK_0xe280 + C@
    Push(Read16(regsp)); // DUP
    Push(0xd9f7); // probable 'UNK_0xd9f7'
    Store_2(); // !_2
    if (Pop() != 0)
  ...
  Push(Pop() | Pop()); // OR
  Push(Read16(regsp)); // DUP
  Push(Pop() & Read16(cc_UNK_0xd913)); //  UNK_0xd913 AND
  UNK_0xeb1c(); // UNK_0xeb1c
  Push(Pop() | Pop()); // OR
  Push(0x51a0); // probable '?A-WEAP'
  Store_2(); // !_2
  UNK_0xe936(); // UNK_0xe936
  Push(Pop() | Pop()); // OR
  Push(Pop() & Read16(cc_UNK_0xd90f)); //  UNK_0xd90f AND
  UNK_0xeb1c(); // UNK_0xeb1c
  Push(Pop() | Pop()); // OR
  Push(0x5192); // probable '?A-SHIE'
  Store_2(); // !_2
...
void UNK_0xf3ce() // UNK_0xf3ce
{
  ...
  Push2Words("*ASSIGN");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xd898.offset); // UNK_0xd898<IFIELD>
  Get_gt_C_plus_S(); // @>C+S
  Push(0x65e1+UNK_0xd889.offset); // UNK_0xd889<IFIELD>
  Push(pp_UNK_0xda2b); // UNK_0xda2b
  _do__ex_(); // $!
  ICLOSE(); // ICLOSE
  Push(0);
  ...
  do // (DO)
  {
    Push((0x65e1+UNK_0xd898.offset) + i); // UNK_0xd898<IFIELD> I +
    Get_gt_C_plus_S(); // @>C+S
    GetINST_dash_S(); // @INST-S
    Push(Pop() + 1); //  1+
    BIT(); // BIT
...
void UNK_0xf45e() // UNK_0xf45e
{
  Push2Words("*ASSIGN");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xd89d.offset); // UNK_0xd89d<IFIELD>
  Get_gt_C_plus_S(); // @>C+S
  Push(Read16(0x65e1+UNK_0xd884.offset)&0xFF); // UNK_0xd884<IFIELD> C@
...
void IAPWR() // IAPWR
{
  ...
  do
  {
    ...
    if (Pop() != 0)
    {
      ...
      Push(Read16(Pop())&0xFF); //  C@
      Push(0x65e1+UNK_0xd8d0.offset); // UNK_0xd8d0<IFIELD>
      _2_at_(); // 2@
      Push(Pop() + Pop()); // +
      LoadData(UNK_0xd8c0); // from 'VESSEL'
      _2_at_(); // 2@
...
{
  UNK_0xd7fe(); // UNK_0xd7fe
  Push(0x65e1+UNK_0xd8ac.offset); // UNK_0xd8ac<IFIELD>
  UNK_0xf4e4(); // UNK_0xf4e4
  Push(0x65e1+UNK_0xd8b1.offset); // UNK_0xd8b1<IFIELD>
  UNK_0xf4e4(); // UNK_0xf4e4
  Push(Pop() + Pop()); // +
  Push(0x65e1+UNK_0xd8bb.offset); // UNK_0xd8bb<IFIELD>
  UNK_0xf4e4(); // UNK_0xf4e4
  Push(Pop() + Pop()); // +
  Push(0x65e1+UNK_0xd8b6.offset); // UNK_0xd8b6<IFIELD>
  UNK_0xf4e4(); // UNK_0xf4e4
  Push(Pop() + Pop()); // +
  ICLOSE(); // ICLOSE
  Push(0x000f);
