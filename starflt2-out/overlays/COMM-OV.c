...
void UNK_0xd963() // UNK_0xd963
{
  ...
  do // (DO)
  {
    ...
    LCMOVE(); // LCMOVE
    Push(a); // R>
    Push(Read16(pp_LSCAN)&0xFF); // LSCAN C@
    Push(Pop() + Pop()); // +
    Push(pp_LSCAN); // LSCAN
    C_ex__2(); // C!_2
    Push(Read16(cc_BL)); // BL
...
void UNK_0xdd47() // UNK_0xdd47
{
  ...
  Push(a); // R>
  BIT(); // BIT
  Push(Read16(pp_UNK_0xda61)); // UNK_0xda61 @
  Push(Pop() & Pop()); // AND
  _gt_FLAG(); // >FLAG
}
...
void UNK_0xee8f() // UNK_0xee8f
{
  ...
  Push(4);
  Push((Pop()==Pop())?1:0); // =
  Push((Read16(0x65e1+UNK_0xd843.offset)&0xFF)==0?1:0); // UNK_0xd843<IFIELD> C@ 0=
  Push(Pop() & Pop()); // AND
  if (Pop() != 0)
  {
    Push(0x0032);
...
void UNK_0xf065() // UNK_0xf065
{
  ...
  Push((Pop()==Pop())?1:0); // =
  ICLOSE(); // ICLOSE
  Push(Read16(cc_UNK_0xd92d)==0?1:0); // UNK_0xd92d 0=
  Push(Pop() & Pop()); // AND
  if (Pop() == 0) return;
  Push(0);
  Push(0x000a);
