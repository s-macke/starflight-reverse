...
void UNK_0xe7f4() // UNK_0xe7f4
{
  ...
  if (Pop() != 0)
  {
    Push(Read16(pp_UNK_0xe43a)); // UNK_0xe43a @
    if (Pop() == 0) Push(1); else Push(0); // NOT
    if (Pop() != 0)
    {
...
void UNK_0xe848() // UNK_0xe848
{
  ...
  if (Pop() != 0)
  {
    ...
    GetIH(); // @IH
    _gt_C_plus_S(); // >C+S
    Push(0x65e1+UNK_0xe4ec.offset); // IFIELD
    Push(3);
    Push(Pop() + Pop()); // +
    _2_at_(); // 2@
    D0_eq_(); // D0=
...
void UNK_0xeba3() // UNK_0xeba3
{
  ...
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xe53d.offset); // IFIELD
  _plus__ex__2(); // +!_2
  ICLOSE(); // ICLOSE
  Push(Read16(regsp)); // DUP
  Push(0xfff6);
...
void _gt_DESCEND() // >DESCEND
{
  ...
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xe4bf.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(0x00ef);
  Push(Pop() & Pop()); // AND
  Push(0x65e1+UNK_0xe4bf.offset); // IFIELD
...
void UNK_0xf28a() // UNK_0xf28a
{
  ...
  CTCR(); // CTCR
  Push(0x65e1+UNK_0xe51a.offset); // IFIELD
  Push(0x000f);
  Push(Read16(cc_BL)); // BL
  FILL_2(); // FILL_2
  Push(0x000f);
...
void UNK_0xf2c5() // UNK_0xf2c5
{
  ...
  Push(Read16(Pop())); // @
  ICLOSE(); // ICLOSE
  Push(0x65e1+UNK_0xe510.offset); // IFIELD
  C_ex__2(); // C!_2
}
...
void UNK_0xf303() // UNK_0xf303
{
  ...
  Push(Pop() * Pop()); // *
  Push(Pop() | Pop()); // OR
  Push(Read16(pp_PAST) * 0x0080); // PAST @ 0x0080 *
  Push(Pop() | Pop()); // OR
  UNK_0xf266(); // UNK_0xf266
  UNK_0xf272(); // UNK_0xf272
  ICLOSE(); // ICLOSE
  Push(0x65e1+UNK_0xe515.offset); // IFIELD
  C_ex__2(); // C!_2
}
...
void UNK_0xf353() // UNK_0xf353
{
  ...
  Push(0x65e1+UNK_0xe501.offset); // IFIELD
  C_ex__2(); // C!_2
}
...
void UNK_0xf385() // UNK_0xf385
{
  ...
  Push(0x65e1+UNK_0xe506.offset); // IFIELD
  Store_2(); // !_2
  CI_i_(); // CI'
  _gt_C_plus_S(); // >C+S
  Push(1);
  ...
  Push(Read16(Pop())); // @
  ICLOSE(); // ICLOSE
  Push(0x65e1+UNK_0xe50b.offset); // IFIELD
  Store_2(); // !_2
...
void UNK_0xf3dc() // UNK_0xf3dc
{
  ...
  Push(pp__ro_SYSTEM); // (SYSTEM
  Get_gt_C_plus_S(); // @>C+S
  Push(0x65e1+UNK_0xe529.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(Pop() & Pop()); // AND
  Push(Read16(regsp)); // DUP
  ROT(); // ROT
