...
void FREEB() // FREEB
{
  ...
  Push(0x0764);
  Push(0x65e1+UNK_0xe814.offset); // IFIELD
  Store_2(); // !_2
  Push(0x0664);
  Push(0x65e1+UNK_0xe819.offset); // IFIELD
  Store_2(); // !_2
  Push(0x0dac);
  Push(0x65e1+UNK_0xe81e.offset); // IFIELD
  Store_2(); // !_2
  ICLOSE(); // ICLOSE
}
...
void UNK_0xea10() // UNK_0xea10
{
  ...
  Get_gt_C_plus_S(); // @>C+S
  Push(0x00ff);
  Push(0x65e1+UNK_0xe80a.offset); // IFIELD
  C_ex__2(); // C!_2
  Push(0);
  Push(0x65e1+UNK_0xe80f.offset); // IFIELD
  C_ex__2(); // C!_2
  CI(); // CI
  ICLOSE(); // ICLOSE
...
void UNK_0xedfd() // UNK_0xedfd
{
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xe82b.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(0x0080);
  Push(Pop() | Pop()); // OR
  Push(0x65e1+UNK_0xe82b.offset); // IFIELD
