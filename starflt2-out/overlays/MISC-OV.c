...
void UNK_0xef36() // UNK_0xef36
{
  EINDE(); // EINDE case
  Push(Pop()*2); // 2*
  Push(0x65e1+UNK_0xef16.offset); // IFIELD
  Push(Pop() + Pop()); // +
  Push(Pop()+1); // 1+
  Push(Read16(regsp)); // DUP
...
void UNK_0xefae() // UNK_0xefae
{
  ...
  Push(0x65e1+SCNT.offset); // IFIELD
  Push(Read16(Pop())); // @
  Push(0x0dac);
  _gt_(); // >
  if (Pop() != 0)
...
void _eq_CARG() // =CARG
{
  ...
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x65e1+UNK_0xef20.offset); // IFIELD
  Push(Read16(Pop())); // @
  _plus_BIT(); // +BIT
  Push(Pop()+1); // 1+
  Push(0x01f4);
  ...
  _dash_(); // -
  Push(Read16(regsp)); // DUP
  Push(0x65e1+UNK_0xef25.offset); // IFIELD
  Store_2(); // !_2
  Push(0x000a);
  U_star_(); // U*
