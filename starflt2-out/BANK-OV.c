...
// 1886:    INIT-BALANCE  codep:0x224c parp:0xf048 size:0x000e C-string:'INIT_minus_BALANCE'
...
// 1901:        (U-BANK)  codep:0x224c parp:0xf4ff size:0x0061 C-string:'_ro_U_minus_BANK_rc_'
