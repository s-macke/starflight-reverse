...
{
  Push(pp_UNK_0xe448); // UNK_0xe448 size: 0
  ON_2(); // ON_2
}
...
void UNK_0xe72f() // UNK_0xe72f
{
  ...
  UNK_0x3f09("ELEMENTS");
  Push(pp_UNK_0xe43e); // UNK_0xe43e size: 0
  _1_dot_5_at_(); // 1.5@
  Push2Words("*STARSH");
  ...
  CDROP(); // CDROP
  ICLOSE(); // ICLOSE
  Push(pp_UNK_0xe43a); // UNK_0xe43a size: 0
  ON_2(); // ON_2
}
...
{
  Push(pp_UNK_0xe436); // UNK_0xe436 size: 0
  _099(); // 099
...
void UNK_0xe8d0() // UNK_0xe8d0
{
  ...
  _at_INST_dash_S(); // @INST-S
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xe542); // UNK_0xe542 size: 0
  _ex__2(); // !_2
  Push(cc__6); // 6
  _eq_(); // =
  _at_IL(); // @IL
...
{
  Push(pp_UNK_0xf1c0); // UNK_0xf1c0 size: 0
  _plus__ex__2(); // +!_2
}
...
void UNK_0xf353() // UNK_0xf353
{
  ...
  Push(Read8(Pop())&0xFF); // C@
  if (Pop() == 0) goto label1;
  Push(pp_UNK_0xe444); // UNK_0xe444 size: 0
  Push(Read16(Pop())); // @
  Push(cc__8); // 8
  MIN(); // MIN
  Push(0x000a);
