...
//      UNK_0xdd1a  codep:0x2214 parp:0xdd1a size:0x000a C-string:'UNK_0xdd1a'
...
//      UNK_0xdf87  codep:0x224c parp:0xdf87 size:0x0032 C-string:'UNK_0xdf87'
...
//      UNK_0xe003  codep:0x224c parp:0xe003 size:0x0026 C-string:'UNK_0xe003'
//      UNK_0xe02b  codep:0x1d29 parp:0xe02b size:0x0026 C-string:'UNK_0xe02b'
...
//      UNK_0xe571  codep:0x224c parp:0xe571 size:0x0099 C-string:'UNK_0xe571'
...
//      UNK_0xe6a4  codep:0x224c parp:0xe6a4 size:0x011b C-string:'UNK_0xe6a4'
...
//      UNK_0xeb72  codep:0x224c parp:0xeb72 size:0x004f C-string:'UNK_0xeb72'
...
//           LOAD.  codep:0x224c parp:0xeeba size:0x004a C-string:'LOAD_dot_'
...
const unsigned short int pp_UNK_0xe02b = 0xe02b; // UNK_0xe02b size: 38
// {0x3a, 0x20, 0x4c, 0x22, 0x25, 0xe0, 0x16, 0x6d, 0x29, 0xe0, 0x65, 0x6d, 0x90, 0x16, 0x4c, 0x22, 0x25, 0xe0, 0xae, 0x0b, 0x29, 0xe0, 0xae, 0x0b, 0x72, 0x0f, 0xf2, 0x0e, 0x41, 0x0e, 0x29, 0xe0, 0x23, 0x6d, 0x8a, 0x6d, 0x90, 0x16}
...
void UNK_0xde7e() // UNK_0xde7e
{
  ...
  RECSIZE(); // RECSIZE
  _ex__2(); // !_2
  Push(pp_UNK_0xde7a); // UNK_0xde7a size: 0
  _099(); // 099
  SYSTEM(); // SYSTEM
  SWAP(); // SWAP
...
void UNK_0xe1a5() // UNK_0xe1a5
{
  ...
  Push(pp_UNK_0xde1a); // UNK_0xde1a size: 0
  _ex__2(); // !_2
}
...
{
  Push(pp_UNK_0xe02b); // UNK_0xe02b size: 0
  _ex__2(); // !_2
  Push(pp_UNK_0xde62); // UNK_0xde62 size: 0
  _ex__2(); // !_2
}
...
{
  Push(pp_UNK_0xde42); // UNK_0xde42 size: 0
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xde3e); // UNK_0xde3e size: 0
  Push(Read16(Pop())); // @
  _dash_(); // -
  Push(pp_UNK_0xde52); // UNK_0xde52 size: 0
  Push(Read16(Pop())); // @
  _slash_(); // /
  Push(pp_UNK_0xde5a); // UNK_0xde5a size: 0
  _ex__2(); // !_2
}
...
{
  Push(pp_UNK_0xde46); // UNK_0xde46 size: 0
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xde4a); // UNK_0xde4a size: 0
  Push(Read16(Pop())); // @
  _dash_(); // -
  Push(pp_UNK_0xde4e); // UNK_0xde4e size: 0
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xde56); // UNK_0xde56 size: 0
  Push(Read16(Pop())); // @
  Push(Pop() + Pop()); // +
  _slash_(); // /
  Push(pp_UNK_0xde5e); // UNK_0xde5e size: 0
  _ex__2(); // !_2
}
...
void UNK_0xe29f() // UNK_0xe29f
{
  Push(pp_UNK_0xde62); // UNK_0xde62 size: 0
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xde6e); // UNK_0xde6e size: 0
  _ex__2(); // !_2
  Push(1); // 1
  Push(pp_UNK_0xde6a); // UNK_0xde6a size: 0
  _ex__2(); // !_2
...
void UNK_0xe30b() // UNK_0xe30b
{
  ...
  Push(pp_UNK_0xde6e); // UNK_0xde6e size: 0
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xde72); // UNK_0xde72 size: 0
  Push(Read16(Pop())); // @
...
void UNK_0xe652() // UNK_0xe652
{
  ...
  _i_KEY(); // 'KEY
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xde76); // UNK_0xde76 size: 0
  _ex__2(); // !_2
  Push(Pop() | Pop()); // OR
  if (Pop() == 0) goto label1;
  Pop(); Pop();// 2DROP
...
void UNK_0xea3f() // UNK_0xea3f
{
  ...
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  Push(pp_UNK_0xde16); // UNK_0xde16 size: 0
  _plus__ex__2(); // +!_2
  Push(1); // 1
  i += Pop();
...
void UNK_0xedf6() // UNK_0xedf6
{
  Push(cc_UNK_0xdd12); // UNK_0xdd12
  BLOCK_2(); // BLOCK_2
  Push(pp_UNK_0xdd32); // UNK_0xdd32 size: 0
  Push(0x00de);
  CMOVE_2(); // CMOVE_2
}
