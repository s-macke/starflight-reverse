...
// ================================================
// 0xed38: db 0x1c 0x1f 0x01 0x20 0xcd 0x6b 0x94 0x73 0x1c 0x1e 0x01 0x20 0xcd 0x6b '     k s     k'

// ================================================
// 0xed46: WORD 'UNK_0xed48' codep=0x7394 parp=0xed48
// ================================================
// 0xed48: db 0x44 0x14 0x02 0x22 0x07 0x6f 'D  " o'

// ================================================
// 0xed4e: WORD 'UNK_0xed50' codep=0x7394 parp=0xed50
// ================================================
// 0xed50: db 0x44 0x16 0x01 0x22 0x07 0x6f 'D  " o'

// ================================================
// 0xed56: WORD 'UNK_0xed58' codep=0x7394 parp=0xed58
// ================================================
// 0xed58: db 0x1a 0x16 0x01 0x17 0xa9 0x6b '     k'

// ================================================
// 0xed5e: WORD 'UNK_0xed60' codep=0x7394 parp=0xed60
// ================================================
// 0xed60: db 0x09 0x18 0x02 0x1b 0x54 0x6a '    Tj'
...
void UNK_0xee57() // UNK_0xee57
{
  ...
  Push(Read8(Pop())&0xFF); // C@
  ICLOSE(); // ICLOSE
  Push(pp_UNK_0xee23); // UNK_0xee23 size: 0
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
}
...
void UNK_0xee69() // UNK_0xee69
{
  ...
  Push(Read8(Pop())&0xFF); // C@
  ICLOSE(); // ICLOSE
  Push(pp_UNK_0xee1c); // UNK_0xee1c size: 0
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
}
...
void UNK_0xef03() // UNK_0xef03
{
  ...
  LoadData("UNK_0xebc6"); // from 'TRADERS     '
  Push(Read8(Pop())&0xFF); // C@
  Push(pp_UNK_0xee2a); // UNK_0xee2a size: 0
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  ICLOSE(); // ICLOSE
  Push(0x0018);
...
{
  Push(pp_UNK_0xf363); // UNK_0xf363 size: 0
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  Push(Read16(regsp)); // DUP
  Push(cc__8); // 8
