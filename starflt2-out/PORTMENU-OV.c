...
void UNK_0xed90() // UNK_0xed90
{
  ...
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xed8c); // UNK_0xed8c size: 0
  Push(Read16(Pop())); // @
  _dash_(); // -
  Push(0x0014);
  Push(Pop() * Pop()); // *
...
void UNK_0xef15() // UNK_0xef15
{
  TIME(); // TIME
  _2_at_(); // 2@
  Push(pp_UNK_0xef0f); // UNK_0xef0f size: 0
  _2_at_(); // 2@
  D_gt_(); // D>
}
...
void UNK_0xf00e() // UNK_0xf00e
{
  Push(2); // 2
  Push(Pop() * Pop()); // *
  Push(pp_UNK_0xeed4); // UNK_0xeed4 size: 0
  Push(Pop()+1); // 1+
  Push(Pop() + Pop()); // +
  _gt_R(); // >R
  Push(pp_XBLT); // XBLT size: 2
...
{
  Push(pp_UNK_0xf1d4); // UNK_0xf1d4 size: 0
  Push(0x000c);
  Push(Pop() + Pop()); // +
  Push(Read16(Pop())); // @
  Push(0x8040);
...
{
  _at_CRS(); // @CRS
  Push(pp_UNK_0xf1c6); // UNK_0xf1c6 size: 0
  Push(pp_UNK_0xf1be); // UNK_0xf1be size: 0
  Push(Read16(Pop())); // @
  Push(cc__3); // 3
  Push(Pop() * Pop()); // *
  Push(Pop() + Pop()); // +
  ...
  _ex__2(); // !_2
  Push(pp_UNK_0xf1c2); // UNK_0xf1c2 size: 0
...
void UNK_0xf3d0() // UNK_0xf3d0
{
  ...
  do // (DO)
  {
  Push(pp_UNK_0xf270); // UNK_0xf270 size: 0
  OVER(); // OVER
  Push(Pop() + Pop()); // +
  Push(i); // I
  Push(cc__4); // 4
