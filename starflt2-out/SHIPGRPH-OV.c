...
void _ro__dot_ACC_rc_() // (.ACC)
{
  ...
  _ex__2(); // !_2
  Push(pp_UNK_0xee59); // UNK_0xee59 size: 0
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
...
void UNK_0xefb0() // UNK_0xefb0
{
  ...
  Push(0x006a);
  POS_dot_(); // POS.
  Push(pp_UNK_0xed71); // UNK_0xed71 size: 0
  ...
  Push(0x004f);
  POS_dot_(); // POS.
  Push(pp_UNK_0xedb7); // UNK_0xedb7 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__2(); // !_2
  BLT(); // BLT
  Push(0x000a);
  ...
  Push(0x0059);
  POS_dot_(); // POS.
  Push(pp_UNK_0xedfd); // UNK_0xedfd size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__2(); // !_2
  BLT(); // BLT
  Push(0x0016);
  ...
  Push(0x005f);
  POS_dot_(); // POS.
  Push(pp_UNK_0xee31); // UNK_0xee31 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__2(); // !_2
  BLT(); // BLT
}
...
{
  Push(pp_UNK_0xf0dc); // UNK_0xf0dc size: 0
  Push(Read16(Pop())); // @
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xf0b8); // UNK_0xf0b8 size: 0
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  Push(pp_XBLT); // XBLT size: 2
  _ex__2(); // !_2
  Push(pp_UNK_0xf0ca); // UNK_0xf0ca size: 0
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
  Push(pp_YBLT); // YBLT size: 2
  _ex__2(); // !_2
...
void _ro__dot_PODS_rc_() // (.PODS)
{
  ...
  _ex__2(); // !_2
  Push(pp_UNK_0xee55); // UNK_0xee55 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__2(); // !_2
  Push(2); // 2
  Push(Read16(regsp)); // DUP
...
void UNK_0xf192() // UNK_0xf192
{
  ...
  Push(pp_YBLT); // YBLT size: 2
  _ex__2(); // !_2
  Push(pp_UNK_0xf182); // UNK_0xf182 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__2(); // !_2
  BLT(); // BLT
}
