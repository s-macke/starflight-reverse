...
// =========== DICTIONARY ==========
// =================================
// 1869:      UNK_0xf376  codep:0x7420 parp:0xf376 size:0x0003 C-string:'UNK_0xf376'
// 1870:      UNK_0xf37b  codep:0x224c parp:0xf37b size:0x0010 C-string:'UNK_0xf37b'
// 1871:          .NOFUN  codep:0x224c parp:0xf396 size:0x0030 C-string:'_dot_NOFUN'
// 1872:      UNK_0xf3c8  codep:0x224c parp:0xf3c8 size:0x002c C-string:'UNK_0xf3c8'
// 1873:      UNK_0xf3f6  codep:0x224c parp:0xf3f6 size:0x003e C-string:'UNK_0xf3f6'
// 1874:      UNK_0xf436  codep:0x224c parp:0xf436 size:0x0034 C-string:'UNK_0xf436'
// 1875:      UNK_0xf46c  codep:0x224c parp:0xf46c size:0x000c C-string:'UNK_0xf46c'
// 1876:      UNK_0xf47a  codep:0x224c parp:0xf47a size:0x0024 C-string:'UNK_0xf47a'
...
void UNK_0xf436() // UNK_0xf436
{
  ...
  DMAX(); // DMAX
  Push(0x634a); // pointer to TOWFINE
  D_ex_(); // D!
}
