...
// =========== DICTIONARY ==========
// =================================
// 1869:      UNK_0xaa59  codep:0x7420 parp:0xaa59 size:0x430b C-string:'UNK_0xaa59'
...
// 1890:         LO-MASS  codep:0xede2 parp:0xeeca size:0x0010 C-string:'LO_minus_MASS'
// 1891:         HI-MASS  codep:0xede2 parp:0xeee6 size:0x0010 C-string:'HI_minus_MASS'
...
// 1920:      UNK_0xf374  codep:0x224c parp:0xf374 size:0x0036 C-string:'UNK_0xf374'
// 1921:          CLIST1  codep:0x1d29 parp:0xf3b5 size:0x0014 C-string:'CLIST1'
// 1922:          CLIST2  codep:0x1d29 parp:0xf3d4 size:0x0014 C-string:'CLIST2'
// 1923:          CLIST3  codep:0x1d29 parp:0xf3f3 size:0x002a C-string:'CLIST3'
// 1924:          (SAND)  codep:0x1d29 parp:0xf428 size:0x009e C-string:'_ro_SAND_rc_'
// 1925:        (TERRAIN  codep:0x4b3b parp:0xf4d3 size:0x0018 C-string:'_ro_TERRAIN'
// 1926:      UNK_0xf4ed  codep:0x224c parp:0xf4ed size:0x0012 C-string:'UNK_0xf4ed'
// 1927:      UNK_0xf501  codep:0x224c parp:0xf501 size:0x001a C-string:'UNK_0xf501'
// 1928:        PLAN-RUL  codep:0x224c parp:0xf528 size:0x0038 C-string:'PLAN_minus_RUL'
