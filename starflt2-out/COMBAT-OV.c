...
void UNK_0xf4a8() // UNK_0xf4a8
{
  ...
  _gt_DISPLA(); // >DISPLA
  CTINIT(); // CTINIT
  Push(0x66e3); Pust(0x0002);
  UNK_0xde37(); // UNK_0xde37
  _dot_TTY(); // .TTY
  Push(0x670c); Pust(0x0002);
  UNK_0xde37(); // UNK_0xde37
  _dot_TTY(); // .TTY
