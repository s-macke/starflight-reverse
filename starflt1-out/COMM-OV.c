...
//      UNK_0xd970  codep:0x744d parp:0xd970 size:0x0008 C-string:'UNK_0xd970'
...
//      UNK_0xda0b  codep:0x1d29 parp:0xda0b size:0x0006 C-string:'UNK_0xda0b'
...
//      UNK_0xda69  codep:0x1d29 parp:0xda69 size:0x0006 C-string:'UNK_0xda69'
//      UNK_0xda71  codep:0x1d29 parp:0xda71 size:0x0002 C-string:'UNK_0xda71'
//      UNK_0xda75  codep:0x2214 parp:0xda75 size:0x0006 C-string:'UNK_0xda75'
...
//      UNK_0xdacf  codep:0x1d29 parp:0xdacf size:0x0006 C-string:'UNK_0xdacf'
...
//        P>AFIELD  codep:0x4a4f parp:0xdbbb size:0x001e C-string:'P_gt_AFIELD'
...
//      UNK_0xdd47  codep:0x224c parp:0xdd47 size:0x0034 C-string:'UNK_0xdd47'
...
//      UNK_0xdebb  codep:0x224c parp:0xdebb size:0x001c C-string:'UNK_0xdebb'
...
//      UNK_0xe4b2  codep:0x1d29 parp:0xe4b2 size:0x006a C-string:'UNK_0xe4b2'
//      UNK_0xe51e  codep:0x224c parp:0xe51e size:0x0006 C-string:'UNK_0xe51e'
//      UNK_0xe526  codep:0x224c parp:0xe526 size:0x0266 C-string:'UNK_0xe526'
//         (?RACE)  codep:0x4a4f parp:0xe798 size:0x003e C-string:'_ro__ask_RACE_rc_'
...
//      UNK_0xe7e8  codep:0x224c parp:0xe7e8 size:0x00cc C-string:'UNK_0xe7e8'
...
//      UNK_0xe912  codep:0x224c parp:0xe912 size:0x0032 C-string:'UNK_0xe912'
//      UNK_0xe946  codep:0x224c parp:0xe946 size:0x0050 C-string:'UNK_0xe946'
...
//      UNK_0xe9c2  codep:0x224c parp:0xe9c2 size:0x007c C-string:'UNK_0xe9c2'
...
const unsigned short int pp_UNK_0xda0b = 0xda0b; // UNK_0xda0b size: 6
...
const unsigned short int pp_UNK_0xda69 = 0xda69; // UNK_0xda69 size: 6
// {0x3a, 0x20, 0x14, 0x22, 0x00, 0x00}
...
const unsigned short int pp_UNK_0xdacf = 0xdacf; // UNK_0xdacf size: 6
// {0x3a, 0x20, 0x14, 0x22, 0x00, 0x00}
...
const unsigned short int pp_UNK_0xe4b2 = 0xe4b2; // UNK_0xe4b2 size: 106
// {0x00, 0x00, 0x4c, 0x22, 0x28, 0xa5, 0x16, 0x16, 0xca, 0x0e, 0x02, 0x00, 0x39, 0xd9, 0x47, 0xa5, 0x5d, 0x17, 0xf4, 0x01, 0xef, 0x2a, 0xa6, 0xdb, 0x46, 0xdb, 0x6b, 0xde, 0x80, 0xe4, 0x90, 0x16, 0x4c, 0x22, 0x83, 0x3b, 0xe7, 0xdc, 0x90, 0x16, 0x4c, 0x22, 0x5d, 0x17, 0xfb, 0xff, 0xe7, 0xdc, 0x90, 0x16, 0x4c, 0x22, 0x5d, 0x17, 0x0a, 0x00, 0xe7, 0xdc, 0x90, 0x16, 0x4c, 0x22, 0x5d, 0x17, 0xf6, 0xff, 0xe7, 0xdc, 0x90, 0x16, 0x4c, 0x22, 0x41, 0xda, 0xae, 0x0b, 0x41, 0x0e, 0x3d, 0x0f, 0x7b, 0x3b, 0x57, 0x40, 0xf2, 0x0e, 0x41, 0x0e, 0xb3, 0x0f, 0xb3, 0x0f, 0xe7, 0xdc, 0x90, 0x16, 0x4c, 0x22, 0x5d, 0x17, 0x64, 0x00, 0xe7, 0xdc, 0x90, 0x16}
...
void A_gt_ORIGINATOR() // A>ORIGINATOR
{
  ...
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xda2f); // UNK_0xda2f size: 0
  _ex__3(); // !_3
  Push(pp_UNK_0xda27); // UNK_0xda27 size: 0
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xda3f); // UNK_0xda3f size: 0
  _ex__3(); // !_3
  Push(0xda5d);
  ON_3(); // ON_3
}
...
void UNK_0xdb6a() // UNK_0xdb6a
{
  ...
  Push(pp__ro_ORIGIN); // (ORIGIN size: 4
  _1_dot_5_ex_(); // 1.5!
  Push(pp_UNK_0xda13); // UNK_0xda13 size: 0
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xda2f); // UNK_0xda2f size: 0
  _ex__3(); // !_3
...
{
  Push(pp_UNK_0xda05); // UNK_0xda05 size: 0
  _at__gt_C_plus_S(); // @>C+S
}
...
{
  Push(pp_UNK_0xdac5); // UNK_0xdac5 size: 0
  _at__gt_C_plus_S(); // @>C+S
...
void P_gt_AFIELD() // P>AFIELD
{
  ...
  case 2:
    ...
    break;
  case 8:
    UNK_0xd99d(); // UNK_0xd99d
    break;
  default:
    UNK_0xd993(); // UNK_0xd993
    break;

  }
}
// 0xdbc7: db 0x4c 0x22 0xfd 0x62 0x02 0x7a 0x11 0xda 0xae 0x0b 0xb9 0xdb 0xc3 0x4b 0xc9 0x79 0x90 0x16 'L" b z       K y  '
...
void UNK_0xdc40() // UNK_0xdc40
{
  ...
  _n_PHR(); // #PHR case
  RRND(); // RRND
  Push(pp_UNK_0xda47); // UNK_0xda47 size: 0
  _ex__3(); // !_3
}
...
void UNK_0xdc6f() // UNK_0xdc6f
{
  ...
  Push(Read16(Pop())); // @
  Push(pp_A_dash_STRENGTH); // A-STRENGTH size: 2
  Push(Read16(Pop())); // @
  _dash_(); // -
  _2DUP(); // 2DUP
  Push(cc__5); // 5
...
void _plus__ex_EDL() // +!EDL
{
  ...
  Push(pp_UNK_0xda1b); // UNK_0xda1b size: 0
  OFF(); // OFF
  Push(pp_UNK_0xda71); // UNK_0xda71 size: 0
  Push(Read16(Pop())); // @
  Push(cc__3); // 3
  _eq_(); // =
  Push(2); // 2
  ...
  C_ex_(); // C!
  ICLOSE(); // ICLOSE
  Push(pp__ro_ENCOUNTER); // (ENCOUNTER size: 4
  _1_dot_5_at_(); // 1.5@
  Push2Words("*HEAVEN");
  D_eq_(); // D=
  if (Pop() == 0) return;
...
void UNK_0xdd47() // UNK_0xdd47
{
  TIME(); // TIME
  _2_at_(); // 2@
  Push(pp_UNK_0xda33); // UNK_0xda33 size: 0
  Push(Read16(Pop())); // @
  Push(0x0037);
  U_star_(); // U*
  OVER(); // OVER
...
void UNK_0xddbf() // UNK_0xddbf
{
  Push(0); // 0
  Push(0x0100);
  Push(pp_UNK_0xda4b); // UNK_0xda4b size: 0
  _ex__3(); // !_3
...
{
  Push(pp_UNK_0xdf32); // UNK_0xdf32 size: 0
  Push(0x00e0);
  Push(cc_BL); // BL
  FILL_1(); // FILL_1
  ORIGINATOR_gt_C(); // ORIGINATOR>C
...
void UNK_0xe0c6() // UNK_0xe0c6
{
  ...
  Push(0x00fa);
  MOD(); // MOD
  Push(pp_UNK_0xdacb); // UNK_0xdacb size: 0
  Push(Read16(Pop())); // @
  _gt_(); // >
  Push(Pop() & Pop()); // AND
}
...
{
  Push(1); // 1
  Push(pp_UNK_0xdadb); // UNK_0xdadb size: 0
  _plus__ex_(); // +!
  Push(pp_UNK_0xdadb); // UNK_0xdadb size: 0
  Push(Read16(Pop())); // @
  Push(cc__7); // 7
...
{
  Push(pp_UNK_0xda7d); // UNK_0xda7d size: 0
  Push(Pop()+1); // 1+
  Push(Read16(regsp)); // DUP
  Push(Pop()-1); // 1-
  Push(Read8(Pop())&0xFF); // C@
...
{
  Push(pp_UNK_0xda8f); // UNK_0xda8f size: 0
  Push(Pop()+1); // 1+
  Push(Read16(regsp)); // DUP
  Push(Pop()-1); // 1-
  Push(Read8(Pop())&0xFF); // C@
...
{
  Push(pp_UNK_0xdaa1); // UNK_0xdaa1 size: 0
  Push(Pop()+1); // 1+
  Push(Read16(regsp)); // DUP
  Push(Pop()-1); // 1-
  Push(Read8(Pop())&0xFF); // C@
...
void UNK_0xe313() // UNK_0xe313
{
  ...
  Push(pp_UNK_0xdab3); // UNK_0xdab3 size: 0
  Push(Pop()+1); // 1+
  Push(Read16(regsp)); // DUP
  Push(Pop()-1); // 1-
  Push(Read8(Pop())&0xFF); // C@
...
// 0xe7bc: db 0x4c 0x22 0x6f 0xda 0xae 0x0b 0x96 0xe7 0x90 0x16 0x4c 0x22 0x2e 0x0f 0xd5 0xdc 0x90 0x16 0x4c 0x22 0x3d 0x0f 0xd5 0xdc 0x90 0x16 'L"o       L".     L"=     '
...
{
  Push(pp_UNK_0xda23); // UNK_0xda23 size: 0
  Push(Read8(Pop())&0xFF); // C@
  _0_gt_(); // 0>
...
void UNK_0xed77() // UNK_0xed77
{
  ...
  Push(pp_UNK_0xed72); // UNK_0xed72 size: 0
  Push(pp_THIS_dash_BU); // THIS-BU size: 2
  Push(Read16(Pop())); // @
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
...
void UNK_0xf330() // UNK_0xf330
{
  ...
  OFF(); // OFF
  Push(pp_UNK_0xdacf); // UNK_0xdacf size: 0
  OFF(); // OFF
