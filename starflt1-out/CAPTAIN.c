...
void UNK_0xdebc() // UNK_0xdebc
{
  ...
  Push(Pop()<<4); // 16*
  Push(Pop() + Pop()); // +
  Push(pp_UNK_0xde70); // UNK_0xde70 size: 0
  _ex__3(); // !_3
...
void UNK_0xdf3e() // UNK_0xdf3e
{
  ...
  RRND(); // RRND
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xde54); // UNK_0xde54 size: 0
  Push(i); // I
  Push(Pop() + Pop()); // +
  C_ex_(); // C!
  Push(pp_UNK_0xde5c); // UNK_0xde5c size: 0
  Push(i); // I
  Push(Pop() + Pop()); // +
  C_ex_(); // C!
  Push(0xfffd);
  ...
  RRND(); // RRND
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xde44); // UNK_0xde44 size: 0
  Push(i); // I
  Push(Pop() + Pop()); // +
  C_ex_(); // C!
  Push(pp_UNK_0xde4c); // UNK_0xde4c size: 0
  Push(i); // I
  Push(Pop() + Pop()); // +
  C_ex_(); // C!
  Push2Words("UNK_0xde6a");
...
{
  Push(pp__ro_THIS_dash_I); // (THIS-I size: 4
  _1_dot_5_at_(); // 1.5@
}
...
void UNK_0xe5c6() // UNK_0xe5c6
{
  ...
  CDROP(); // CDROP
  ICLOSE(); // ICLOSE
  Push(pp_UNK_0xde3a); // UNK_0xde3a size: 0
  ON_3(); // ON_3
}
...
{
  Push(pp_UNK_0xde36); // UNK_0xde36 size: 0
  OFF(); // OFF
...
void UNK_0xe767() // UNK_0xe767
{
  ...
  _at_INST_dash_SPECIES(); // @INST-SPECIES
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xe0d7); // UNK_0xe0d7 size: 0
  _ex__3(); // !_3
  Push(cc__6); // 6
  _eq_(); // =
  _at_IL(); // @IL
...
{
  Push(pp_UNK_0xed37); // UNK_0xed37 size: 0
  Push(Read16(Pop())); // @
  if (Pop() == 0) goto label1;
  UNK_0xecdf(); // UNK_0xecdf
  goto label2;
...
void UNK_0xedf7() // UNK_0xedf7
{
  ...
  Push(pp_UNK_0xed3b); // UNK_0xed3b size: 0
  _ex__3(); // !_3
  Push(pp_UNK_0xed37); // UNK_0xed37 size: 0
  OFF(); // OFF
  SetColor("BLUE");
...
void UNK_0xf007() // UNK_0xf007
{
  ...
  Push(Pop() & Pop()); // AND
  if (Pop() == 0) goto label2;
  Push(pp__i_LAUNCH); // 'LAUNCH size: 2
  Push(Read16(Pop())); // @
  MODULE(); // MODULE
  Push(Read16(regsp)); // DUP
  if (Pop() == 0) goto label3;
...
{
  Push(pp_UNK_0xf18d); // UNK_0xf18d size: 0
  _plus__ex_(); // +!
}
...
void UNK_0xf348() // UNK_0xf348
{
  ...
  Push(Read8(Pop())&0xFF); // C@
  if (Pop() == 0) goto label1;
  Push(pp_UNK_0xf2cc); // UNK_0xf2cc size: 0
  Push(Read16(Pop())); // @
  Push(cc__8); // 8
  MIN(); // MIN
  Push(0x000a);
