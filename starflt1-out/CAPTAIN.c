...
void UNK_0xdebc() // UNK_0xdebc
{
  ...
  Push(Pop()<<4); // 16*
  Push(Pop() + Pop()); // +
  Push(0xde70); // pointer to UNK_0xde70
  _ex__3(); // !_3
...
void UNK_0xdf3e() // UNK_0xdf3e
{
  ...
  RRND(); // RRND
  Push(Read16(regsp)); // DUP
  Push(0xde54); // pointer to UNK_0xde54
  Push(i); // I
  Push(Pop() + Pop()); // +
  C_ex_(); // C!
  Push(0xde5c); // pointer to UNK_0xde5c
  Push(i); // I
  Push(Pop() + Pop()); // +
  C_ex_(); // C!
  Push(0xfffd);
  ...
  RRND(); // RRND
  Push(Read16(regsp)); // DUP
  Push(0xde44); // pointer to UNK_0xde44
  Push(i); // I
  Push(Pop() + Pop()); // +
  C_ex_(); // C!
  Push(0xde4c); // pointer to UNK_0xde4c
  Push(i); // I
  Push(Pop() + Pop()); // +
  C_ex_(); // C!
  Push2Words("UNK_0xde6a");
...
void UNK_0xe5c6() // UNK_0xe5c6
{
  ...
  CDROP(); // CDROP
  ICLOSE(); // ICLOSE
  Push(0xde3a); // pointer to UNK_0xde3a
  ON_3(); // ON_3
}
...
{
  Push(0xde36); // pointer to UNK_0xde36
  OFF(); // OFF
...
void UNK_0xe767() // UNK_0xe767
{
  ...
  _at_INST_dash_SPECIES(); // @INST-SPECIES
  Push(Read16(regsp)); // DUP
  Push(0xe0d7); // pointer to UNK_0xe0d7
  _ex__3(); // !_3
  Push(cc__6); // 6
  _eq_(); // =
  _at_IL(); // @IL
...
{
  Push(0xed37); // pointer to UNK_0xed37
  Push(Read16(Pop())); // @
  if (Pop() == 0) goto label1;
  UNK_0xecdf(); // UNK_0xecdf
  goto label2;
...
void UNK_0xedf7() // UNK_0xedf7
{
  ...
  Push(0xed3b); // pointer to UNK_0xed3b
  _ex__3(); // !_3
  Push(0xed37); // pointer to UNK_0xed37
  OFF(); // OFF
  SetColor("BLUE");
...
{
  Push(0xf18d); // pointer to UNK_0xf18d
  _plus__ex_(); // +!
}
...
void UNK_0xf348() // UNK_0xf348
{
  ...
  Push(Read8(Pop())&0xFF); // C@
  if (Pop() == 0) goto label1;
  Push(0xf2cc); // pointer to UNK_0xf2cc
  Push(Read16(Pop())); // @
  Push(cc__8); // 8
  MIN(); // MIN
  Push(0x000a);
