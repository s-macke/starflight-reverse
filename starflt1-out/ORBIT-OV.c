...
void UNK_0xe462() // UNK_0xe462
{
  ...
  Push(0); // 0
  SWAP(); // SWAP
  ReadArray(0x9679, 0x0120); // FACET
  LC_at_(); // LC@
  Push(cc__4); // 4
  SWAP(); // SWAP
  ReadArray(0x93dd, 0x0324); // XFORMVERT
  L_at_(); // L@
  R_gt_(); // R>
  Push(0x003e);
  Push(Pop() + Pop()); // +
...
void UNK_0xe7a7() // UNK_0xe7a7
{
  ...
  Push(j); // I
  Push(i); // J
  ReadArray(0x9428, 0x0051); // 9X9COARSE
  LC_ex_(); // LC!
  j++;
...
void UNK_0xe80d() // UNK_0xe80d
{
  ...
  Push(i); // J
  _dash_(); // -
  ReadArray(0x91fe, 0x1811); // CONTOUR
  LC_at_(); // LC@
  Push(j); // I
  Push(i); // J
  ReadArray(0x9421, 0x0051); // 9X9FINE>GVERTEX
  LC_ex_(); // LC!
  j++;
...
void UNK_0xe865() // UNK_0xe865
{
  ...
  Push(j); // I
  OVER(); // OVER
  ReadArray(0x948d, 0x015f); // GVERTEX>GRIDCOLOR
  LC_at_(); // LC@
  Push(i); // J
  Push(cc__3); // 3
  Push(Pop() * Pop()); // *
...
void UNK_0xeb45() // UNK_0xeb45
{
  Push(0); // 0
  SWAP(); // SWAP
  ReadArray(0x9454, 0x00b2); // GRIDCOLOR
  OVER(); // OVER
  OVER(); // OVER
  LC_at_(); // LC@
  Push(pp_COLOR); // COLOR
