...
//      UNK_0xdcdc  codep:0x73ea parp:0xdcdc size:0x0042 C-string:'UNK_0xdcdc'
...
// 0xdce2: db 0x29 0x1d 0x8b 0xc1 0xc3 0x29 0x1d 0x8b 0xc2 0x03 0xc1 0x40 0xd1 0xf8 0x03 0xc1 0x40 0xd1 0xf8 0xc3 0x29 0x1d 0x8b 0xc2 0x03 0xc1 0x40 0xd1 0xf8 0xc3 0x29 0x1d 0x8b 0xc2 0x03 0xc1 0x40 0xd1 0xf8 0x03 0xc2 0x40 0xd1 0xf8 0xc3 0x29 0x1d 0x8b 0xc2 0xc3 0xe4 0xdc 0xe9 0xdc 0xf8 0xdc 0x02 0xdd 0x11 0xdd ')    )     @    @   )     @   )     @    @   )              '
...
void UNK_0xe865() // UNK_0xe865
{
  ...
  do // (DO)
  {
    ...
    do // (DO)
    {
      ...
      Push(j); // I
      Push(Pop() + Pop()); // +
      Push(Pop() + pp_UNK_0xdc64); //  UNK_0xdc64 +
      C_ex_(); // C!
      j++;
    } while(j<jmax); // (LOOP)
...
void UNK_0xe8a1() // UNK_0xe8a1
{
  ...
  do // (DO)
  {
    ...
    do // (DO)
    {
      ...
      L_at_(); // L@
      Push(i); // J
      Push(Pop() * 4 + pp_UNK_0xdc38); //  4 * UNK_0xdc38 +
      Push(j); // I
...
void UNK_0xe9b3() // UNK_0xe9b3
{
  ...
  {
    Push(i); // I
    Push(Pop() * 6 + pp_UNK_0xdc90); //  6 * UNK_0xdc90 +
    Push(Read16(regsp)); // DUP
    Push(Read16(Pop())); //  @
    SWAP(); // SWAP
    Push(Read16(Pop() + 4)); //  4 + @
    Push(i); // I
    Push((Pop() * 2) * 2 + pp_UNK_0xdc38); //  2* 2* UNK_0xdc38 +
    a = Pop(); // >R
    Push(a); // I
    Store_3(); // !_3
    Push(a); // R>
