...
//      UNK_0xdd78  codep:0x224c parp:0xdd78 size:0x000a C-string:'UNK_0xdd78'
//      UNK_0xdd84  codep:0x224c parp:0xdd84 size:0x0006 C-string:'UNK_0xdd84'
//      UNK_0xdd8c  codep:0x2214 parp:0xdd8c size:0x0002 C-string:'UNK_0xdd8c'
...
//      UNK_0xddb8  codep:0x744d parp:0xddb8 size:0x0003 C-string:'UNK_0xddb8'
//      UNK_0xddbd  codep:0x744d parp:0xddbd size:0x0003 C-string:'UNK_0xddbd'
...
//      UNK_0xddcc  codep:0x744d parp:0xddcc size:0x0003 C-string:'UNK_0xddcc'
//      UNK_0xddd1  codep:0x2214 parp:0xddd1 size:0x0002 C-string:'UNK_0xddd1'
//      UNK_0xddd5  codep:0x744d parp:0xddd5 size:0x0003 C-string:'UNK_0xddd5'
//      UNK_0xddda  codep:0x744d parp:0xddda size:0x0003 C-string:'UNK_0xddda'
//      UNK_0xdddf  codep:0x744d parp:0xdddf size:0x0003 C-string:'UNK_0xdddf'
//      UNK_0xdde4  codep:0x744d parp:0xdde4 size:0x0003 C-string:'UNK_0xdde4'
//      UNK_0xdde9  codep:0x744d parp:0xdde9 size:0x0003 C-string:'UNK_0xdde9'
//      UNK_0xddee  codep:0x744d parp:0xddee size:0x0003 C-string:'UNK_0xddee'
//      UNK_0xddf3  codep:0x744d parp:0xddf3 size:0x0003 C-string:'UNK_0xddf3'
//      UNK_0xddf8  codep:0x744d parp:0xddf8 size:0x0003 C-string:'UNK_0xddf8'
//      UNK_0xddfd  codep:0x744d parp:0xddfd size:0x0003 C-string:'UNK_0xddfd'
...
//      UNK_0xe055  codep:0x224c parp:0xe055 size:0x000a C-string:'UNK_0xe055'
//      UNK_0xe061  codep:0x224c parp:0xe061 size:0x0008 C-string:'UNK_0xe061'
...
//      UNK_0xe0ab  codep:0x224c parp:0xe0ab size:0x0006 C-string:'UNK_0xe0ab'
//      UNK_0xe0b3  codep:0x224c parp:0xe0b3 size:0x000c C-string:'UNK_0xe0b3'
...
//      UNK_0xe139  codep:0x224c parp:0xe139 size:0x000c C-string:'UNK_0xe139'
//      UNK_0xe147  codep:0x1d29 parp:0xe147 size:0x001e C-string:'UNK_0xe147'
...
//      UNK_0xe482  codep:0x224c parp:0xe482 size:0x000a C-string:'UNK_0xe482'
//      UNK_0xe48e  codep:0x224c parp:0xe48e size:0x000a C-string:'UNK_0xe48e'
...
//      UNK_0xec7b  codep:0x224c parp:0xec7b size:0x0006 C-string:'UNK_0xec7b'
//      UNK_0xec83  codep:0x224c parp:0xec83 size:0x0010 C-string:'UNK_0xec83'
...
//      UNK_0xf240  codep:0x224c parp:0xf240 size:0x00a8 C-string:'UNK_0xf240'
//      UNK_0xf2ea  codep:0x224c parp:0xf2ea size:0x0008 C-string:'UNK_0xf2ea'
...
const unsigned short int pp_UNK_0xe147 = 0xe147; // UNK_0xe147 size: 30
// {0x00, 0x00, 0x4c, 0x22, 0x4c, 0xdd, 0x5d, 0x17, 0x5a, 0x00, 0x46, 0x12, 0xfa, 0x15, 0x08, 0x00, 0x45, 0xe1, 0xac, 0x3b, 0x53, 0x13, 0x45, 0xe1, 0xae, 0x0b, 0x44, 0xdd, 0x90, 0x16}
...
const unsigned short int cc_UNK_0xdd8c = 0xdd8c; // UNK_0xdd8c
const unsigned short int cc_UNK_0xddd1 = 0xddd1; // UNK_0xddd1
...
// ================================================
// 0xdd4c: WORD 'UNK_0xdd4e' codep=0x224c parp=0xdd4e params=0 returns=1
// ================================================
...
// ================================================
// 0xdd58: WORD 'UNK_0xdd5a' codep=0x224c parp=0xdd5a params=0 returns=1
// ================================================
...
// ================================================
// 0xdd82: WORD 'UNK_0xdd84' codep=0x224c parp=0xdd84 params=0 returns=0
// ================================================
// orphan

void UNK_0xdd84() // UNK_0xdd84
{
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
}
...
// ================================================
// 0xdd8a: WORD 'UNK_0xdd8c' codep=0x2214 parp=0xdd8c
// ================================================
// orphan
// 0xdd8c: dw 0x0019
...
// ================================================
// 0xddbb: WORD 'UNK_0xddbd' codep=0x744d parp=0xddbd
// ================================================
// orphan
IFieldType UNK_0xddbd = {VESSELIDX, 0x12, 0x02};
...
// ================================================
// 0xddcf: WORD 'UNK_0xddd1' codep=0x2214 parp=0xddd1
// ================================================
// orphan
// 0xddd1: dw 0x0014

// ================================================
// 0xddd3: WORD 'UNK_0xddd5' codep=0x744d parp=0xddd5
// ================================================
// orphan
IFieldType UNK_0xddd5 = {SHIPIDX, 0x11, 0x01};

// ================================================
// 0xddd8: WORD 'UNK_0xddda' codep=0x744d parp=0xddda
// ================================================
// orphan
IFieldType UNK_0xddda = {SHIPIDX, 0x12, 0x01};
...
// ================================================
// 0xdde2: WORD 'UNK_0xdde4' codep=0x744d parp=0xdde4
// ================================================
// orphan
IFieldType UNK_0xdde4 = {SHIPIDX, 0x14, 0x01};

// ================================================
// 0xdde7: WORD 'UNK_0xdde9' codep=0x744d parp=0xdde9
// ================================================
// orphan
IFieldType UNK_0xdde9 = {SHIPIDX, 0x15, 0x01};

// ================================================
// 0xddec: WORD 'UNK_0xddee' codep=0x744d parp=0xddee
// ================================================
// orphan
IFieldType UNK_0xddee = {SHIPIDX, 0x16, 0x01};

// ================================================
// 0xddf1: WORD 'UNK_0xddf3' codep=0x744d parp=0xddf3
// ================================================
// orphan
IFieldType UNK_0xddf3 = {SHIPIDX, 0x17, 0x01};

// ================================================
// 0xddf6: WORD 'UNK_0xddf8' codep=0x744d parp=0xddf8
// ================================================
// orphan
IFieldType UNK_0xddf8 = {SHIPIDX, 0x18, 0x01};

// ================================================
// 0xddfb: WORD 'UNK_0xddfd' codep=0x744d parp=0xddfd
// ================================================
// orphan
IFieldType UNK_0xddfd = {SHIPIDX, 0x19, 0x01};
...
// ================================================
// 0xde57: WORD 'UNK_0xde59' codep=0x224c parp=0xde59 params=4 returns=1
// ================================================
...
// ================================================
// 0xde99: WORD 'UNK_0xde9b' codep=0x224c parp=0xde9b params=0 returns=0
// ================================================
...
// ================================================
// 0xdea9: WORD 'UNK_0xdeab' codep=0x224c parp=0xdeab params=0 returns=1
// ================================================
...
void UNK_0xdef1() // UNK_0xdef1
{
  ...
  if (Pop() != 0)
  {
    Push(0x63ef+UNK_0xddcc.offset); // UNK_0xddcc<IFIELD>
  } else
  {
    Push(0x63ef+UNK_0xde2a.offset); // UNK_0xde2a<IFIELD>
  }
  Push(Read16(Pop())&0xFF); //  C@
}
...
// ================================================
// 0xdf8a: WORD 'UNK_0xdf8c' codep=0x224c parp=0xdf8c params=0 returns=1
// ================================================
...
// ================================================
// 0xe017: WORD 'UNK_0xe019' codep=0x224c parp=0xe019 params=0 returns=1
// ================================================
...
void UNK_0xe025() // UNK_0xe025
{
  ...
  _1_dot_5_at_(); // 1.5@
  _gt_C_plus_S(); // >C+S
  Push(Read16(0x63ef+UNK_0xe00a.offset)&0xFF); // UNK_0xe00a<IFIELD> C@
  ICLOSE(); // ICLOSE
  UNK_0xdd46(); // UNK_0xdd46
}
...
// ================================================
// 0xe053: WORD 'UNK_0xe055' codep=0x224c parp=0xe055 params=0 returns=0
// ================================================
...
// ================================================
// 0xe05f: WORD 'UNK_0xe061' codep=0x224c parp=0xe061 params=0 returns=1
// ================================================
// orphan

void UNK_0xe061() // UNK_0xe061
{
  UNK_0xdd4e(); // UNK_0xdd4e
  Push(5);
  _st_(); // <
...
{
  Push(Read16(0x63ef+UNK_0xddb8.offset)&0xFF); // UNK_0xddb8<IFIELD> C@
  UNK_0xdd46(); // UNK_0xdd46
}
...
// ================================================
// 0xe0b1: WORD 'UNK_0xe0b3' codep=0x224c parp=0xe0b3 params=0 returns=1
// ================================================
// orphan

void UNK_0xe0b3() // UNK_0xe0b3
{
...
// ================================================
// 0xe0c9: WORD 'UNK_0xe0cb' codep=0x224c parp=0xe0cb params=1 returns=0
// ================================================
...
// ================================================
// 0xe0d9: WORD 'UNK_0xe0db' codep=0x224c parp=0xe0db params=0 returns=1
// ================================================
...
void UNK_0xe0f1() // UNK_0xe0f1
{
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x63ef+UNK_0xde0c.offset); // UNK_0xde0c<IFIELD>
  UNK_0xde77(); // UNK_0xde77
  UNK_0xdd46(); // UNK_0xdd46
  Push(0x63ef+UNK_0xde07.offset); // UNK_0xde07<IFIELD>
...
void UNK_0xe109() // UNK_0xe109
{
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x63ef+UNK_0xde16.offset); // UNK_0xde16<IFIELD>
  UNK_0xde77(); // UNK_0xde77
  UNK_0xdd46(); // UNK_0xdd46
  Push(0x63ef+UNK_0xde11.offset); // UNK_0xde11<IFIELD>
  UNK_0xde81(); // UNK_0xde81
  UNK_0xdd46(); // UNK_0xdd46
  Push(Pop() & Pop()); // AND
  ICLOSE(); // ICLOSE
...
// ================================================
// 0xe145: WORD 'UNK_0xe147' codep=0x1d29 parp=0xe147
// ================================================
// orphan
// 0xe147: db 0x00 0x00 0x4c 0x22 0x4c 0xdd 0x5d 0x17 0x5a 0x00 0x46 0x12 0xfa 0x15 0x08 0x00 0x45 0xe1 0xac 0x3b 0x53 0x13 0x45 0xe1 0xae 0x0b 0x44 0xdd 0x90 0x16 '  L"L ] Z F     E  ;S E   D   '
...
{
  Push((Read16(0x63ef+UNK_0xde20.offset)&0xFF) & 8); // UNK_0xde20<IFIELD> C@ 8 AND
  UNK_0xdd46(); // UNK_0xdd46
}
...
{
  Push(Read16(0x63ef+UNK_0xde1b.offset)); // UNK_0xde1b<IFIELD> @
  UNK_0xdd46(); // UNK_0xdd46
...
{
  Push(Read16(0x63ef+UNK_0xde25.offset)); // UNK_0xde25<IFIELD> @
  UNK_0xdd46(); // UNK_0xdd46
...
// 0xe211: call   1649
  Push((Read16(Pop())&0xFF) + Read16(pp_UNK_0xe1f7)); //  C@ UNK_0xe1f7 @ +
}
...
{
  Push(Pop() * Read16(cc_UNK_0xe1ff) + pp_MARRAY); //  UNK_0xe1ff * MARRAY +
...
// ================================================
// 0xe65e: WORD 'UNK_0xe660' codep=0x224c parp=0xe660 params=0 returns=0
// ================================================
...
void UNK_0xe9df() // UNK_0xe9df
{
  ...
  Push((Read16(0x63ef+UNK_0xddcc.offset)&0xFF) + 4); // UNK_0xddcc<IFIELD> C@ 4 +
  Push(8);
  MOD(); // MOD
  Push(Read16(regsp)); // DUP
  Push(0x63ef+UNK_0xddcc.offset); // UNK_0xddcc<IFIELD>
...
{
  Push(0x63ef+UNK_0xdddf.offset); // UNK_0xdddf<IFIELD>
  Push(Read16(regsp)); // DUP
  UNK_0xde81(); // UNK_0xde81
  _0_gt_(); // 0>
  SWAP(); // SWAP
...
// ================================================
// 0xeab9: WORD 'UNK_0xeabb' codep=0x224c parp=0xeabb params=0 returns=0
// ================================================
...
// ================================================
// 0xeb61: WORD 'UNK_0xeb63' codep=0x224c parp=0xeb63 params=0 returns=0
// ================================================
...
// ================================================
// 0xec81: WORD 'UNK_0xec83' codep=0x224c parp=0xec83 params=2 returns=2
// ================================================
// orphan
...
void UNK_0xec95() // UNK_0xec95
{
  ...
  Push(3);
  Push(0x63ef+UNK_0xddc7.offset); // UNK_0xddc7<IFIELD>
  C_ex_(); // C!
  Push(pp_UNK_0xde55); // UNK_0xde55
  ON_3(); // ON_3
...
// ================================================
// 0xed98: WORD 'UNK_0xed9a' codep=0x224c parp=0xed9a params=1 returns=0
// ================================================
...
{
  Push(Read16(0x63ef+UNK_0xde1b.offset)); // UNK_0xde1b<IFIELD> @
  Push(0x63ef+UNK_0xde02.offset); // UNK_0xde02<IFIELD>
  UNK_0xde77(); // UNK_0xde77
...
{
  Push(Read16(0x63ef+UNK_0xddc2.offset)); // UNK_0xddc2<IFIELD> @
...
void UNK_0xef20() // UNK_0xef20
{
  ...
  if (Pop() == 0) return;
  Push(0x0014);
  Push(0x63ef+UNK_0xde1b.offset); // UNK_0xde1b<IFIELD>
  _plus__ex__2(); // +!_2
}
...
{
  Push((Read16(0x63ef+UNK_0xde20.offset)&0xFF) & 1); // UNK_0xde20<IFIELD> C@ 1 AND
}
...
// ================================================
// 0xf0b4: WORD 'UNK_0xf0b6' codep=0x224c parp=0xf0b6 params=1 returns=2
// ================================================
...
void UNK_0xf0d8() // UNK_0xf0d8
{
  ...
  _gt_C_plus_S(); // >C+S
  Push(0x63ef+UNK_0xde2f.offset); // UNK_0xde2f<IFIELD>
  _1_dot_5_at_(); // 1.5@
  _gt_C_plus_S(); // >C+S
  Push(Read16(0x63ef+UNK_0xde34.offset)&0xFF); // UNK_0xde34<IFIELD> C@
  a = Pop(); // >R
...
void UNK_0xf2f4() // UNK_0xf2f4
{
  ...
  Store_3(); // !_3
  Push(0xf2ea); // probable 'UNK_0xf2ea'
