...
//      UNK_0xe147  codep:0x1d29 parp:0xe147 size:0x0002 C-string:'UNK_0xe147'
//      UNK_0xe14b  codep:0x224c parp:0xe14b size:0x001a C-string:'UNK_0xe14b'
...
const unsigned short int pp_UNK_0xe147 = 0xe147; // UNK_0xe147 size: 2
// {0x00, 0x00}
...
// ================================================
// 0xe149: WORD 'UNK_0xe14b' codep=0x224c parp=0xe14b params=0 returns=1
// ================================================
// orphan

void UNK_0xe14b() // UNK_0xe14b
{
  UNK_0xdd4e(); // UNK_0xdd4e
  Push(0x005a);
  _st_(); // <
  if (Pop() != 0)
  {
    Push(pp_UNK_0xe147); // UNK_0xe147
    Push(-1);
    TOGGLE(); // TOGGLE
  }
  Push(Read16(pp_UNK_0xe147)); // UNK_0xe147 @
  UNK_0xdd46(); // UNK_0xdd46
}
