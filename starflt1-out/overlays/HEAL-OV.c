...
void ROLE_dash_C() // ROLE-C
{
  ...
  do // (DO)
  {
    ...
    Push(Pop() + Pop()); // +
    Get_gt_C_plus_S(); // @>C+S
    Push(0x63ef+UNK_0xf11d.offset); // IFIELD
...
void UNK_0xf292() // UNK_0xf292
{
  ...
  Push(0x63ef+UNK_0xf0fa.offset); // IFIELD
  Get_gt_C_plus_S(); // @>C+S
  Push(0x0104);
...
{
  CTINIT(); // CTINIT
  Push(0x63ef+UNK_0xf0ff.offset); // IFIELD
  COUNT(); // COUNT
  DrawTTY(); // .TTY
  PRINT(" IS HEALED", 10); // (.")
}
...
void UNK_0xf2cd() // UNK_0xf2cd
{
  ...
  do // (DO)
  {
    ...
    if (Pop() != 0)
    {
      ...
      if (Pop() != 0)
      {
        Push(0x63ef+UNK_0xf122.offset); // IFIELD
        Push(Read8(Pop())&0xFF); // C@
        Push(4);
        Push(Pop() & Pop()); // AND
        if (Pop() == 0) Push(1); else Push(0); // 0=
...
void UNK_0xf42f() // UNK_0xf42f
{
  ...
  Push2Words("*ASSIGN-CREW");
  _gt_C_plus_S(); // >C+S
  Push(0x63ef+UNK_0xf0f0.offset); // IFIELD
  _1_dot_5_at_(); // 1.5@
...
void UNK_0xf497() // UNK_0xf497
{
  ...
  if (Pop() != 0)
  {
    ...
    CI_i_(); // CI'
    _gt_C_plus_S(); // >C+S
    Push(0x63ef+UNK_0xf0f5.offset); // IFIELD
    _1_dot_5_at_(); // 1.5@
    Push(0x63ef+UNK_0xf0f0.offset); // IFIELD
    _1_dot_5_ex_(); // 1.5!
    ICLOSE(); // ICLOSE
