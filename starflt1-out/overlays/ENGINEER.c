...
void UNK_0xed5c() // UNK_0xed5c
{
  ...
  Push(Pop()*2); // 2*
  Push(0x63ef+UNK_0xec70.offset); // IFIELD
  Push(Pop() + Pop()); // +
  a = Pop(); // >R
  Push(a); // I
  Push(Pop()+1); // 1+
...
// ================================================
// 0xf059: WORD 'UNK_0xf05b' codep=0x224c parp=0xf05b params=4 returns=0
// ================================================
...
// ================================================
// 0xf07e: WORD 'UNK_0xf080' codep=0x224c parp=0xf080 params=4 returns=0
// ================================================
...
void UNK_0xf0cb() // UNK_0xf0cb
{
  ...
  _gt_C_plus_S(); // >C+S
  Push(0x63ef+UNK_0xec6b.offset); // IFIELD
  Get_gt_C_plus_S(); // @>C+S
  Push(0x00fb);
  Push(0x63ef+UNK_0xec66.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  _dash_(); // -
  Push(0x0064);
  ROT(); // ROT
...
// ================================================
// 0xf0fd: WORD 'UNK_0xf0ff' codep=0x224c parp=0xf0ff params=3 returns=0
// ================================================
