...
void UNK_0xea0b() // UNK_0xea0b
{
  ...
  do
  {
    ...
    {
      Push(a); // I
      Push(Pop() + (Read16(0x63ef+UNK_0xe950.offset)&0xFF)); //  UNK_0xe950<IFIELD> C@ +
      Push(0x0064);
      MIN(); // MIN
...
void UNK_0xef75() // UNK_0xef75
{
  ...
  Push(Read16(Pop() + 2)&0xFF); //  2+ C@
  Push(a); // R>
  Push((Read16(Pop() + 6)&0xFF) & 1); //  6 + C@ 1 AND
  if (Pop() != 0)
  {
    MIN(); // MIN
    return;
...
void UNK_0xefd5() // UNK_0xefd5
{
  ...
  Push(Read16(Pop())&0xFF); //  C@
  Push(a); // R>
  Push((Read16(Pop() + 6)&0xFF) & 2); //  6 + C@ 2 AND
  if (Pop() != 0)
  {
    MIN(); // MIN
    return;
...
void UNK_0xf239() // UNK_0xf239
{
  ...
  do // (DO)
  {
    Push(pp_UNK_0xeeb5 + 1); // UNK_0xeeb5 1+
    Push(i); // I
    Push(Pop() + Pop()); // +
    a = Pop(); // >R
    Push(a); // I
