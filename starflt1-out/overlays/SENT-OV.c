...
//      UNK_0xe518  codep:0x73ea parp:0xe518 size:0x0026 C-string:'UNK_0xe518'
...
//      UNK_0xe5b0  codep:0x73ea parp:0xe5b0 size:0x00c6 C-string:'UNK_0xe5b0'
...
// ================================================
// 0xe2d4: WORD 'UNK_0xe2d6' codep=0x2214 parp=0xe2d6 orphan
// ================================================
// 0xe2d6: dw 0x001c

// ================================================
// 0xe2d8: WORD 'UNK_0xe2da' codep=0x2214 parp=0xe2da orphan
// ================================================
// 0xe2da: dw 0x0039
...
// ================================================
// 0xe2fc: WORD 'UNK_0xe2fe' codep=0x224c parp=0xe2fe orphan
// ================================================
...
// ================================================
// 0xe308: WORD 'UNK_0xe30a' codep=0x224c parp=0xe30a orphan
// ================================================
...
// ================================================
// 0xe3e9: WORD 'UNK_0xe3eb' codep=0x224c parp=0xe3eb orphan params=2 returns=3
// ================================================
...
// ================================================
// 0xe427: WORD 'UNK_0xe429' codep=0x224c parp=0xe429 orphan params=3 returns=1
// ================================================
...
// ================================================
// 0xe42f: WORD 'UNK_0xe431' codep=0x2214 parp=0xe431 orphan
// ================================================
// 0xe431: dw 0x002e
...
// ================================================
// 0xe486: WORD 'UNK_0xe488' codep=0x224c parp=0xe488 orphan
// ================================================
...
// ================================================
// 0xe4b1: WORD 'UNK_0xe4b3' codep=0x744d parp=0xe4b3 orphan
// ================================================
...
// ================================================
// 0xe4be: WORD 'UNK_0xe4c0' codep=0x73ea parp=0xe4c0 orphan
// ================================================
LoadDataType UNK_0xe4c0 = {ARTIFACTIDX, 0x1d, 0x01, 0x1e, 0x652c};

// ================================================
// 0xe4c6: WORD 'UNK_0xe4c8' codep=0x73ea parp=0xe4c8 orphan
// ================================================
...
// ================================================
// 0xe4d6: WORD 'UNK_0xe4d8' codep=0x73ea parp=0xe4d8 orphan
// ================================================
...
// ================================================
// 0xe4e6: WORD 'UNK_0xe4e8' codep=0x73ea parp=0xe4e8 orphan
// ================================================
LoadDataType UNK_0xe4e8 = {CREATUREIDX, 0x0d, 0x03, 0x9c, 0x69d8};

// ================================================
// 0xe4ee: WORD 'UNK_0xe4f0' codep=0x73ea parp=0xe4f0 orphan
// ================================================
...
// ================================================
// 0xe4fe: WORD 'UNK_0xe500' codep=0x73ea parp=0xe500 orphan
// ================================================
LoadDataType UNK_0xe500 = {CREATUREIDX, 0x16, 0x03, 0x9c, 0x69d8};

// ================================================
// 0xe506: WORD 'UNK_0xe508' codep=0x73ea parp=0xe508 orphan
// ================================================
LoadDataType UNK_0xe508 = {CREATUREIDX, 0x19, 0x01, 0x9c, 0x69d8};

// ================================================
// 0xe50e: WORD 'UNK_0xe510' codep=0x73ea parp=0xe510 orphan
// ================================================
LoadDataType UNK_0xe510 = {CREATUREIDX, 0x1a, 0x03, 0x9c, 0x69d8};

// ================================================
// 0xe516: WORD 'UNK_0xe518' codep=0x73ea parp=0xe518 orphan
// ================================================
LoadDataType UNK_0xe518 = {CREATUREIDX, 0x1d, 0x01, 0x9c, 0x69d8};
// 0xe51e: db 0xea 0x73 0x44 0x1e 0x03 0x9c 0xd8 0x69 0xea 0x73 0x44 0x21 0x01 0x9c 0xd8 0x69 0xea 0x73 0x44 0x22 0x03 0x9c 0xd8 0x69 0xea 0x73 0x44 0x25 0x01 0x9c 0xd8 0x69 ' sD    i sD!   i sD"   i sD%   i'
...
// ================================================
// 0xe54e: WORD 'UNK_0xe550' codep=0x73ea parp=0xe550 orphan
// ================================================
LoadDataType UNK_0xe550 = {CREATUREIDX, 0x30, 0x01, 0x9c, 0x69d8};

// ================================================
// 0xe556: WORD 'UNK_0xe558' codep=0x73ea parp=0xe558 orphan
// ================================================
LoadDataType UNK_0xe558 = {CREATUREIDX, 0x31, 0x01, 0x9c, 0x69d8};

// ================================================
// 0xe55e: WORD 'UNK_0xe560' codep=0x73ea parp=0xe560 orphan
// ================================================
...
// ================================================
// 0xe586: WORD 'UNK_0xe588' codep=0x73ea parp=0xe588 orphan
// ================================================
...
// ================================================
// 0xe6a9: WORD 'UNK_0xe6ab' codep=0x224c parp=0xe6ab orphan params=0 returns=0
// ================================================
...
// ================================================
// 0xe93b: WORD 'UNK_0xe93d' codep=0x224c parp=0xe93d orphan params=1 returns=2
// ================================================
...
// ================================================
// 0xe949: WORD 'UNK_0xe94b' codep=0x224c parp=0xe94b orphan
// ================================================
