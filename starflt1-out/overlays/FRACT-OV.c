...
//      UNK_0xe3e0  codep:0x1d29 parp:0xe3e0 size:0x0018 C-string:'UNK_0xe3e0'
//      UNK_0xe3fa  codep:0x1d29 parp:0xe3fa size:0x006d C-string:'UNK_0xe3fa'
//      UNK_0xe469  codep:0x1d29 parp:0xe469 size:0x004e C-string:'UNK_0xe469'
//      UNK_0xe4b9  codep:0x1d29 parp:0xe4b9 size:0x0034 C-string:'UNK_0xe4b9'
//      UNK_0xe4ef  codep:0x1d29 parp:0xe4ef size:0x001e C-string:'UNK_0xe4ef'
//      UNK_0xe50f  codep:0x1d29 parp:0xe50f size:0x0026 C-string:'UNK_0xe50f'
//      UNK_0xe537  codep:0xe537 parp:0xe537 size:0x0008 C-string:'UNK_0xe537'
//      UNK_0xe541  codep:0x224c parp:0xe541 size:0x002a C-string:'UNK_0xe541'
//      UNK_0xe56d  codep:0x1d29 parp:0xe56d size:0x0045 C-string:'UNK_0xe56d'
//      UNK_0xe5b4  codep:0x1d29 parp:0xe5b4 size:0x0045 C-string:'UNK_0xe5b4'
//      UNK_0xe5fb  codep:0x1d29 parp:0xe5fb size:0x0033 C-string:'UNK_0xe5fb'
//      UNK_0xe630  codep:0x1d29 parp:0xe630 size:0x005f C-string:'UNK_0xe630'
//      UNK_0xe691  codep:0x1d29 parp:0xe691 size:0x0017 C-string:'UNK_0xe691'
//      UNK_0xe6aa  codep:0x1d29 parp:0xe6aa size:0x0016 C-string:'UNK_0xe6aa'
//      UNK_0xe6c2  codep:0x1d29 parp:0xe6c2 size:0x009a C-string:'UNK_0xe6c2'
...
const unsigned short int pp_UNK_0xe3e0 = 0xe3e0; // UNK_0xe3e0 size: 24
// {0x5b, 0x58, 0x59, 0x03, 0xc1, 0x3d, 0x7f, 0x00, 0x7e, 0x03, 0xb8, 0x7f, 0x00, 0x3d, 0x81, 0xff, 0x79, 0x03, 0xb8, 0x81, 0xff, 0x50, 0x53, 0xc3}

const unsigned short int pp_UNK_0xe3fa = 0xe3fa; // UNK_0xe3fa size: 109
...
const unsigned short int pp_UNK_0xe469 = 0xe469; // UNK_0xe469 size: 78
...
const unsigned short int pp_UNK_0xe4b9 = 0xe4b9; // UNK_0xe4b9 size: 52
...
const unsigned short int pp_UNK_0xe4ef = 0xe4ef; // UNK_0xe4ef size: 30
...
const unsigned short int pp_UNK_0xe50f = 0xe50f; // UNK_0xe50f size: 38
...
const unsigned short int pp_UNK_0xe56d = 0xe56d; // UNK_0xe56d size: 69
...
const unsigned short int pp_UNK_0xe5b4 = 0xe5b4; // UNK_0xe5b4 size: 69
...
const unsigned short int pp_UNK_0xe5fb = 0xe5fb; // UNK_0xe5fb size: 51
...
const unsigned short int pp_UNK_0xe630 = 0xe630; // UNK_0xe630 size: 95
...
const unsigned short int pp_UNK_0xe691 = 0xe691; // UNK_0xe691 size: 23
// {0x8b, 0x46, 0x08, 0x03, 0x46, 0x04, 0xd1, 0xf8, 0x89, 0x46, 0x0c, 0x8b, 0x46, 0x06, 0x03, 0x46, 0x02, 0xd1, 0xf8, 0x89, 0x46, 0x0a, 0xc3}

const unsigned short int pp_UNK_0xe6aa = 0xe6aa; // UNK_0xe6aa size: 22
...
// ================================================
// 0xe3a4: WORD 'UNK_0xe3a6' codep=0x224c parp=0xe3a6 params=0 returns=1
// ================================================
...
void UNK_0xe3a6() // UNK_0xe3a6
{
  ...
  do // (DO)
  {
    Push(Read16(pp_UNK_0xe35a)); // UNK_0xe35a @
...
// ================================================
// 0xe3be: WORD 'UNK_0xe3c0' codep=0x1d29 parp=0xe3c0 orphan params=0 returns=1
// ================================================
...
// ================================================
// 0xe3de: WORD 'UNK_0xe3e0' codep=0x1d29 parp=0xe3e0 params=0 returns=1
// ================================================
// 0xe3e0: pop    bx
// 0xe3e1: pop    ax
// 0xe3e2: pop    cx
...
// ================================================
// 0xe3f8: WORD 'UNK_0xe3fa' codep=0x1d29 parp=0xe3fa params=0 returns=1
// ================================================
// 0xe3fa: pop    bx
// 0xe3fb: pop    ax
// 0xe3fc: pop    cx
...
// ================================================
// 0xe467: WORD 'UNK_0xe469' codep=0x1d29 parp=0xe469 params=0 returns=1
// ================================================
// 0xe469: pop    dx
// 0xe46a: pop    ax
// 0xe46b: pop    cx
...
// ================================================
// 0xe4b7: WORD 'UNK_0xe4b9' codep=0x1d29 parp=0xe4b9 params=0 returns=1
// ================================================
...
// ================================================
// 0xe4ed: WORD 'UNK_0xe4ef' codep=0x1d29 parp=0xe4ef params=0 returns=1
// ================================================
// 0xe4ef: pop    dx
...
// ================================================
// 0xe50d: WORD 'UNK_0xe50f' codep=0x1d29 parp=0xe50f params=0 returns=1
// ================================================
...
// ================================================
// 0xe56b: WORD 'UNK_0xe56d' codep=0x1d29 parp=0xe56d orphan params=0 returns=1
// ================================================
// 0xe56d: pop    cx
...
// ================================================
// 0xe5b2: WORD 'UNK_0xe5b4' codep=0x1d29 parp=0xe5b4 params=0 returns=1
// ================================================
// 0xe5b4: pop    cx
...
// ================================================
// 0xe5f9: WORD 'UNK_0xe5fb' codep=0x1d29 parp=0xe5fb params=0 returns=1
// ================================================
...
// ================================================
// 0xe62e: WORD 'UNK_0xe630' codep=0x1d29 parp=0xe630 params=0 returns=1
// ================================================
...
// ================================================
// 0xe68f: WORD 'UNK_0xe691' codep=0x1d29 parp=0xe691 params=0 returns=1
// ================================================
// 0xe691: mov    ax,[bp+08]
// 0xe694: add    ax,[bp+04]
// 0xe697: sar    ax,1
...
// ================================================
// 0xe6a8: WORD 'UNK_0xe6aa' codep=0x1d29 parp=0xe6aa params=0 returns=1
// ================================================
// 0xe6aa: mov    ax,[bp+0E]
...
// ================================================
// 0xe6c0: WORD 'UNK_0xe6c2' codep=0x1d29 parp=0xe6c2 params=0 returns=1
// ================================================
// 0xe6c2: mov    bp,sp
// 0xe6c4: mov    ax,[bp+04]
// 0xe6c7: sub    ax,[bp+08]
...
void UNK_0xecc6() // UNK_0xecc6
{
  ...
  do // (DO)
  {
    ...
    L_ex_(); // L!
    POLYGON_dash_EXTRACT(); // POLYGON-EXTRACT
    Push(Read16(pp_UNK_0xeb84)); // UNK_0xeb84 @
    Push(2);
    Push(i); // I
    ReadArray(FACE); // FACE
    LC_ex_(); // LC!
...
void UNK_0xedd9() // UNK_0xedd9
{
  ...
  Push(Read16(pp_UNK_0xed30) - 0x0044); // UNK_0xed30 @ 0x0044 -
  Push(0x0046);
  Push(0);
  FILL_1(); // FILL_1
  Push(b); // R>
...
void UNK_0xeefa() // UNK_0xeefa
{
  ...
  LC_at_(); // LC@
  a = Pop(); // >R
  Push(Read16(pp_UNK_0xed85)); // UNK_0xed85 @
  Push(a); // I
  ...
  L_ex_(); // L!
  Push(Pop() + 2); //  2+
  Push(Read16(pp_UNK_0xed89)); // UNK_0xed89 @
  ROT(); // ROT
  ROT(); // ROT
  LC_ex_(); // LC!
}
