...
// ================================================
// 0xe514: WORD 'UNK_0xe516' codep=0x224c parp=0xe516 params=10 returns=1
// ================================================
...
// ================================================
// 0xe53c: WORD 'UNK_0xe53e' codep=0x224c parp=0xe53e params=10 returns=1
// ================================================
...
// ================================================
// 0xe55a: WORD 'UNK_0xe55c' codep=0x224c parp=0xe55c params=10 returns=1
// ================================================
...
// ================================================
// 0xe564: WORD 'UNK_0xe566' codep=0x224c parp=0xe566 params=10 returns=1
// ================================================
...
// ================================================
// 0xe56e: WORD 'UNK_0xe570' codep=0x224c parp=0xe570 params=10 returns=1
// ================================================
...
// ================================================
// 0xe578: WORD 'UNK_0xe57a' codep=0x224c parp=0xe57a params=10 returns=1
// ================================================
...
void UNK_0xe806() // UNK_0xe806
{
  ...
  INEXT(); // INEXT
  Push(0x63ef+UNK_0xe6a3.offset); // IFIELD
...
void UNK_0xe82a() // UNK_0xe82a
{
  Push(Read16(regsp)); // DUP
  _0_st_(); // 0<
  Push(0x63ef+UNK_0xe6a8.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  _0_gt_(); // 0>
  Push(Pop() & Pop()); // AND
  if (Pop() != 0)
...
void UNK_0xea7d() // UNK_0xea7d
{
  ...
  Push(pp_XBLT); // XBLT
  Store_3(); // !_3
  Push(0x63ef+UNK_0xe69e.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(3);
  DrawR(); // .R
  Push(0x004a);
  ...
  Push(a); // I
  UNK_0xe922(); // UNK_0xe922
  Push(0x63ef+UNK_0xe68f.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(3);
  DrawR(); // .R
  Push(0x008d);
  ...
  Push(a); // I
  UNK_0xe922(); // UNK_0xe922
  Push(0x63ef+UNK_0xe694.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(3);
  DrawR(); // .R
  Push(0x004a);
  ...
  Push(a); // R>
  UNK_0xe922(); // UNK_0xe922
  Push(0x63ef+UNK_0xe699.offset); // IFIELD
  Push(Read8(Pop())&0xFF); // C@
  Push(3);
  DrawR(); // .R
  Push(0x008d);
