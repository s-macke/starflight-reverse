...
//      UNK_0xe054  codep:0x744d parp:0xe054 size:0x0003 C-string:'UNK_0xe054'
//      UNK_0xe059  codep:0x73ea parp:0xe059 size:0x0006 C-string:'UNK_0xe059'
...
//      UNK_0xe0af  codep:0x744d parp:0xe0af size:0x0003 C-string:'UNK_0xe0af'
//      UNK_0xe0b4  codep:0x744d parp:0xe0b4 size:0x0003 C-string:'UNK_0xe0b4'
...
// ================================================
// 0xde72: WORD 'UNK_0xde74' codep=0x224c parp=0xde74 params=0 returns=0
// ================================================
...
// ================================================
// 0xde7c: WORD 'UNK_0xde7e' codep=0x224c parp=0xde7e params=10 returns=2
// ================================================
...
// ================================================
// 0xdeba: WORD 'UNK_0xdebc' codep=0x224c parp=0xdebc params=2 returns=0
// ================================================
...
// ================================================
// 0xdf3c: WORD 'UNK_0xdf3e' codep=0x224c parp=0xdf3e params=0 returns=0
// ================================================
...
void UNK_0xdf3e() // UNK_0xdf3e
{
  ...
  do // (DO)
  {
    ...
    RRND(); // RRND
    Push(Read16(regsp)); // DUP
    Push(pp_UNK_0xde54 + i); // UNK_0xde54 I +
    C_ex_(); // C!
    Push(pp_UNK_0xde5c + i); // UNK_0xde5c I +
    C_ex_(); // C!
    Push(-3);
    Push(4);
    RRND(); // RRND
    Push(Read16(regsp)); // DUP
    Push(pp_UNK_0xde54 + (i + 1)); // UNK_0xde54 I 1+ +
    C_ex_(); // C!
    Push(pp_UNK_0xde5c + (i + 1)); // UNK_0xde5c I 1+ +
    C_ex_(); // C!
    Push2Words("UNK_0xde64");
    RRND(); // RRND
    Push(Read16(regsp)); // DUP
    Push(pp_UNK_0xde44 + i); // UNK_0xde44 I +
    C_ex_(); // C!
    Push(pp_UNK_0xde4c + i); // UNK_0xde4c I +
    C_ex_(); // C!
    Push2Words("UNK_0xde6a");
    RRND(); // RRND
    Push(Read16(regsp)); // DUP
    Push(pp_UNK_0xde44 + (i + 1)); // UNK_0xde44 I 1+ +
    C_ex_(); // C!
    Push(pp_UNK_0xde4c + (i + 1)); // UNK_0xde4c I 1+ +
    C_ex_(); // C!
    Push(2);
    int step = Pop();
    i += step;
...
void UNK_0xdfb6() // UNK_0xdfb6
{
  ...
  do // (DO)
  {
    ...
    Push(Read16(pp_UNK_0xde70)); // UNK_0xde70 @
...
// ================================================
// 0xe001: WORD 'UNK_0xe003' codep=0x224c parp=0xe003 params=0 returns=0
// ================================================

void UNK_0xe003() // UNK_0xe003
{
  IFIRST(); // IFIRST
  Push(0x63ef+UNK_0xdffe.offset); // UNK_0xdffe<IFIELD>
  PAD(); // PAD
  Push(Pop() + 1); //  1+
  Push(8);
  CMOVE(); // CMOVE
...
// ================================================
// 0xe0d9: WORD 'UNK_0xe0db' codep=0x224c parp=0xe0db params=2 returns=0
// ================================================
...
// ================================================
// 0xe0e5: WORD 'UNK_0xe0e7' codep=0x224c parp=0xe0e7 params=0 returns=0
// ================================================
...
// ================================================
// 0xe18b: WORD 'UNK_0xe18d' codep=0x224c parp=0xe18d params=0 returns=0
// ================================================
...
// ================================================
// 0xe1af: WORD 'UNK_0xe1b1' codep=0x224c parp=0xe1b1 params=1 returns=0
// ================================================
...
// ================================================
// 0xe203: WORD 'UNK_0xe205' codep=0x224c parp=0xe205 params=1 returns=0
// ================================================

void UNK_0xe205() // UNK_0xe205
{
  Push((0x63ef+UNK_0xdffe.offset) + Read16(pp_CTX)); // UNK_0xdffe<IFIELD> CTX @ +
  C_ex_(); // C!
}


// ================================================
// 0xe211: WORD 'UNK_0xe213' codep=0x224c parp=0xe213 params=1 returns=0
// ================================================
...
// ================================================
// 0xe239: WORD 'UNK_0xe23b' codep=0x224c parp=0xe23b params=1 returns=0
// ================================================
...
// ================================================
// 0xe253: WORD 'UNK_0xe255' codep=0x224c parp=0xe255 params=1 returns=0
// ================================================
...
// ================================================
// 0xe28f: WORD 'UNK_0xe291' codep=0x224c parp=0xe291 params=1 returns=0
// ================================================
...
// ================================================
// 0xe2f4: WORD 'UNK_0xe2f6' codep=0x224c parp=0xe2f6 params=1 returns=0
// ================================================
...
// ================================================
// 0xe460: WORD 'UNK_0xe462' codep=0x224c parp=0xe462 params=0 returns=2
// ================================================
...
// ================================================
// 0xe468: WORD 'UNK_0xe46a' codep=0x224c parp=0xe46a params=0 returns=0
// ================================================
...
// ================================================
// 0xe48c: WORD 'UNK_0xe48e' codep=0x224c parp=0xe48e params=0 returns=0
// ================================================
...
// ================================================
// 0xe49c: WORD 'UNK_0xe49e' codep=0x224c parp=0xe49e params=2 returns=0
// ================================================
...
// ================================================
// 0xe4ac: WORD 'UNK_0xe4ae' codep=0x224c parp=0xe4ae params=1 returns=0
// ================================================
...
// ================================================
// 0xe4e0: WORD 'UNK_0xe4e2' codep=0x224c parp=0xe4e2 params=0 returns=0
// ================================================
...
// ================================================
// 0xe4ec: WORD 'UNK_0xe4ee' codep=0x224c parp=0xe4ee params=0 returns=0
// ================================================
...
// ================================================
// 0xe518: WORD 'UNK_0xe51a' codep=0x224c parp=0xe51a params=0 returns=0
// ================================================
...
// ================================================
// 0xe562: WORD 'UNK_0xe564' codep=0x224c parp=0xe564 params=0 returns=0
// ================================================
...
// ================================================
// 0xe631: WORD 'UNK_0xe633' codep=0x224c parp=0xe633 params=0 returns=1
// ================================================
...
// ================================================
// 0xe689: WORD 'UNK_0xe68b' codep=0x224c parp=0xe68b params=2 returns=0
// ================================================
...
void UNK_0xe6df() // UNK_0xe6df
{
  ...
  if (Pop() != 0)
  {
    ...
    GetIH(); // @IH
    _gt_C_plus_S(); // >C+S
    Push((0x63ef+UNK_0xe081.offset) + 3); // UNK_0xe081<IFIELD> 3 +
    _2_at_(); // 2@
    D0_eq_(); // D0=
    Push(!Pop()); //  NOT
    ICLOSE(); // ICLOSE
...
// ================================================
// 0xe707: WORD 'UNK_0xe709' codep=0x224c parp=0xe709 params=0 returns=0
// ================================================
  ...
  do // (DO)
  {
    ...
    if (Pop() != 0)
    {
      ...
      } else
      {
        ...
        do // (DO)
        {
          Push((Read16((0x63ef+UNK_0xe081.offset) + j)&0xFF)==0?1:0); // UNK_0xe081<IFIELD> I + C@ 0=
          if (Pop() != 0)
          {
            Push(Read16(pp_UNK_0xe0d7)); // UNK_0xe0d7 @
            Push((0x63ef+UNK_0xe081.offset) + j); // UNK_0xe081<IFIELD> I +
            C_ex_(); // C!
            Push(Read16(pp_ELEM_dash_AM)); // ELEM-AM @
            Push(((0x63ef+UNK_0xe081.offset) + 4) + j); // UNK_0xe081<IFIELD> 4 + I +
            C_ex_(); // C!
            jmax = j; // LEAVE
          }
          j++;
...
void UNK_0xe823() // UNK_0xe823
{
  ...
  do // (DO)
  {
    ...
    if (Pop() != 0)
    {
      ...
      do // (DO)
      {
        Push(Read16(((0x63ef+UNK_0xe081.offset) + 3) + j)&0xFF); // UNK_0xe081<IFIELD> 3 + I + C@
        if (Read16(regsp) != 0) Push(Read16(regsp)); // ?DUP
        if (Pop() != 0)
        {
          Push(0x001a);
          ...
          {
            Push(Read16((0x63ef+UNK_0xe081.offset) + (j - 1))&0xFF); // UNK_0xe081<IFIELD> I 1- + C@
          }
          ICREATE(); // ICREATE
          _gt_C_plus_S(); // >C+S
          Push(0x63ef+INST_dash_QTY.offset); // INST-QTY<IFIELD>
      ...
      Push(0x63ef+UNK_0xe081.offset); // UNK_0xe081<IFIELD>
      Push(7);
      Push(0);
      FILL_1(); // FILL_1
      ICLOSE(); // ICLOSE
  ...
  Push(0x000a);
  IFIND(); // IFIND
  Push(Pop() & Read16(pp_UNK_0xde36)); //  UNK_0xde36 @ AND
  if (Pop() != 0)
  {
    Push(0x0030);
    StoreINST_dash_SPECIES(); // !INST-SPECIES
...
// ================================================
// 0xe905: WORD 'UNK_0xe907' codep=0x224c parp=0xe907 params=0 returns=0
// ================================================
...
// ================================================
// 0xe96e: WORD 'UNK_0xe970' codep=0x224c parp=0xe970 params=0 returns=0
// ================================================
...
// ================================================
// 0xe9b8: WORD 'UNK_0xe9ba' codep=0x224c parp=0xe9ba params=0 returns=0
// ================================================
...
// ================================================
// 0xe9e0: WORD 'UNK_0xe9e2' codep=0x224c parp=0xe9e2 params=1 returns=0
// ================================================
...
// ================================================
// 0xeaf2: WORD 'UNK_0xeaf4' codep=0x224c parp=0xeaf4 params=0 returns=0
// ================================================
...
void UNK_0xeb14() // UNK_0xeb14
{
  ...
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x63ef+UNK_0xe0d2.offset); // UNK_0xe0d2<IFIELD>
  _plus__ex__2(); // +!_2
  ICLOSE(); // ICLOSE
  Push(Read16(regsp)); // DUP
  Push(0xfff6);
...
// ================================================
// 0xebbe: WORD 'UNK_0xebc0' codep=0x224c parp=0xebc0 params=2 returns=2
// ================================================
...
// ================================================
// 0xebe6: WORD 'UNK_0xebe8' codep=0x224c parp=0xebe8 params=1 returns=0
// ================================================
...
// ================================================
// 0xec0a: WORD 'UNK_0xec0c' codep=0x224c parp=0xec0c params=1 returns=0
// ================================================
...
// ================================================
// 0xec5e: WORD 'UNK_0xec60' codep=0x224c parp=0xec60 params=2 returns=0
// ================================================
...
void UNK_0xec73() // UNK_0xec73
{
  ...
  Push(Read16(0x63ef+UNK_0xe0c3.offset)&0xFF); // UNK_0xe0c3<IFIELD> C@
  Push(0);
  DrawR(); // .R
  PRINT(",", 1); // (.")
  Push(Read16(0x63ef+UNK_0xe0c8.offset)&0xFF); // UNK_0xe0c8<IFIELD> C@
  Draw(); // .
  SET_STR_AS_PARAM("PLANET");
  UNK_0xec60(); // UNK_0xec60
  Push(Read16(0x63ef+UNK_0xe0cd.offset)&0xFF); // UNK_0xe0cd<IFIELD> C@
  Draw(); // .
  ...
  UNK_0xec60(); // UNK_0xec60
  Push(Read16(0x63ef+UNK_0xe0b9.offset)); // UNK_0xe0b9<IFIELD> @
  PAD(); // PAD
...
// ================================================
// 0xecdd: WORD 'UNK_0xecdf' codep=0x224c parp=0xecdf params=2 returns=0
// ================================================
...
// ================================================
// 0xecf3: WORD 'UNK_0xecf5' codep=0x224c parp=0xecf5 params=2 returns=0
// ================================================
...
{
  Push(Read16(pp_UNK_0xed37)); // UNK_0xed37 @
  if (Pop() != 0)
  {
    UNK_0xecdf(); // UNK_0xecdf
  } else
...
// ================================================
// 0xed61: WORD 'UNK_0xed63' codep=0x224c parp=0xed63 params=0 returns=1
// ================================================
...
// ================================================
// 0xed73: WORD 'UNK_0xed75' codep=0x224c parp=0xed75 params=0 returns=1
// ================================================
...
// ================================================
// 0xed89: WORD 'UNK_0xed8b' codep=0x224c parp=0xed8b params=0 returns=1
// ================================================
...
// ================================================
// 0xeda6: WORD 'UNK_0xeda8' codep=0x224c parp=0xeda8 params=0 returns=1
// ================================================
...
void UNK_0xee4a() // UNK_0xee4a
{
  ...
  if (Pop() != 0)
  {
    ...
    do
    {
      ...
      if (Pop() != 0)
      {
        Push(-Pop() + Read16(pp_UNK_0xed37)); //  NEGATE UNK_0xed37 @ +
        Push(Read16(regsp)); // DUP
        Push(0);
        Push(Read16(pp_UNK_0xed3b) + 1); // UNK_0xed3b @ 1+
        WITHIN(); // WITHIN
        if (Pop() != 0)
        {
          Push((Read16(pp_WTOP) - (Read16(pp_UNK_0xed37) + 1) * 7) + 1); // WTOP @ UNK_0xed37 @ 1+ 7 * - 1+
          UNK_0xe4ae(); // UNK_0xe4ae
          Push(Read16(regsp)); // DUP
          Push(pp_UNK_0xed37); // UNK_0xed37
          Store_3(); // !_3
...
// ================================================
// 0xeef0: WORD 'UNK_0xeef2' codep=0x224c parp=0xeef2 params=0 returns=2
// ================================================
...
// ================================================
// 0xefbd: WORD 'UNK_0xefbf' codep=0x224c parp=0xefbf params=3 returns=0
// ================================================
...
void _gt_DESCEND() // >DESCEND
{
  ...
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push((Read16(0x63ef+UNK_0xe054.offset)&0xFF) & 0x00ef); // UNK_0xe054<IFIELD> C@ 0x00ef AND
  Push(0x63ef+UNK_0xe054.offset); // UNK_0xe054<IFIELD>
  C_ex_(); // C!
  ICLOSE(); // ICLOSE
}
...
// ================================================
// 0xf1f9: WORD 'UNK_0xf1fb' codep=0x224c parp=0xf1fb params=0 returns=1
// ================================================
...
// ================================================
// 0xf217: WORD 'UNK_0xf219' codep=0x224c parp=0xf219 params=0 returns=1
// ================================================
...
void UNK_0xf257() // UNK_0xf257
{
  ...
  CTCR(); // CTCR
  Push(0x63ef+UNK_0xe0af.offset); // UNK_0xe0af<IFIELD>
  Push(0x000f);
  Push(Read16(cc_BL)); // BL
  FILL_1(); // FILL_1
  Push(0x000f);
...
// ================================================
// 0xf290: WORD 'UNK_0xf292' codep=0x224c parp=0xf292 params=0 returns=3
// ================================================
...
void UNK_0xf292() // UNK_0xf292
{
  ...
  MODULE(); // MODULE
  Push(Read16(0x63ef+UNK_0xe096.offset)&0xFF); // UNK_0xe096<IFIELD> C@
  Push(0x03e8);
  U_star_(); // U*
...
void UNK_0xf2d0() // UNK_0xf2d0
{
  ...
  Push(Read16(0x63ef+INST_dash_QTY.offset)); // INST-QTY<IFIELD> @
  ICLOSE(); // ICLOSE
  Push(0x63ef+UNK_0xe0a5.offset); // UNK_0xe0a5<IFIELD>
  C_ex_(); // C!
}
...
void UNK_0xf30e() // UNK_0xf30e
{
  ...
  ICLOSE(); // ICLOSE
  Push(0x63ef+UNK_0xe0aa.offset); // UNK_0xe0aa<IFIELD>
  C_ex_(); // C!
}


// ================================================
// 0xf346: WORD 'UNK_0xf348' codep=0x224c parp=0xf348 params=0 returns=0
// ================================================
...
void UNK_0xf348() // UNK_0xf348
{
  ...
  if (Pop() != 0)
  {
    Push(Read16(pp_UNK_0xf2cc)); // UNK_0xf2cc @
    Push(8);
    MIN(); // MIN
  ...
  {
    Push(Read16(pp_UNK_0xf18d) * 5); // UNK_0xf18d @ 5 *
  }
  Push(0x63ef+UNK_0xe096.offset); // UNK_0xe096<IFIELD>
  C_ex_(); // C!
}
...
void UNK_0xf37a() // UNK_0xf37a
{
  ...
  Push(0x63ef+UNK_0xe09b.offset); // UNK_0xe09b<IFIELD>
  Store_3(); // !_3
  CI_i_(); // CI'
  _gt_C_plus_S(); // >C+S
  Push(1);
  ...
  Push(Read16(0x63ef+INST_dash_QTY.offset)); // INST-QTY<IFIELD> @
  ICLOSE(); // ICLOSE
  Push(0x63ef+UNK_0xe0a0.offset); // UNK_0xe0a0<IFIELD>
  Store_3(); // !_3
...
// ================================================
// 0xf3d1: WORD 'UNK_0xf3d3' codep=0x224c parp=0xf3d3 params=0 returns=1
// ================================================
...
void UNK_0xf3d3() // UNK_0xf3d3
{
  ...
  Push(Read16(regsp)); // DUP
  ROT(); // ROT
  Push(Pop() | Read16(0x63ef+UNK_0xe0be.offset)&0xFF); //  UNK_0xe0be<IFIELD> C@ OR
  Push(0x63ef+UNK_0xe0be.offset); // UNK_0xe0be<IFIELD>
  C_ex_(); // C!
  ICLOSE(); // ICLOSE
  if (Pop() != 0)
  {
