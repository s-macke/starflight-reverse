...
// 0xe62b: db 0x4d 0x74 0x14 0x15 0x02 0x4d 0x74 0x10 0x1a 0x01 0x4d 0x74 0x11 0x14 0x03 'Mt   Mt   Mt   '
...
void UNK_0xe760() // UNK_0xe760
{
  ...
  do // (DO)
  {
    Push(0x63ef+UNK_0xe60a.offset); // IFIELD
    Push(i); // I
    Push(Pop() + Pop()); // +
    Push(Pop()+1); // 1+
...
void UNK_0xe86b() // UNK_0xe86b
{
  Push(7);
  UNK_0xe754(); // UNK_0xe754
  Push(0x63ef+UNK_0xe628.offset); // IFIELD
  Push(Read16(Pop())); // @
  Push(3);
  Push(Pop() & Pop()); // AND
...
void UNK_0xe90e() // UNK_0xe90e
{
  ...
  Push2Words("*SHIP");
  _gt_C_plus_S(); // >C+S
  Push(0x63ef+UNK_0xe619.offset); // IFIELD
  Push(Read16(Pop())); // @
  _plus_BIT(); // +BIT
  Push(Pop()+1); // 1+
  Push(0x01f4);
  Push(Pop() * Pop()); // *
  Push(Read16(regsp)); // DUP
  Push(0x63ef+UNK_0xe623.offset); // IFIELD
  Push(Read16(Pop())); // @
...
// ================================================
// 0xe99e: WORD 'UNK_0xe9a0' codep=0x224c parp=0xe9a0 params=3 returns=0
// ================================================
...
void UNK_0xe9a0() // UNK_0xe9a0
{
  SetColor(YELLOW);
  StoreCOLOR(); // !COLOR
  Push(0x63ef+UNK_0xe61e.offset); // IFIELD
  Push(Read16(Pop())); // @
  Push(0x0035);
  _slash_(); // /
...
// ================================================
// 0xe9d8: WORD 'UNK_0xe9da' codep=0x224c parp=0xe9da params=5 returns=0
// ================================================

void UNK_0xe9da() // UNK_0xe9da
{
  Push(0x63ef+UNK_0xe60f.offset); // IFIELD
  Push(Pop()+1); // 1+
  Push(Read8(Pop())&0xFF); // C@
  Push(1);
  Push(0x0065);
  ...
  SetColor(RED);
  StoreCOLOR(); // !COLOR
  Push(0x63ef+UNK_0xe614.offset); // IFIELD
  Push(Read16(Pop())); // @
  Push(0x0059);
  _slash_(); // /
  if (Read16(regsp) != 0) Push(Read16(regsp)); // ?DUP
...
// ================================================
// 0xea24: WORD 'UNK_0xea26' codep=0x224c parp=0xea26 params=8 returns=0
// ================================================
...
// ================================================
// 0xec6e: WORD 'UNK_0xec70' codep=0x224c parp=0xec70 params=2 returns=2
// ================================================
...
// ================================================
// 0xf237: WORD 'UNK_0xf239' codep=0x224c parp=0xf239 params=4 returns=0
// ================================================
...
void UNK_0xf39c() // UNK_0xf39c
{
  ...
  Push(0x63ef+UNK_0xe65c.offset); // IFIELD
  _2_at_(); // 2@
  Push(Pop() + Pop()); // +
  Push(0);
  MAX(); // MAX
