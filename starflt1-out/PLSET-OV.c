...
// 1761:            SETC  codep:0x224c parp:0xf2f4 size:0x0014 C-string:'SETC'
// 1762:      UNK_0xf30a  codep:0x224c parp:0xf30a size:0x000e C-string:'UNK_0xf30a'
// 1763:      UNK_0xf31a  codep:0x224c parp:0xf31a size:0x0010 C-string:'UNK_0xf31a'
// 1764:          CLIST1  codep:0x1d29 parp:0xf335 size:0x0014 C-string:'CLIST1'
// 1765:          CLIST2  codep:0x1d29 parp:0xf354 size:0x0014 C-string:'CLIST2'
// 1766:          CLIST3  codep:0x1d29 parp:0xf373 size:0x0014 C-string:'CLIST3'
// 1767:      UNK_0xf389  codep:0x224c parp:0xf389 size:0x0014 C-string:'UNK_0xf389'
// 1768:          (SAND)  codep:0x1d29 parp:0xf3a8 size:0x0010 C-string:'_ro_SAND_rc_'
// 1769:      UNK_0xf3ba  codep:0x224c parp:0xf3ba size:0x0052 C-string:'UNK_0xf3ba'
// 1770:      UNK_0xf40e  codep:0x224c parp:0xf40e size:0x000c C-string:'UNK_0xf40e'
// 1771:      UNK_0xf41c  codep:0x224c parp:0xf41c size:0x0016 C-string:'UNK_0xf41c'
// 1772:      UNK_0xf434  codep:0x224c parp:0xf434 size:0x0012 C-string:'UNK_0xf434'
// 1773:        (TERRAIN  codep:0x4a4f parp:0xf453 size:0x0018 C-string:'_ro_TERRAIN'
// 1774:      UNK_0xf46d  codep:0x224c parp:0xf46d size:0x0008 C-string:'UNK_0xf46d'
// 1775:        PLAN-RUL  codep:0x224c parp:0xf482 size:0x0000 C-string:'PLAN_dash_RUL'
...
unsigned char CLIST3[20] = {0x01, 0x00, 0x53, 0xe5, 0x01, 0x00, 0x18, 0xe8, 0x01, 0x00, 0x43, 0xe8, 0x01, 0x00, 0x6f, 0xe8, 0x01, 0x00, 0x64, 0xe5}; // CLIST3
unsigned char _ro_SAND_rc_[16] = {0x01, 0x00, 0x24, 0xe7, 0x01, 0x00, 0x3a, 0xe7, 0x01, 0x00, 0x69, 0xe7, 0x01, 0x00, 0x51, 0xe7}; // (SAND)
...
void UNK_0xf128() // UNK_0xf128
{
  ...
  Push(cc__5); // 5
  RRND(); // RRND
  Push(0xf0af); // pointer to SUBHYDRO
  goto label2;
  ...
  Push(cc__7); // 7
  RRND(); // RRND
  Push(0xf0d5); // pointer to INFHYDRO
  goto label2;
  ...
  Push(cc__7); // 7
  RRND(); // RRND
  Push(0xf0c1); // pointer to TEMPHYDR
...
void UNK_0xf18e() // UNK_0xf18e
{
  ...
  Push(cc__5); // 5
  RRND(); // RRND
  Push(0xf0e8); // pointer to SUBATMO
  goto label2;
  ...
  Push(cc__7); // 7
  RRND(); // RRND
  Push(0xf10f); // pointer to INFATMO
  goto label2;
  ...
  Push(cc__9); // 9
  RRND(); // RRND
  Push(0xf0fa); // pointer to TEMPATMO
...
{
  Push2Words("0.");
  Push(0x53f8); // pointer to P-PHRAS
  _1_dot_5_ex_(); // 1.5!
  Push2Words("0.");
  Push(0x53e9); // pointer to P-COLOR
  _1_dot_5_ex_(); // 1.5!
}
...
{
  Push(0xf354); // pointer to CLIST2
  UNK_0xf31a(); // UNK_0xf31a
  Push(0x5415); // pointer to O-COLOR
  _1_dot_5_ex_(); // 1.5!
...
// ================================================
// 0xf432: WORD 'UNK_0xf434' codep=0x224c parp=0xf434
// ================================================
