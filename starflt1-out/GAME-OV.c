...
void UNK_0xebfc() // UNK_0xebfc
{
  ...
  U_slash_MOD(); // U/MOD
  SWAP(); // SWAP
  if (Pop() == 0) goto label1698;

  Push(Pop()+1); // 1+

  label1698:
  _ask_DUP(); // ?DUP
  if (Pop() == 0) goto label1699;
