...
void UNK_0xf207() // UNK_0xf207
{
  ...
  if (Pop() == 0) Push(1); else Push(0); // 0=
  Push(Pop() & Pop()); // AND
  if (Pop() == 0) goto label1056;

  _2DUP(); // 2DUP
  UNK_0xed31(); // UNK_0xed31
  D_eq_(); // D=
  if (Pop() == 0) goto label1057;
