...
// =========== DICTIONARY ==========
// =================================
// 1703:          OLDINT  codep:0x2214 parp:0xe21f size:0x0002 C-string:'OLDINT'
// 1704:          ?MUSIC  codep:0x2214 parp:0xe22c size:0x0002 C-string:'_ask_MUSIC'
// 1705:          MUSINT  codep:0x2214 parp:0xe239 size:0x0002 C-string:'MUSINT'
// 1706:         PHRASE0  codep:0x2214 parp:0xe247 size:0x0002 C-string:'PHRASE0'
// 1707:         CURRPHR  codep:0x2214 parp:0xe255 size:0x0002 C-string:'CURRPHR'
// 1708:         CURNOTE  codep:0x2214 parp:0xe263 size:0x0002 C-string:'CURNOTE'
// 1709:         REPEATS  codep:0x2214 parp:0xe271 size:0x0002 C-string:'REPEATS'
// 1710:         COUNTER  codep:0x2214 parp:0xe27f size:0x0002 C-string:'COUNTER'
// 1711:        DURATION  codep:0x2214 parp:0xe28e size:0x0002 C-string:'DURATION'
// 1712:       RESTVALUE  codep:0x2214 parp:0xe29e size:0x0002 C-string:'RESTVALUE'
// 1713:       TONESTATE  codep:0x2214 parp:0xe2ae size:0x0002 C-string:'TONESTATE'
// 1714:           SONGS  codep:0x2214 parp:0xe2ba size:0x0002 C-string:'SONGS'
// 1715:           SCALE  codep:0x2214 parp:0xe2c6 size:0x0002 C-string:'SCALE'
// 1716:      UNK_0xe2ca  codep:0x1d29 parp:0xe2ca size:0x0002 C-string:'UNK_0xe2ca'
// 1717:      UNK_0xe2ce  codep:0x224c parp:0xe2ce size:0x0006 C-string:'UNK_0xe2ce'
// 1718:      UNK_0xe2d6  codep:0x224c parp:0xe2d6 size:0x0006 C-string:'UNK_0xe2d6'
// 1719:      UNK_0xe2de  codep:0x224c parp:0xe2de size:0x000e C-string:'UNK_0xe2de'
// 1720:      UNK_0xe2ee  codep:0x224c parp:0xe2ee size:0x01c9 C-string:'UNK_0xe2ee'
// 1721:              P2  codep:0x1d29 parp:0xe4be size:0x0014 C-string:'P2'
// 1722:              P3  codep:0x1d29 parp:0xe4d9 size:0x0014 C-string:'P3'
// 1723:              P4  codep:0x1d29 parp:0xe4f4 size:0x0014 C-string:'P4'
// 1724:              P5  codep:0x1d29 parp:0xe50f size:0x001a C-string:'P5'
// 1725:              P6  codep:0x1d29 parp:0xe530 size:0x0014 C-string:'P6'
// 1726:              P1  codep:0x1d29 parp:0xe54b size:0x001a C-string:'P1'
// 1727:              R,  codep:0x224c parp:0xe56c size:0x000a C-string:'R_co_'
// 1728:           0SONG  codep:0x1d29 parp:0xe580 size:0x0017 C-string:'_0SONG'
// 1729:         INITMUS  codep:0x224c parp:0xe5a3 size:0x003e C-string:'INITMUS'
// 1730:           HIMUS  codep:0x224c parp:0xe5eb size:0x0014 C-string:'HIMUS'
// 1731:        CSCR>EGA  codep:0x224c parp:0xe60c size:0x0072 C-string:'CSCR_gt_EGA'
// 1732:      UNK_0xe680  codep:0x224c parp:0xe680 size:0x001a C-string:'UNK_0xe680'
// 1733:      UNK_0xe69c  codep:0x224c parp:0xe69c size:0x001e C-string:'UNK_0xe69c'
// 1734:      UNK_0xe6bc  codep:0x1d29 parp:0xe6bc size:0x0002 C-string:'UNK_0xe6bc'
// 1735:      UNK_0xe6c0  codep:0x1d29 parp:0xe6c0 size:0x0002 C-string:'UNK_0xe6c0'
// 1736:      UNK_0xe6c4  codep:0x1d29 parp:0xe6c4 size:0x0002 C-string:'UNK_0xe6c4'
// 1737:      UNK_0xe6c8  codep:0x1d29 parp:0xe6c8 size:0x0002 C-string:'UNK_0xe6c8'
// 1738:      UNK_0xe6cc  codep:0x1d29 parp:0xe6cc size:0x0002 C-string:'UNK_0xe6cc'
// 1739:      UNK_0xe6d0  codep:0x1d29 parp:0xe6d0 size:0x0002 C-string:'UNK_0xe6d0'
// 1740:      UNK_0xe6d4  codep:0x1d29 parp:0xe6d4 size:0x0002 C-string:'UNK_0xe6d4'
// 1741:      UNK_0xe6d8  codep:0x1d29 parp:0xe6d8 size:0x0002 C-string:'UNK_0xe6d8'
// 1742:      UNK_0xe6dc  codep:0x1d29 parp:0xe6dc size:0x0002 C-string:'UNK_0xe6dc'
// 1743:      UNK_0xe6e0  codep:0x1d29 parp:0xe6e0 size:0x0002 C-string:'UNK_0xe6e0'
// 1744:      UNK_0xe6e4  codep:0x224c parp:0xe6e4 size:0x0006 C-string:'UNK_0xe6e4'
// 1745:      UNK_0xe6ec  codep:0x224c parp:0xe6ec size:0x0012 C-string:'UNK_0xe6ec'
// 1746:      UNK_0xe700  codep:0x224c parp:0xe700 size:0x0014 C-string:'UNK_0xe700'
// 1747:      UNK_0xe716  codep:0x224c parp:0xe716 size:0x0012 C-string:'UNK_0xe716'
// 1748:          BRMOVE  codep:0x224c parp:0xe733 size:0x0098 C-string:'BRMOVE'
// 1749:      UNK_0xe7cd  codep:0x224c parp:0xe7cd size:0x0044 C-string:'UNK_0xe7cd'
// 1750:      UNK_0xe813  codep:0x224c parp:0xe813 size:0x0016 C-string:'UNK_0xe813'
// 1751:      UNK_0xe82b  codep:0x224c parp:0xe82b size:0x005a C-string:'UNK_0xe82b'
// 1752:          REDUCE  codep:0x224c parp:0xe890 size:0x0026 C-string:'REDUCE'
// 1753:        INCREASE  codep:0x224c parp:0xe8c3 size:0x0018 C-string:'INCREASE'
// 1754:           XOFFS  codep:0x1d29 parp:0xe8e5 size:0x001a C-string:'XOFFS'
...
// =========== VARIABLES ===========
// =================================
unsigned char UNK_0xe2ca[2] = {0x00, 0xe3}; // UNK_0xe2ca
unsigned char P2[20] = {0x09, 0x3c, 0x03, 0x2c, 0x09, 0x1c, 0x03, 0x2c, 0x09, 0x14, 0x03, 0x1c, 0x09, 0x04, 0x03, 0x14, 0x30, 0x24, 0x00, 0x00}; // P2
unsigned char P3[20] = {0x09, 0x3c, 0x03, 0x2c, 0x09, 0x1c, 0x03, 0x2c, 0x09, 0x14, 0x03, 0x1c, 0x09, 0x04, 0x03, 0x53, 0x30, 0x04, 0x00, 0x00}; // P3
unsigned char P4[20] = {0x09, 0x54, 0x03, 0x4c, 0x09, 0x3c, 0x03, 0x2c, 0x09, 0x3c, 0x03, 0x4c, 0x09, 0x2c, 0x03, 0x04, 0x30, 0x05, 0x00, 0x00}; // P4
unsigned char P5[26] = {0x09, 0x3d, 0x03, 0x2d, 0x09, 0x25, 0x03, 0x2d, 0x09, 0x15, 0x03, 0x25, 0x09, 0x05, 0x03, 0x15, 0x09, 0x54, 0x03, 0x4c, 0x18, 0x3c, 0x4c, 0x3c, 0x00, 0x00}; // P5
...
unsigned char _0SONG[23] = {0x01, 0x4b, 0x02, 0x01, 0xbe, 0x01, 0x01, 0x4b, 0x02, 0x01, 0xd9, 0x01, 0x01, 0xf4, 0x01, 0x01, 0x0f, 0x02, 0x01, 0x30, 0x02, 0x00, 0x00}; // 0SONG
unsigned char UNK_0xe6bc[2] = {0xf4, 0x01}; // UNK_0xe6bc
unsigned char UNK_0xe6c0[2] = {0x3a, 0x20}; // UNK_0xe6c0
unsigned char UNK_0xe6c4[2] = {0x3a, 0x20}; // UNK_0xe6c4
unsigned char UNK_0xe6c8[2] = {0x00, 0x02}; // UNK_0xe6c8
unsigned char UNK_0xe6cc[2] = {0x3a, 0x20}; // UNK_0xe6cc
unsigned char UNK_0xe6d0[2] = {0x3a, 0x20}; // UNK_0xe6d0
unsigned char UNK_0xe6d4[2] = {0x3a, 0x20}; // UNK_0xe6d4
unsigned char UNK_0xe6d8[2] = {0x3a, 0x20}; // UNK_0xe6d8
unsigned char UNK_0xe6dc[2] = {0x3a, 0x20}; // UNK_0xe6dc
unsigned char UNK_0xe6e0[2] = {0x3a, 0x20}; // UNK_0xe6e0
unsigned char XOFFS[26] = {0x27, 0x00, 0x27, 0x00, 0x27, 0x00, 0x26, 0x00, 0x26, 0x00, 0x24, 0x00, 0x23, 0x00, 0x22, 0x00, 0x20, 0x00, 0x1e, 0x00, 0x1a, 0x00, 0x12, 0x00, 0x0c, 0x00}; // XOFFS
unsigned char PAUSEOFF[26] = {0x58, 0x02, 0xf4, 0x01, 0x90, 0x01, 0x5e, 0x01, 0x2c, 0x01, 0xfa, 0x00, 0xc8, 0x00, 0x96, 0x00, 0x64, 0x00, 0x4b, 0x00, 0x32, 0x00, 0x23, 0x00, 0x19, 0x00}; // PAUSEOFF
...
{
  _at_DS(); // @DS
  Push(0xe2ca); // pointer to UNK_0xe2ca
  Push(Read16(Pop())); // @
  Push(cc_MUSSEG); // MUSSEG
  Push(0); // 0
  Push(0x0320);
...
{
  Push(0xe6dc); // pointer to UNK_0xe6dc
  Push(Read16(Pop())); // @
}
...
{
  Push(0xe6c8); // pointer to UNK_0xe6c8
  Push(Read16(Pop())); // @
  Push(Pop() * Pop()); // *
  Push(0x0400);
  _slash_MOD(); // /MOD
  Push(0xe6cc); // pointer to UNK_0xe6cc
  Push(Read16(Pop())); // @
  Push(Pop() + Pop()); // +
}
...
{
  Push(0xe6d8); // pointer to UNK_0xe6d8
  _i_KEY(); // 'KEY
  if (Pop() == 0) goto label1;
  ON_3(); // ON_3
  return;
...
void BRMOVE() // BRMOVE
{
  ...
  SWAP(); // SWAP
  LC_at_(); // LC@
  Push(0xe6c4); // pointer to UNK_0xe6c4
  _ex__3(); // !_3
  Push(0x000a);
  Push(Pop() + Pop()); // +
  UNK_0xe6e4(); // UNK_0xe6e4
  SWAP(); // SWAP
  LC_at_(); // LC@
  Push(0xe6c0); // pointer to UNK_0xe6c0
  _ex__3(); // !_3
  Push(0x0010);
  Push(Pop() + Pop()); // +
  UNK_0xe6e4(); // UNK_0xe6e4
  ...
  Push(0xe6c0); // pointer to UNK_0xe6c0
  Push(Read16(Pop())); // @
  Push(0xe6d0); // pointer to UNK_0xe6d0
  Push(Read16(Pop())); // @
  Push(Pop() + Pop()); // +
  Push(i); // I
  _dash_(); // -
  ...
  Push(Pop() * Pop()); // *
  Push(Pop() + Pop()); // +
  Push(0xe6d4); // pointer to UNK_0xe6d4
  Push(Read16(Pop())); // @
  Push(Pop() + Pop()); // +
  Push(0xe6c4); // pointer to UNK_0xe6c4
  Push(Read16(Pop())); // @
  ...
  Push(0x0010);
  Push(Pop() + Pop()); // +
  Push(0xe6e0); // pointer to UNK_0xe6e0
  _plus__ex_(); // +!
  Push(0xe6bc); // pointer to UNK_0xe6bc
  Push(Read16(Pop())); // @
  MS(); // MS
}
...
void UNK_0xe928() // UNK_0xe928
{
  ...
  _ex__3(); // !_3
  Push(i); // I
  Push(0xe90c); // pointer to PAUSEOFF
  Push(i); // I
  Push(Pop() + Pop()); // +
  Push(Pop() + Pop()); // +
  Push(Read16(Pop())); // @
