...
{
  _at_DS(); // @DS
  Push(pp_UNK_0xe2ca); // UNK_0xe2ca size: 0
  Push(Read16(Pop())); // @
  Push(cc_MUSSEG); // MUSSEG
  Push(0); // 0
  Push(0x0320);
...
{
  Push(pp_UNK_0xe6dc); // UNK_0xe6dc size: 0
  Push(Read16(Pop())); // @
}
...
{
  Push(pp_UNK_0xe6c8); // UNK_0xe6c8 size: 0
  Push(Read16(Pop())); // @
  Push(Pop() * Pop()); // *
  Push(0x0400);
  _slash_MOD(); // /MOD
  Push(pp_UNK_0xe6cc); // UNK_0xe6cc size: 0
  Push(Read16(Pop())); // @
  Push(Pop() + Pop()); // +
}
...
{
  Push(pp_UNK_0xe6d8); // UNK_0xe6d8 size: 0
  _i_KEY(); // 'KEY
  if (Pop() == 0) goto label1;
  ON_3(); // ON_3
  return;
...
void BRMOVE() // BRMOVE
{
  ...
  SWAP(); // SWAP
  LC_at_(); // LC@
  Push(pp_UNK_0xe6c4); // UNK_0xe6c4 size: 0
  _ex__3(); // !_3
  Push(0x000a);
  Push(Pop() + Pop()); // +
  UNK_0xe6e4(); // UNK_0xe6e4
  SWAP(); // SWAP
  LC_at_(); // LC@
  Push(pp_UNK_0xe6c0); // UNK_0xe6c0 size: 0
  _ex__3(); // !_3
  Push(0x0010);
  Push(Pop() + Pop()); // +
  UNK_0xe6e4(); // UNK_0xe6e4
  ...
  Push(pp_UNK_0xe6c0); // UNK_0xe6c0 size: 0
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xe6d0); // UNK_0xe6d0 size: 0
  Push(Read16(Pop())); // @
  Push(Pop() + Pop()); // +
  Push(i); // I
  _dash_(); // -
  ...
  Push(Pop() * Pop()); // *
  Push(Pop() + Pop()); // +
  Push(pp_UNK_0xe6d4); // UNK_0xe6d4 size: 0
  Push(Read16(Pop())); // @
  Push(Pop() + Pop()); // +
  Push(pp_UNK_0xe6c4); // UNK_0xe6c4 size: 0
  Push(Read16(Pop())); // @
  ...
  Push(0x0010);
  Push(Pop() + Pop()); // +
  Push(pp_UNK_0xe6e0); // UNK_0xe6e0 size: 0
  _plus__ex_(); // +!
  Push(pp_UNK_0xe6bc); // UNK_0xe6bc size: 0
  Push(Read16(Pop())); // @
  MS(); // MS
}
...
void UNK_0xe928() // UNK_0xe928
{
  ...
  _ex__3(); // !_3
  Push(i); // I
  Push(pp_PAUSEOFF); // PAUSEOFF size: 112
  Push(i); // I
  Push(Pop() + Pop()); // +
  Push(Pop() + Pop()); // +
  Push(Read16(Pop())); // @
