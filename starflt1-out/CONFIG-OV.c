...
void UNK_0xebe9() // UNK_0xebe9
{
  ...
  Push(Pop() + Pop()); // +
  POS_dot_(); // POS.
  Push(0xeb81); // pointer to UNK_0xeb81
  Push(i); // I
  Push(Pop()*2); // 2*
  Push(Pop() + Pop()); // +
  Push(Read16(Pop())); // @
...
void UNK_0xecb0() // UNK_0xecb0
{
  ...
  DMAX(); // DMAX
  _2DUP(); // 2DUP
  Push(0xecaa); // pointer to UNK_0xecaa
  D_ex_(); // D!
  Push(cc__6); // 6
  D_dot_R(); // D.R
  return;
...
{
  Push(0xeb81); // pointer to UNK_0xeb81
  Push(0xeb7d); // pointer to UNK_0xeb7d
  Push(Read16(Pop())); // @
  Push(Pop()-1); // 1-
  Push(0x000a);
  Push(Pop() * Pop()); // *
...
void UNK_0xf14c() // UNK_0xf14c
{
  ...
  Push(0x5bb9); // pointer to OCRS
  OFF(); // OFF
  Push(0xea4a); // pointer to UNK_0xea4a
  BLD_dash_CRS(); // BLD-CRS
  Push(0); // 0
  Push(0xf148); // pointer to UNK_0xf148
  Push(Read16(Pop())); // @
  if (Pop() == 0) goto label1;
...
void _ro_U_dash_CONFIG_rc_() // (U-CONFIG)
{
  ...
  MODULE(); // MODULE
  UNK_0xeadd(); // UNK_0xeadd
  Push(0xea33); // pointer to UNK_0xea33
  BLD_dash_CRS(); // BLD-CRS
  _gt_DISPLAY(); // >DISPLAY
