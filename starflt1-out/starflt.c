...
//       (SCROLL_1  codep:0x1d29 wordp:0x6192 size:0x0004 C-string:'_ro_SCROLL_1'
//         (ORIGIN  codep:0x1d29 wordp:0x61a2 size:0x0004 C-string:'_ro_ORIGIN'
//       (SCROLL_2  codep:0x1d29 wordp:0x61b2 size:0x0004 C-string:'_ro_SCROLL_2'
...
//           W6329  codep:0x1d29 wordp:0x6329 size:0x0078 C-string:'W6329'
//           W63A3  codep:0x1d29 wordp:0x63a3 size:0x0040 C-string:'W63A3'
...
// ================================================
// 0x6186: WORD '(SCROLL_1' codep=0x1d29 wordp=0x6192
// ================================================
// 0x6192: db 0x4f 0x58 0x29 0x20 'OX) '

// ================================================
// 0x6196: WORD '(ORIGIN' codep=0x1d29 wordp=0x61a2
// ================================================
// 0x61a2: db 0x4f 0x52 0x29 0x20 'OR) '

// ================================================
// 0x61a6: WORD '(SCROLL_2' codep=0x1d29 wordp=0x61b2
// ================================================
...
// ================================================
// 0x6303: WORD 'THIS-RE' codep=0x1d29 wordp=0x630f
// ================================================
// 0x630f: db 0x4f 0x4e 0x20 0x6e 'ON n'

// ================================================
// 0x6313: WORD '(THIS-I' codep=0x1d29 wordp=0x631f
// ================================================
...
// ================================================
// 0x6327: WORD 'W6329' codep=0x1d29 wordp=0x6329
// ================================================
...
// ================================================
// 0x63a1: WORD 'W63A3' codep=0x1d29 wordp=0x63a3
// ================================================
