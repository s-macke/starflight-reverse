...
void UNK_0xea0b() // UNK_0xea0b
{
  ...
  Push(Read16(Pop())); // @
  Push(pp_UNK_0xea07); // UNK_0xea07 size: 0
  Push(Read16(Pop())); // @
  _dash_(); // -
  Push(0x0014);
  Push(Pop() * Pop()); // *
...
void UNK_0xed40() // UNK_0xed40
{
  TIME(); // TIME
  _2_at_(); // 2@
  Push(pp_UNK_0xed3a); // UNK_0xed3a size: 0
  _2_at_(); // 2@
  D_gt_(); // D>
}
...
void UNK_0xee39() // UNK_0xee39
{
  Push(cc__4); // 4
  Push(Pop() * Pop()); // *
  Push(pp_UNK_0xecf1); // UNK_0xecf1 size: 0
  Push(Pop()+1); // 1+
  Push(Pop() + Pop()); // +
  _gt_R(); // >R
  Push(pp_YBLT); // YBLT size: 2
...
{
  Push(pp_UNK_0xf0b5); // UNK_0xf0b5 size: 0
  Push(0x000c);
  Push(Pop() + Pop()); // +
  Push(Read16(Pop())); // @
  Push(0x8040);
...
{
  _at_CRS(); // @CRS
  Push(pp_UNK_0xf0a7); // UNK_0xf0a7 size: 0
  Push(pp_UNK_0xf09f); // UNK_0xf09f size: 0
  Push(Read16(Pop())); // @
  Push(cc__3); // 3
  Push(Pop() * Pop()); // *
  Push(Pop() + Pop()); // +
  ...
  _ex__3(); // !_3
  Push(pp_UNK_0xf0a3); // UNK_0xf0a3 size: 0
...
void UNK_0xf1e9() // UNK_0xf1e9
{
  ...
  Push(Read16(Pop())); // @
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xebfc); // UNK_0xebfc size: 0
  _ex__3(); // !_3
  POS_dot_(); // POS.
  PAD(); // PAD
...
{
  Push(pp_UNK_0xea73); // UNK_0xea73 size: 0
  OFF(); // OFF
  Push(pp_UNK_0xeeb5); // UNK_0xeeb5 size: 0
  Push(Read8(Pop())&0xFF); // C@
  Push(cc__7); // 7
  Push(Pop() * Pop()); // *
  Push(0); // 0
  ...
  Push(2); // 2
  Push(Pop() & Pop()); // AND
  Push(pp_UNK_0xea77); // UNK_0xea77 size: 0
  Push(Read16(Pop())); // @
  Push(Pop() & Pop()); // AND
  if (Pop() == 0) goto label1;
  Push(i); // I
  ...
  Push(1); // 1
  Push(Pop() & Pop()); // AND
  Push(pp_UNK_0xea7b); // UNK_0xea7b size: 0
  Push(Read16(Pop())); // @
  Push(Pop() & Pop()); // AND
  if (Pop() == 0) goto label2;
  Push(i); // I
...
void UNK_0xf30b() // UNK_0xf30b
{
  ...
  do // (DO)
  {
  Push(pp_UNK_0xf151); // UNK_0xf151 size: 0
  OVER(); // OVER
  Push(Pop() + Pop()); // +
  Push(i); // I
  Push(cc__4); // 4
