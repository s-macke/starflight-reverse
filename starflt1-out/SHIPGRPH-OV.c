...
void UNK_0xef90() // UNK_0xef90
{
  ...
  Push(0x004f);
  POS_dot_(); // POS.
  Push(pp_UNK_0xedb5); // UNK_0xedb5 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__3(); // !_3
  BLT(); // BLT
  Push(0x000a);
  ...
  Push(0x0059);
  POS_dot_(); // POS.
  Push(pp_UNK_0xedfb); // UNK_0xedfb size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__3(); // !_3
  BLT(); // BLT
  Push(0x0016);
  ...
  Push(0x005f);
  POS_dot_(); // POS.
  Push(pp_UNK_0xee2f); // UNK_0xee2f size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__3(); // !_3
  BLT(); // BLT
}
...
void _ro__dot_PODS_rc_() // (.PODS)
{
  ...
  Push(pp_WBLT); // WBLT size: 2
  _ex__3(); // !_3
  Push(pp_UNK_0xee53); // UNK_0xee53 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__3(); // !_3
  Push(pp_XORMODE); // XORMODE size: 2
  OFF(); // OFF
...
void UNK_0xf132() // UNK_0xf132
{
  ...
  Push(0x006b);
  POS_dot_(); // POS.
  Push(pp_UNK_0xf11c); // UNK_0xf11c size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__3(); // !_3
  BLT(); // BLT
  Push(0x0040);
  Push(pp_YBLT); // YBLT size: 2
  _ex__3(); // !_3
  Push(pp_UNK_0xf122); // UNK_0xf122 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__3(); // !_3
  BLT(); // BLT
}
...
void UNK_0xf174() // UNK_0xf174
{
  ...
  Push(pp_WBLT); // WBLT size: 2
  _ex__3(); // !_3
  Push(pp_UNK_0xf128); // UNK_0xf128 size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__3(); // !_3
  Push(0x006b);
  Push(0x0058);
