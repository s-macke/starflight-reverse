...
// 1718:    MERCATOR-GEN  codep:0x224c parp:0xe7b9 size:0x003c C-string:'MERCATOR_dash_GEN'
...
// 1754: POLYGON-EXTRACT  codep:0x224c parp:0xec70 size:0x0054 C-string:'POLYGON_dash_EXTRACT'
...
// 1774:      MAKE-GLOBE  codep:0x224c parp:0xefad size:0x0006 C-string:'MAKE_dash_GLOBE'
...
// 1782:      NEWCONTOUR  codep:0x224c parp:0xf108 size:0x0000 C-string:'NEWCONTOUR'
...
void UNK_0xe80f() // UNK_0xe80f
{
  ...
  Push(i); // J
  Push(Pop()*2); // 2*
  ReadArray(Read16(0x6aad+6), 0x003f); // CONANCHOR
  LC_ex_(); // LC!
  j++;
...
void UNK_0xebfc() // UNK_0xebfc
{
  ...
  UNK_0xeb20(); // UNK_0xeb20
  Push(Pop()-1); // 1-
  ReadArray(Read16(0x6a99+6), 0x0480); // MERCATOR
  L_plus__dash__at_(); // L+-@
  COLORMAP(); // COLORMAP
