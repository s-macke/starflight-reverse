...
void _ask_STORM() // ?STORM
{
  ...
  Push(Read16(Pop())); // @
  Push(pp__pe_STORM); // %STORM size: 10
  OVER(); // OVER
  Push(Pop() + Pop()); // +
  Push(Pop() + Pop()); // +
  Push(Read16(Pop())); // @
...
void UNK_0xef8a() // UNK_0xef8a
{
  ...
  Push(pp_FUNCTIONS); // FUNCTIONS size: 53
...
void ICONS() // ICONS
{
  ...
  Push(pp_UNK_0xef9e); // UNK_0xef9e size: 0
  _at_EXECUTE(); // @EXECUTE
