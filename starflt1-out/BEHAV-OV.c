...
//      UNK_0xe10c  codep:0x224c parp:0xe10c size:0x0032 C-string:'UNK_0xe10c'
//      UNK_0xe140  codep:0x73ea parp:0xe140 size:0x0006 C-string:'UNK_0xe140'
//      UNK_0xe148  codep:0x73ea parp:0xe148 size:0x000e C-string:'UNK_0xe148'
//      STUN.EFFEC  codep:0x73ea parp:0xe165 size:0x0016 C-string:'STUN_dot_EFFEC'
...
//      UNK_0xe1b5  codep:0x744d parp:0xe1b5 size:0x0008 C-string:'UNK_0xe1b5'
...
//      ?ALIEN-SMA  codep:0x224c parp:0xe265 size:0x0018 C-string:'_ask_ALIEN_dash_SMA'
//      ?RANDOM-SC  codep:0x224c parp:0xe28c size:0x000a C-string:'_ask_RANDOM_dash_SC'
// ?ALIEN-HIT-WITH-LASER  codep:0x224c parp:0xe2a5 size:0x003a C-string:'_ask_ALIEN_dash_HIT_dash_WITH_dash_LASER'
// ?ALIEN-HIT-WITH-STUNNER  codep:0x224c parp:0xe2ee size:0x0022 C-string:'_ask_ALIEN_dash_HIT_dash_WITH_dash_STUNNER'
...
//      UNK_0xe388  codep:0x224c parp:0xe388 size:0x00c4 C-string:'UNK_0xe388'
...
//        ?STUNNED  codep:0x224c parp:0xe482 size:0x0048 C-string:'_ask_STUNNED'
//   ?WANTS-TO-FLY  codep:0x224c parp:0xe4d9 size:0x000a C-string:'_ask_WANTS_dash_TO_dash_FLY'
// ?WANTS-TO-FLOAT  codep:0x224c parp:0xe4f2 size:0x0070 C-string:'_ask_WANTS_dash_TO_dash_FLOAT'
//      UNK_0xe564  codep:0x224c parp:0xe564 size:0x004e C-string:'UNK_0xe564'
...
//      UNK_0xe5fc  codep:0x224c parp:0xe5fc size:0x003e C-string:'UNK_0xe5fc'
//      REDUCE-AGG  codep:0x224c parp:0xe649 size:0x0018 C-string:'REDUCE_dash_AGG'
//      INCREASES-  codep:0x224c parp:0xe670 size:0x003e C-string:'INCREASES_dash_'
//      UNK_0xe6b0  codep:0x224c parp:0xe6b0 size:0x000a C-string:'UNK_0xe6b0'
//      UNK_0xe6bc  codep:0x224c parp:0xe6bc size:0x005c C-string:'UNK_0xe6bc'
...
//      STUN-EFFEC  codep:0x224c parp:0xe79e size:0x0024 C-string:'STUN_dash_EFFEC'
//      INCREMENT-  codep:0x224c parp:0xe7d1 size:0x0014 C-string:'INCREMENT_dash_'
//      UNK_0xe7e7  codep:0x73ea parp:0xe7e7 size:0x0022 C-string:'UNK_0xe7e7'
...
//      UNK_0xe855  codep:0x224c parp:0xe855 size:0x00c3 C-string:'UNK_0xe855'
//      UNK_0xe91a  codep:0x224c parp:0xe91a size:0x0111 C-string:'UNK_0xe91a'
...
void UNK_0xef8a() // UNK_0xef8a
{
  ...
  Push(0xef6b); // pointer to FUNCTIONS
...
void ICONS() // ICONS
{
  ...
  Push(0xef9e); // pointer to UNK_0xef9e
  _at_EXECUTE(); // @EXECUTE
