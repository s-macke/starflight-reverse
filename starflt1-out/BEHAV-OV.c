...
// 1723: ?ALIEN-HIT-WITH-LASER  codep:0x224c parp:0xe2a5 size:0x003a C-string:'_ask_ALIEN_dash_HIT_dash_WITH_dash_LASER'
// 1724: ?ALIEN-HIT-WITH-STUNNER  codep:0x224c parp:0xe2ee size:0x0022 C-string:'_ask_ALIEN_dash_HIT_dash_WITH_dash_STUNNER'
...
// 1731:   ?WANTS-TO-FLY  codep:0x224c parp:0xe4d9 size:0x000a C-string:'_ask_WANTS_dash_TO_dash_FLY'
// 1732: ?WANTS-TO-FLOAT  codep:0x224c parp:0xe4f2 size:0x0070 C-string:'_ask_WANTS_dash_TO_dash_FLOAT'
...
// 1741: ERASE-LIFEFORM-FROM-ARRAY  codep:0x224c parp:0xe727 size:0x0008 C-string:'ERASE_dash_LIFEFORM_dash_FROM_dash_ARRAY'
...
// 1769:      angle>text  codep:0x224c parp:0xee0d size:0x00fa C-string:'angle_gt_text'
