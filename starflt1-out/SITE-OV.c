...
//       .LATFRAME  codep:0x224c parp:0xee6e size:0x0063 C-string:'_dot_LATFRAME'
...
//            .LON  codep:0x224c parp:0xef28 size:0x0072 C-string:'_dot_LON'
...
//       .MERCATOR  codep:0x224c parp:0xf4cf size:0x005c C-string:'_dot_MERCATOR'
...
void UNK_0xf014() // UNK_0xf014
{
  ...
  if (Pop() == 0) goto label1;
  Push(0x01e0);
  Push(0xef9c); // pointer to UNK_0xef9c
  _ex__3(); // !_3
  Push(0x0480);
  Push(0xef1d); // pointer to UNK_0xef1d
  _ex__3(); // !_3
...
void _gt_XHAIR() // >XHAIR
{
  ...
  _ex__3(); // !_3
  Push(0xee54); // pointer to LTLNBLT
  Push(0x589d); // pointer to ABLT
  _ex__3(); // !_3
  Push(0x5da3); // pointer to ?EGA
  Push(Read16(Pop())); // @
...
void UNK_0xf311() // UNK_0xf311
{
  ...
  _eq_(); // =
  if (Pop() == 0) return;
  Push(0xf28c); // pointer to UNK_0xf28c
  Push(0x589d); // pointer to ABLT
  _ex__3(); // !_3
  Push(cc__3); // 3
  Push(0x5892); // pointer to WBLT
