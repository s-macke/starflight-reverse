...
void ?POPULA()
{
  ...
  (.") string 21 "SCANNING NEW TERRAIN "
...
void TV-MOVE()
{
  Push(0xf37b); Push(0xf3a7); Push(0xf355); DOTASKS();
  pp_TIME-PA ON();
...
void APPROACH()
{
  ...
  UNK_0xf417 @ 
  label1105:
  DUP Push(0xc302); MODULE();
  SHIP-CO();
  Push(0xc48c); MODULE();
  .REGION();
  Push(0xc4a2); MODULE();
  pp_#CLRMAP @ SWAP Push(0xc380); MODULE();
  Push(0xc395); MODULE();
  Push(0xc3a7); MODULE();
  >DISPLA();
  WHITE !COLOR();
