...
// 1705:      UNK_0xefdb  codep:0x1d29 parp:0xefdb size:0x0002 C-string:'UNK_0xefdb'
// 1706:          SIC'EM  codep:0x224c parp:0xefe8 size:0x0048 C-string:'SIC_i_EM'
// 1707:      UNK_0xf032  codep:0x1d29 parp:0xf032 size:0x0002 C-string:'UNK_0xf032'
// 1708:      UNK_0xf036  codep:0x1d29 parp:0xf036 size:0x0002 C-string:'UNK_0xf036'
// 1709:      UNK_0xf03a  codep:0x1d29 parp:0xf03a size:0x0006 C-string:'UNK_0xf03a'
// 1710:      UNK_0xf042  codep:0x1d29 parp:0xf042 size:0x0004 C-string:'UNK_0xf042'
// 1711:      UNK_0xf048  codep:0x224c parp:0xf048 size:0x023d C-string:'UNK_0xf048'
// 1712:      UNK_0xf287  codep:0x1d29 parp:0xf287 size:0x0012 C-string:'UNK_0xf287'
// 1713:      UNK_0xf29b  codep:0x1d29 parp:0xf29b size:0x0030 C-string:'UNK_0xf29b'
// 1714:      UNK_0xf2cd  codep:0x1d29 parp:0xf2cd size:0x0018 C-string:'UNK_0xf2cd'
// 1715:      UNK_0xf2e7  codep:0x224c parp:0xf2e7 size:0x0044 C-string:'UNK_0xf2e7'
// 1716:      UNK_0xf32d  codep:0x224c parp:0xf32d size:0x001c C-string:'UNK_0xf32d'
// 1717:      UNK_0xf34b  codep:0x224c parp:0xf34b size:0x0053 C-string:'UNK_0xf34b'
// 1718:      UNK_0xf3a0  codep:0x224c parp:0xf3a0 size:0x0042 C-string:'UNK_0xf3a0'
// 1719:      UNK_0xf3e4  codep:0x224c parp:0xf3e4 size:0x005b C-string:'UNK_0xf3e4'
// 1720:      UNK_0xf441  codep:0x224c parp:0xf441 size:0x0017 C-string:'UNK_0xf441'
...
void SIC_i_EM() // SIC'EM
{
  ...
  Push(0x0080);
  _st_(); // <
  Push(0xefdb); // pointer to UNK_0xefdb
  _ex__3(); // !_3
  Push(0x0080);
  Push(Pop() | Pop()); // OR
  Push(0x6403); // IFIELD(UNK_0xefd6)
...
{
  Push(0xf032); // pointer to UNK_0xf032
  Push(Read16(Pop())); // @
  Push(0xf036); // pointer to UNK_0xf036
  Push(Read16(Pop())); // @
  _2DUP(); // 2DUP
  _st_(); // <
...
void UNK_0xf2e7() // UNK_0xf2e7
{
  ...
  Push(0xf036); // pointer to UNK_0xf036
  Push(Read16(Pop())); // @
  Push(0xf2cd); // pointer to UNK_0xf2cd
  Push(Pop() + Pop()); // +
  Push(Read8(Pop())&0xFF); // C@
...
void UNK_0xf34b() // UNK_0xf34b
{
  ...
  Push(0xf042); // pointer to UNK_0xf042
  D_ex_(); // D!
}
