...
void UNK_0xea52() // UNK_0xea52
{
  ...
  SetColor("BLUE");
  _ex_COLOR(); // !COLOR
  Push(pp_UNK_0xea2e); // UNK_0xea2e size: 0
...
void UNK_0xec36() // UNK_0xec36
{
  ...
  _ex__3(); // !_3
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xec28); // UNK_0xec28 size: 0
  _ex__3(); // !_3
  Push(Pop()+1); // 1+
  Push(pp_XBLT); // XBLT size: 2
  _ex__3(); // !_3
  ...
  Push(pp_WBLT); // WBLT size: 2
  _ex__3(); // !_3
  Push(pp_UNK_0xec2c); // UNK_0xec2c size: 0
  Push(pp_ABLT); // ABLT size: 2
  _ex__3(); // !_3
  BLT(); // BLT
}
...
void UNK_0xef17() // UNK_0xef17
{
  ...
  Push(cc__3); // 3
  Push(Pop() * Pop()); // *
  Push(pp_UNK_0xef0c); // UNK_0xef0c size: 0
  Push(Pop() + Pop()); // +
  Push(0); // 0
  Push(cc__3); // 3
  RRND(); // RRND
...
void UNK_0xefe9() // UNK_0xefe9
{
  ...
  _eq_(); // =
  if (Pop() == 0) goto label2;
  Push(pp_UNK_0xefe1); // UNK_0xefe1 size: 0
  ON_3(); // ON_3
  goto label3;
...
void UNK_0xf239() // UNK_0xf239
{
  ...
  _eq_(); // =
  if (Pop() == 0) goto label1;
  Push(pp_UNK_0xe606); // UNK_0xe606 size: 0
  OFF(); // OFF
...
void UNK_0xf2dc() // UNK_0xf2dc
{
  ...
  R_gt_(); // R>
  Push(Read16(regsp)); // DUP
  Push(pp_UNK_0xefd3); // UNK_0xefd3 size: 0
  Push(cc__4); // 4
  Push(Pop() + Pop()); // +
  C_ex_(); // C!
