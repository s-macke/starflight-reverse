...
void _ro_XCOMM_rc_() // (XCOMM)
{
  ...
  {
  case 1:
    Push(pp_UNK_0xf454); // UNK_0xf454 size: 0
    break;
  case 7:
    Push(pp_UNK_0xf45f); // UNK_0xf45f size: 0
    break;
  case 8:
    Push(pp_UNK_0xf46c); // UNK_0xf46c size: 0
    break;
  case 3:
    Push(pp_UNK_0xf475); // UNK_0xf475 size: 0
    break;
  case 10:
    Push(pp_UNK_0xf47a); // UNK_0xf47a size: 0
    break;
  case 21:
    Push(pp_UNK_0xf47f); // UNK_0xf47f size: 0
    break;
  default:
    Push(0); // 0
    break;
