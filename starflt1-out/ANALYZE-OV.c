...
// =========== DICTIONARY ==========
// =================================
// 1703:       (.VESSEL) bitfield: 0 0 0  codep:0x4a4f parp:0xeca4 size:0x0051
// 1704:       (.OBJECT) bitfield: 0 0 0  codep:0x4a4f parp:0xed03 size:0x0014
// 1705:      UNK_0xed19 bitfield: 0 0 0  codep:0x224c parp:0xed19 size:0x0124
// 1706:         (.TYPE) bitfield: 0 0 0  codep:0x4a4f parp:0xee49 size:0x01f6
// 1707:          .TDESC bitfield: 0 0 0  codep:0x4a4f parp:0xf04a size:0x0097
// 1708:         (.SURF) bitfield: 0 0 0  codep:0x4a4f parp:0xf0ed size:0x00e6
// 1709:         (.ATMO) bitfield: 0 0 0  codep:0x4a4f parp:0xf1df size:0x0078
// 1710:        (.WEATH) bitfield: 0 0 0  codep:0x4a4f parp:0xf264 size:0x019d
// 1711:      (.V/P-OBJ) bitfield: 0 0 0  codep:0x4a4f parp:0xf410 size:0x0038
// 1712:     (.ANALYSIS) bitfield: 0 0 0  codep:0x4a4f parp:0xf458 size:0x0010
// 1713:     (/ANALYSIS) bitfield: 0 0 0  codep:0x224c parp:0xf478 size:0x00e8
...
void UNK_0xed19()
{
  ...
  (.") string 32 "ANALYSIS OF LAST SENSOR READING:"
  CTCR();
...
void (/ANALYSIS)()
{
  CTINIT();
  CTERASE();
  pp_SENSE-A 1.5@ 2DUP DABS();
  Push(0x0002); Pust(0x0000); D>();
  ...
  (.") string 29 "I SAID THERE'S NOTHING THERE!"
  
  goto label1479;
  
  label1478:
  
  (.") string 32 "I NEED A CURRENT SENSOR READING."
  
  label1479:
  DROP Push(0x05dc); Pust(0x0000); 
  label1481:
  TIME 2@ D+ pp_OK-TALK D!();
  NULL pp_SENSE-A 1.5!();
