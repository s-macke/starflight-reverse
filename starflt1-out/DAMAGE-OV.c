...
{
  Push(pp_UNK_0xebda); // UNK_0xebda size: 0
...
{
  Push(pp_UNK_0xebde); // UNK_0xebde size: 0
  _2_at_(); // 2@
}
...
void UNK_0xed12() // UNK_0xed12
{
  ...
  IFLD_at_(); // IFLD@
  Push(Pop()*2); // 2*
  Push(pp_LDAMAGE); // LDAMAGE size: 130
  Push(Pop() + Pop()); // +
  Push(Read16(Pop())); // @
  Push(0x000a);
  _star__slash_(); // */
...
{
  Push(1); // 1
  Push(pp_UNK_0xed5a); // UNK_0xed5a size: 0
  Push(Read16(Pop())); // @
  Push(Pop()+1); // 1+
  RRND(); // RRND
...
{
  Push(pp_WOUNDED); // WOUNDED size: 268
  Push(Read16(regsp)); // DUP
  Push(cc__6); // 6
  Push(Pop() + Pop()); // +
  SWAP(); // SWAP
  ...
  C_ex_(); // C!
  Push(1); // 1
  Push(pp_UNK_0xed9a); // UNK_0xed9a size: 0
  _st__plus__ex__gt_(); // <+!>
  LEAVE(); // LEAVE
...
void UNK_0xf08a() // UNK_0xf08a
{
  ...
  Push(pp_UNK_0xf081); // UNK_0xf081 size: 0
  Push(cc__7); // 7
  CMOVE(); // CMOVE
  Push(0x0018);
...
void UNK_0xf23a() // UNK_0xf23a
{
  ...
  Push(Pop()*2); // 2*
  Push(pp_MDAMAGE); // MDAMAGE size: 252
  Push(Pop() + Pop()); // +
  Push(Read16(Pop())); // @
}
