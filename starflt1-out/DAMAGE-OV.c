...
// =========== DICTIONARY ==========
// =================================
// 1703:            'OVS bitfield: 0 0 0  codep:0x1d29 parp:0xeabd size:0x0002
// 1704:      UNK_0xeac1 bitfield: 0 0 0  codep:0x224c parp:0xeac1 size:0x0012
// 1705:      UNK_0xead5 bitfield: 0 0 0  codep:0x224c parp:0xead5 size:0x0012
// 1706:      UNK_0xeae9 bitfield: 0 0 0  codep:0x224c parp:0xeae9 size:0x000a
// 1707:      UNK_0xeaf5 bitfield: 0 0 0  codep:0x224c parp:0xeaf5 size:0x000a
// 1708:      UNK_0xeb01 bitfield: 0 0 0  codep:0x73ea parp:0xeb01 size:0x0006
// 1709:      UNK_0xeb09 bitfield: 0 0 0  codep:0x73ea parp:0xeb09 size:0x0016
// 1710:      UNK_0xeb21 bitfield: 0 0 0  codep:0x73ea parp:0xeb21 size:0x0006
// 1711:      UNK_0xeb29 bitfield: 0 0 0  codep:0x73ea parp:0xeb29 size:0x0006
// 1712:      UNK_0xeb31 bitfield: 0 0 0  codep:0x744d parp:0xeb31 size:0x0008
// 1713:      UNK_0xeb3b bitfield: 0 0 0  codep:0x744d parp:0xeb3b size:0x0003
// 1714:      UNK_0xeb40 bitfield: 0 0 0  codep:0x744d parp:0xeb40 size:0x0003
// 1715:      UNK_0xeb45 bitfield: 0 0 0  codep:0x744d parp:0xeb45 size:0x0003
// 1716:      UNK_0xeb4a bitfield: 0 0 0  codep:0x744d parp:0xeb4a size:0x0007
// 1717:      UNK_0xeb53 bitfield: 0 0 0  codep:0x744d parp:0xeb53 size:0x0003
// 1718:      UNK_0xeb58 bitfield: 0 0 0  codep:0x744d parp:0xeb58 size:0x0026
// 1719:      UNK_0xeb80 bitfield: 0 0 0  codep:0x744d parp:0xeb80 size:0x0017
// 1720:      UNK_0xeb99 bitfield: 0 0 0  codep:0x744d parp:0xeb99 size:0x0003
// 1721:      UNK_0xeb9e bitfield: 0 0 0  codep:0x744d parp:0xeb9e size:0x0003
// 1722:      UNK_0xeba3 bitfield: 0 0 0  codep:0x744d parp:0xeba3 size:0x0008
// 1723:      UNK_0xebad bitfield: 0 0 0  codep:0x744d parp:0xebad size:0x0003
// 1724:      UNK_0xebb2 bitfield: 0 0 0  codep:0x744d parp:0xebb2 size:0x000b
// 1725:      UNK_0xebbf bitfield: 0 0 0  codep:0x744d parp:0xebbf size:0x0003
// 1726:            RSRC bitfield: 0 0 0  codep:0x1d29 parp:0xebcb size:0x0009
// 1727:      UNK_0xebd6 bitfield: 0 0 0  codep:0x1d29 parp:0xebd6 size:0x0002
// 1728:      UNK_0xebda bitfield: 0 0 0  codep:0x1d29 parp:0xebda size:0x0002
// 1729:      UNK_0xebde bitfield: 0 0 0  codep:0x1d29 parp:0xebde size:0x0004
// 1730:      UNK_0xebe4 bitfield: 0 0 0  codep:0x224c parp:0xebe4 size:0x000c
// 1731:      UNK_0xebf2 bitfield: 0 0 0  codep:0x224c parp:0xebf2 size:0x0008
// 1732:      UNK_0xebfc bitfield: 0 0 0  codep:0x224c parp:0xebfc size:0x000c
// 1733:      UNK_0xec0a bitfield: 0 0 0  codep:0x224c parp:0xec0a size:0x0006
// 1734:      UNK_0xec12 bitfield: 0 0 0  codep:0x224c parp:0xec12 size:0x001c
// 1735:      UNK_0xec30 bitfield: 0 0 0  codep:0x224c parp:0xec30 size:0x0038
// 1736:      UNK_0xec6a bitfield: 0 0 0  codep:0x224c parp:0xec6a size:0x001e
// 1737:      UNK_0xec8a bitfield: 0 0 0  codep:0x224c parp:0xec8a size:0x0014
// 1738:      UNK_0xeca0 bitfield: 0 0 0  codep:0x224c parp:0xeca0 size:0x001a
// 1739:      UNK_0xecbc bitfield: 0 0 0  codep:0x224c parp:0xecbc size:0x001a
// 1740:      UNK_0xecd8 bitfield: 0 0 0  codep:0x224c parp:0xecd8 size:0x0018
// 1741:      UNK_0xecf2 bitfield: 0 0 0  codep:0x224c parp:0xecf2 size:0x0006
// 1742:         LDAMAGE bitfield: 0 0 0  codep:0x1d29 parp:0xed04 size:0x000c
// 1743:      UNK_0xed12 bitfield: 0 0 0  codep:0x224c parp:0xed12 size:0x0022
// 1744:      UNK_0xed36 bitfield: 0 0 0  codep:0x224c parp:0xed36 size:0x0016
// 1745:      UNK_0xed4e bitfield: 0 0 0  codep:0x224c parp:0xed4e size:0x0038
// 1746:         WOUNDED bitfield: 0 0 0  codep:0x1d29 parp:0xed92 size:0x0006
// 1747:      UNK_0xed9a bitfield: 0 0 0  codep:0x1d29 parp:0xed9a size:0x0056
// 1748:      UNK_0xedf2 bitfield: 0 0 0  codep:0x224c parp:0xedf2 size:0x0010
// 1749:      UNK_0xee04 bitfield: 0 0 0  codep:0x224c parp:0xee04 size:0x0021
// 1750:      UNK_0xee27 bitfield: 0 0 0  codep:0x224c parp:0xee27 size:0x001d
// 1751:      UNK_0xee46 bitfield: 0 0 0  codep:0x224c parp:0xee46 size:0x0058
// 1752:         ENGINE- bitfield: 0 0 0  codep:0xee6d parp:0xeeaa size:0x0004
// 1753:         SENSOR- bitfield: 0 0 0  codep:0xee6d parp:0xeeba size:0x0004
// 1754:         COMM-CH bitfield: 0 0 0  codep:0xee6d parp:0xeeca size:0x0004
// 1755:         MISS-CH bitfield: 0 0 0  codep:0xee6d parp:0xeeda size:0x0004
// 1756:         LASER-C bitfield: 0 0 0  codep:0xee6d parp:0xeeea size:0x0004
// 1757:         SHIELD- bitfield: 0 0 0  codep:0xee6d parp:0xeefa size:0x0004
// 1758:      UNK_0xef00 bitfield: 0 0 0  codep:0x224c parp:0xef00 size:0x000a
// 1759:         #>?FIEL bitfield: 0 0 0  codep:0x4a4f parp:0xef16 size:0x0024
// 1760:      UNK_0xef3c bitfield: 0 0 0  codep:0x224c parp:0xef3c size:0x0038
// 1761:      UNK_0xef76 bitfield: 0 0 0  codep:0x224c parp:0xef76 size:0x0016
// 1762:      UNK_0xef8e bitfield: 0 0 0  codep:0x224c parp:0xef8e size:0x009e
// 1763:      UNK_0xf02e bitfield: 0 0 0  codep:0x224c parp:0xf02e size:0x0051
// 1764:      UNK_0xf081 bitfield: 0 0 0  codep:0x1d29 parp:0xf081 size:0x0007
// 1765:      UNK_0xf08a bitfield: 0 0 0  codep:0x224c parp:0xf08a size:0x00aa
// 1766:      UNK_0xf136 bitfield: 0 0 0  codep:0x224c parp:0xf136 size:0x002a
// 1767:      UNK_0xf162 bitfield: 0 0 0  codep:0x224c parp:0xf162 size:0x0036
// 1768:      UNK_0xf19a bitfield: 0 0 0  codep:0x224c parp:0xf19a size:0x0050
// 1769:      UNK_0xf1ec bitfield: 0 0 0  codep:0x224c parp:0xf1ec size:0x0032
// 1770:         MDAMAGE bitfield: 0 0 0  codep:0x1d29 parp:0xf22a size:0x000e
// 1771:      UNK_0xf23a bitfield: 0 0 0  codep:0x224c parp:0xf23a size:0x000c
// 1772:      UNK_0xf248 bitfield: 0 0 0  codep:0x224c parp:0xf248 size:0x0020
// 1773:      UNK_0xf26a bitfield: 0 0 0  codep:0x224c parp:0xf26a size:0x00bc
// 1774:         #>DAMAG bitfield: 0 0 0  codep:0x4a4f parp:0xf332 size:0x0024
// 1775:      UNK_0xf358 bitfield: 0 0 0  codep:0x224c parp:0xf358 size:0x001e
// 1776:      UNK_0xf378 bitfield: 0 0 0  codep:0x224c parp:0xf378 size:0x002a
// 1777:      UNK_0xf3a4 bitfield: 0 0 0  codep:0x224c parp:0xf3a4 size:0x0044
// 1778:      UNK_0xf3ea bitfield: 0 0 0  codep:0x224c parp:0xf3ea size:0x000c
// 1779:      UNK_0xf3f8 bitfield: 0 0 0  codep:0x224c parp:0xf3f8 size:0x000a
// 1780:      UNK_0xf404 bitfield: 0 0 0  codep:0x224c parp:0xf404 size:0x0036
// 1781:      UNK_0xf43c bitfield: 0 0 0  codep:0x224c parp:0xf43c size:0x0041
// 1782:      UNK_0xf47f bitfield: 0 0 0  codep:0x224c parp:0xf47f size:0x0064
// 1783:      UNK_0xf4e5 bitfield: 0 0 0  codep:0x224c parp:0xf4e5 size:0x0010
// 1784:      UNK_0xf4f7 bitfield: 0 0 0  codep:0x224c parp:0xf4f7 size:0x000e
// 1785:      UNK_0xf507 bitfield: 0 0 0  codep:0x224c parp:0xf507 size:0x000e
// 1786:         DO-DAMA bitfield: 0 0 0  codep:0x224c parp:0xf521 size:0x003f

// =================================
// =========== VARIABLES ===========
// =================================
unsigned char 'OVS[2] = {0x4e, 0xcb};
unsigned char RSRC[9] = {0x05, 0x41, 0x4c, 0x4c, 0x4f, 0x54, 0x20, 0x41, 0x53};
unsigned char UNK_0xebd6[2] = {0x00, 0x00};
unsigned char UNK_0xebda[2] = {0x3a, 0x20};
unsigned char UNK_0xebde[4] = {0x56, 0x3a, 0x20, 0x53};
unsigned char LDAMAGE[12] = {0x00, 0x00, 0x5a, 0x00, 0xd2, 0x00, 0x68, 0x01, 0xfe, 0x01, 0x94, 0x02};
unsigned char WOUNDED[6] = {0x05, 0x41, 0x4c, 0x4c, 0x4f, 0x54};
unsigned char UNK_0xed9a[86] = {0x00, 0x00, 0x4c, 0x22, 0x90, 0xed, 0x41, 0x0e, 0x8b, 0x3b, 0x72, 0x0f, 0xf2, 0x0e, 0xb8, 0x15, 0x50, 0x0e, 0x92, 0x0c, 0x7f, 0x0e, 0x5f, 0x12, 0xfa, 0x15, 0x0a, 0x00, 0x32, 0x0e, 0x4a, 0x17, 0x60, 0x16, 0x1c, 0x00, 0x50, 0x0e, 0x92, 0x0c, 0x5d, 0x17, 0xff, 0x00, 0x5f, 0x12, 0xfa, 0x15, 0x0e, 0x00, 0x50, 0x0e, 0x6a, 0x6d, 0x2e, 0x0f, 0x98, 0xed, 0x11, 0x4c, 0x4a, 0x17, 0xd0, 0x15, 0xd0, 0xff, 0x90, 0x16, 0x4c, 0x22, 0x90, 0xed, 0x8b, 0x3b, 0x5d, 0x17, 0xff, 0x00, 0xfd, 0x6d, 0x98, 0xed, 0xc5, 0x6d, 0x90, 0x16};
unsigned char UNK_0xf081[7] = {0x3a, 0x20, 0x05, 0x41, 0x4c, 0x4c, 0x4f};
unsigned char MDAMAGE[14] = {0x00, 0x00, 0xc8, 0x00, 0x90, 0x01, 0xbc, 0x02, 0xe8, 0x03, 0xdc, 0x05, 0xa0, 0x0f};
...
void UNK_0xebe4()
{
  pp_UNK_0xebda C@ Push(0x000f); AND 
}
...
void UNK_0xebfc()
{
  UNK_0xeb9e C@ Push(cc_8); AND UNK_0xeac1();
...
void UNK_0xec12()
{
  ROT - DUP * >R - DUP * Push(0); R> Push(0); D+ SQRT();
...
{
  pp_(ENCOUN @>C+S();
  Push(1); UNK_0xebad DUP C@ ROT + SWAP C!();
  ICLOSE();
  Push(cc_-1); pp_#VESS +!();
...
void UNK_0xed12()
{
  >R UNK_0xead5();
  UNK_0xec12();
  Push(0x000a); SWAP - R> IFLD@();
  2* pp_LDAMAGE + @ Push(0x000a); */();
...
void UNK_0xef3c()
{
  pp_RSRC Push(cc_9); Push(0); FILL();
  pp_UNK_0xebd6 OFF();
  Push(0); Push(cc_9); Push(1); 
  do // (DO)
  {
  I #>?FIEL DUP 
  if (Pop() == 0) goto label1892;
  I pp_UNK_0xebd6 @ pp_RSRC + <C!> Push(1); pp_UNK_0xebd6 <+!> 
  label1892:
  OR 
  } while(...); // (LOOP) 0xffe0
...
void UNK_0xef8e()
{
  ...
  label1884:
  R@ Push(0x0015); Push(0x0033); WITHIN();
  ...
  label1885:
  R@ Push(0x0033); Push(0x0051); WITHIN();
...
void UNK_0xf08a()
{
  ...
  .TTY();
  Push(0); UNK_0xeb31 C!();
  UNK_0xeb21 pp_UNK_0xf081 Push(cc_7); CMOVE();
  Push(0x0018); !INST-S();
  SET-CUR();
  pp_UNK_0xf081 UNK_0xeb4a Push(cc_7); CMOVE();
  UNK_0xec6a();
  Push(0xc27d); MODULE();
...
void UNK_0xf136()
{
  UNK_0xeb09 C@ DUP NEGATE pp_A-STREN +!();
  UNK_0xeb3b 2@ + UNK_0xeb01 2@ + */();
  pp_A-STREN @ + Push(0); MAX();
  pp_A-STREN !();
...
void UNK_0xf162()
{
  UNK_0xeb40 @ 0= Push(cc_?A-SHIE); 0= OR pp_?NEB @ OR 
  if (Pop() == 0) goto label1900;
  Push(0xeb3b); UNK_0xec30();
  
  goto label1902;
  
  label1900:
  Push(0xeb40); UNK_0xec30();
...
void UNK_0xf19a()
{
  ...
  BEEPON();
  Push(0x0514); Push(cc_MPS); 1- * Push(0x01f4); MAX();
  Push(0); 
  do // (DO)
  {
  Push(0); I RRND();
...
void UNK_0xf248()
{
  UNK_0xeb99 @ SWAP Push(cc_6); UNK_0xeb80 UNK_0xebf2();
  - * Push(cc_5); / - Push(0); MAX();
  UNK_0xeb99 !();
...
void UNK_0xf26a()
{
  UNK_0xeba3 @ SWAP Push(cc_6); UNK_0xeb58 UNK_0xebf2();
  - * Push(cc_5); / - Push(0); MAX();
  UNK_0xeba3 !();
  UNK_0xeba3 @ 0= 
...
void UNK_0xf404()
{
  ...
  VCLIPSE();
  UNK_0xec0a();
  WLD>SCR SCR>BLT SWAP Push(cc_3); + SWAP Push(cc_3); - pp_XWLD:XP @ Push(cc_6); MIN();
  Push(2); 
  do // (DO)
  {
  2DUP I .CIRCLE();
