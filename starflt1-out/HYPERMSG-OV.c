...
// =========== DICTIONARY ==========
// =================================
//      UNK_0xe566  codep:0x224c parp:0xe566 size:0x001c C-string:'UNK_0xe566'
//      UNK_0xe584  codep:0x2214 parp:0xe584 size:0x0016 C-string:'UNK_0xe584'
...
//            ?PRL  codep:0x224c parp:0xe76d size:0x0142 C-string:'_ask_PRL'
//      UNK_0xe8b1  codep:0x744d parp:0xe8b1 size:0x0003 C-string:'UNK_0xe8b1'
//      UNK_0xe8b6  codep:0x224c parp:0xe8b6 size:0x0052 C-string:'UNK_0xe8b6'
...
//         US-MESS  codep:0x224c parp:0xf135 size:0x0061 C-string:'US_dash_MESS'
...
//            DMSG  codep:0x224c parp:0xf1bc size:0x009a C-string:'DMSG'
...
void UNK_0xe935() // UNK_0xe935
{
  ...
  _1_dot_5_ex_(); // 1.5!
  Push(pp_UNK_0xe931); // UNK_0xe931 size: 0
  OFF(); // OFF
  Push(0); // 0
...
void UNK_0xed4b() // UNK_0xed4b
{
  ...
  OFF(); // OFF
  ICLOSE(); // ICLOSE
  Push(pp_UNK_0xed07); // UNK_0xed07 size: 0
  OFF(); // OFF
...
void DMSG() // DMSG
{
  Push(pp_UNK_0xf1b1); // UNK_0xf1b1 size: 0
  OFF(); // OFF
  Push(pp_XABS); // XABS size: 2
  Push(Read16(Pop())); // @
  Push(pp_YABS); // YABS size: 2
...
{
  Push(pp_UNK_0xf27b); // UNK_0xf27b size: 0
  Push(Read16(Pop())); // @
  Push(0x0096);
  _gt_(); // >
  Push(pp_UNK_0xf283); // UNK_0xf283 size: 0
  Push(Read16(Pop())); // @
  Push(cc__8); // 8
  _slash_(); // /
  Push(cc__8); // 8
  Push(Pop() * Pop()); // *
  Push(pp_UNK_0xf287); // UNK_0xf287 size: 0
  Push(Read16(Pop())); // @
  Push(cc__8); // 8
  _slash_(); // /
  Push(cc__8); // 8
  ...
  Push(Pop() & Pop()); // AND
  if (Pop() == 0) return;
  Push(pp_UNK_0xf27f); // UNK_0xf27f size: 0
  Push(Read16(Pop())); // @
  if (Pop() == 0) goto label1;
  CTINIT(); // CTINIT
...
{
  Push(pp_UNK_0xf43d); // UNK_0xf43d size: 0
  OFF(); // OFF
