...
// 1743:  PFILE-FUNCTION  codep:0x4a4f parp:0xf4e8 size:0x0014 C-string:'PFILE_minus_FUNCTION'
// 1744:       (U-PFILE)  codep:0x224c parp:0xf50a size:0x0056 C-string:'_ro_U_minus_PFILE_rc_'
